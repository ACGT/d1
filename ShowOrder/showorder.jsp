 ...
 String gdsid="";
	...
	<div class="sstep">
	  <div style="clear:both;">   <span>&nbsp;&nbsp;&nbsp;&nbsp;<font style="color:red;">*</font>第二步：上传宝贝图片</span>&nbsp;&nbsp;&nbsp;&nbsp;<font class="msg">(请选择jpg、jpeg、png、gif格式的图片，图片大小不能超过4M)</font></div>
	        	<p class="msg" style="padding-left:25px;">晒单我们鼓励使用原创实拍并与商品相关的图片，其他图片一律不能审核通过哦！</p>
<!-- <div id="fileQueue" class="sctpk" style="float:left;<%if(!b){%>display:none;<%}%> ">
        	 <input type="file" name="uploadify" id="uploadify" /> 
      		...
      		<div  id="btnupload" style="padding-left:25px;float:left;clear:both;<%if(!b){%>display:block;<%}%>"> <a href="javascript:void(0);" onclick="checkorder();" ><img src="http://images.d1.com.cn/images2012/sd/an_03.jpg" border="0"/></a>
      		</div>
...
<p style="padding-top:5px;">**对于清晰的真人秀，将根据图片整体效果获得100至200个积分奖励！！（仅限服装类商品的晒单）
</p></li>
