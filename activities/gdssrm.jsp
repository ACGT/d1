...
<div style=" background:url(http://images.d1.com.cn/zt2011/20111219lndq/xsq/qianggou_12.jpg) repeat-y; text-align:center;">
<div style="overflow:hidden;  padding-bottom:18px; ">
<%
String code="7006";
		...
		for(Product product:productlist){
			...
			if(pproductlist!=null && directory!=null){
			 ...
			 request.setAttribute("t", t);
			   ...
			   double memberprice=product.getGdsmst_memberprice().doubleValue();
				String strmprice=ProductGroupHelper.getRoundPrice((float)memberprice);
...
<div style="  float:left;  width:216px;height:320px; /*FF*/ *height:320px;/*IE7*/ _height:320px;/*IE6*/ _width:217px; <%if (l!=0 && i%4!=0 ){ %>		  margin-left:20px; <%}else{%> margin-left:20px; _margin-left:15px;/*IE6*/ <% }%> margin-top:8px; padding-top:10px; line-height:21px;border:1px solid #cdcdcd; background-color:#FFFFFF; overflow:hidden;" >
