...
<div style="margin:0px auto; width:980px; text-align:center; padding-top:25px; font-size:14px;">
   ...
   <a href="http://www.d1.com.cn/admin/Gdscoll/agd.jsp?gdscollid=<%= gid %>" target="bottom">添加搭配商品</a><br/>
   <%
      String ggURL = Tools.addOrUpdateParameter(request,null,null);
      ArrayList<Gdscolldetail> list=new ArrayList<Gdscolldetail>();
      list=GdscollHelper.getGdscollBycollid1(gid);
    	 ...
    	 if(request.getParameter("pageno1")!=null&&request.getParameter("pageno1").length()>0)
	      ...
	      for(int i=(pageno1-1)*15;i<list.size()&&i<pageno1*15;i++)
    	  {
    		  ...
    		  {%>
    			...
    			<td><a href="/admin/Gdscoll/gdu.jsp?id=<%=fl.getId() %>" >修改</a>&nbsp;&nbsp;<a href="javascript:void(0)" onclick="deleteGdscolld('<%= fl.getId() %>')">删除</a></td>
    			</tr>  
    		  <%}
    	  }%>
    	  <!-- 分页 -->
      ...
      {%>
    	还没有搭配，<a href="http://www.d1.com.cn/admin/Gdscoll/agd.jsp?gdscollid=<%= gid %>" target="bottom">马上去添加</a>  
      <%}
