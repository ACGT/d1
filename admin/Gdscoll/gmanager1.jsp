...
<form id="search1" name="search1" method="post" action="/admin/Gdscoll/gdsmstlist.jsp" target="_blank">
<font style="font-size:16px; color:#f00;">商品搜索选项：</font><br/>
商品名称：<input type="tetx" id="gdsname" name="gdsname" style="width:60px;"/>
<br/>
<br/>
