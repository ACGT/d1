	  ...
	  String endimgscal="";
	    Long size=0l;
		  ...
		  if(gs1!=null&&gs1.length()>0&&!Tools.isMath(gs1))
		  {
		    ...
		    if(gdsscene!=null){
		    	Tools.outJs(out, "添加场景成功", "/admin/Gdsscene/Addgdsscene.jsp");
		    }else{
		    	
		    	Tools.outJs(out, "添加场景失败", "back");
		    }
		   } catch (Exception e) {
			   out.print("fail");
		        e.printStackTrace();
...
<div style="margin:0px auto; width:980px; text-align:center; padding-top:25px;">
   ...
   <a href="gdsscenemanager.jsp">场景管理</a><br/>
   <form id="gdsscene" name="gdsscene" method="post" action="Addgdsscene.jsp" enctype="multipart/form-data">
