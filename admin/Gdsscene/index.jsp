...
if(session.getAttribute("admin_mng")!=null){
	   ...
	   ArrayList<AdminPower> aplist=   AdminPowerHelper.getAwardByGdsid(userid, "gdsscene");
...
<title>场景管理</title>
	<frameset cols="250,*" >
	  <frame name="left" src="/admin/Gdsscene/gdsscenelist.jsp" noresize>
	   <frameset rows="180,*" >
		  <frame name="top" src="/admin/Gdsscene/gmanager.jsp">
