  ...
  if("post".equals(request.getMethod().toLowerCase()))   
  {
	  ...
	  String endimg2="";
	    Long size=0l;
		  ...
		  if(g!=null)
		  {
			  out.print("<script>alert('添加系列成功！');this.location.href='/admin/Gdsser/gm.jsp';</script>");
		  }
	  	 } catch (Exception e) {
			   out.print("fail");
		        e.printStackTrace();
...
<div style="margin:0px auto; width:980px; text-align:center; padding-top:25px;">
   ...
   <a href="gm.jsp">系列管理</a><br/>
   <form id="gdsser" name="gdsser" method="post" action="ag.jsp" enctype="multipart/form-data">
