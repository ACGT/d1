	...
	public static ArrayList<Jsmst> getJsmstList(HttpServletRequest request,HttpServletResponse response){
		...
		try {
			...
			if(jsmst_status!= null && !"".equals(jsmst_status)) {
				...
				listRes.add(Restrictions.ne("jsmst_status", new Long(0)));
			}
...
%>	
	<div id="search">
		<form id="search2" name="search2" method="post" action="jsmstshoplist.jsp" >
		<table width="806" border="0" cellspacing="0" cellpadding="0" align="center">
			...
			<tr>
				...
				<td></td>
				<td colspan="2"><input type="hidden" name="jsmst_shpcode" value="<%=jsmst_shpcode %>"/></td>				
...
%>
	<tr>
		...
		<td align="center">
			<%
				out.print("<a href='jsdtlshoplist.jsp?jsdtl_jsmstcode="+jsmst.getJsmst_code()+"&jsmst_shpcode="+jsmst.getJsmst_shpcode()+"&jsmst_shpname="+jsmst.getJsmst_shpname()+"&jsmst_status="+jsmst.getJsmst_status()+"&href=jsmstshoplist.jsp?jsmst_shpcode="+jsmst_shpcode+"'>详情</a><br/>");
			%>
		</td>
	</tr>
<%
