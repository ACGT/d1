...
<table style="width:980px; margin:0px auto;" border="0" cellpadding="0" cellspacing="0">
  <tr><td style="text-align:left;" valign="top">
   <div style=" width:327px; height:418px; background:url('/admin/SHManage/images/shLogin/bg.png'); float:right; padding:0px;margin:0px; margin-top:30px; overflow:hidden;">
   ...
   <table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
      ...
      <input type="text" class="text" id="shname" name="shname" style="background:url('/admin/SHManage/images/shLogin/l1.jpg') no-repeat;background-position: 0px 1px; padding-left:37px;"/>
      </td></tr>
...
function ajaxCall(urlstr , fn){$.get(urlstr,{},function(data){if(fn instanceof Function){fn(data);}});}
	...
	function AjaxLogin(){		
		...
		if(hvalivode.length>0){			
			var login_url = "/admin/ajax/loginkfCheck.jsp";			
