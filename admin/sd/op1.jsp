...
if(Tools.isNull(showid) || Tools.isNull(request.getParameter("backtype"))  || Tools.isNull(request.getParameter("sh")) || Tools.isNull(request.getParameter("jf")) || Tools.isNull(mbrid)){
...
Long score=show.getMyshow_score();
...
if(Tools.getManager(MyShow.class).update(show, true)){
	if(jf>0 && UserHelper.getById(mbrid)!=null){
		 jf=jf-score;
