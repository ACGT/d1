...
<center>
<table>
<tr><td valign="top" style="border:none;"><%@include file="left.jsp"%></td><td style="border:none; width:100%;">

<%
String odrmst_subad="mqjs";
...
if(s==null && e==null && Tools.isNull(orderstatus) ){
	s=new Date(System.currentTimeMillis()-Tools.DAY_MILLIS*30);
}
ArrayList<OrderBase> list= getOrderList(odrmst_subad,ticketno,s,e, orderstatus, isticket);
