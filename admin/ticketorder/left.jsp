...
function search(){
	...
	// var isticket = $('#isticket').val();
	 var url = "jsorder.jsp?start_time="+encodeURIComponent($('#start_time').val())+"&end_time="+encodeURIComponent($('#end_time').val())+"&orderstatus="+encodeURIComponent($('#orderstatus').val());
