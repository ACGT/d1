...
function search(){
	...
	// var tuancardno = $('#tuancardno').val();
	 var url = "order.jsp?start_time="+encodeURIComponent($('#start_time').val())+"&end_time="+encodeURIComponent($('#end_time').val())+"&orderstatus="+encodeURIComponent($('#orderstatus').val())+"&subad="+subad+"&cardno="+cardno;
...
String subad="";String cardno="";String tuancardno="";
...
}if(!Tools.isNull(request.getParameter("subad"))){
	subad=request.getParameter("subad");
}
if(!Tools.isNull(request.getParameter("cardno"))){
	cardno=request.getParameter("cardno");
}
if(!Tools.isNull(request.getParameter("tuancardno"))){
	tuancardno=request.getParameter("tuancardno");
}
%>
<table width="200px">
...
<tr><td>活动subad</td><td><input type="text" name="subad" id="subad" value="<%=subad%>"/></td></tr>
<tr><td>券头：</td><td><input type="text" name="cardno" id="cardno" value="<%=cardno%>"/></td></tr>
