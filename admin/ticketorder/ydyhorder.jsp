...
static ArrayList<OrderCache> getOrderCacheList(String cardno,Date s,Date e,String status,String isticket){
...
public static ArrayList<OrderMain> getOrderMainList(String cardno,Date s,Date e,String status,String isticket){
...
public static ArrayList<OrderRecent> getOrderRecentList(String cardno,Date s,Date e,String status,String isticket){
...
public static ArrayList<OrderBase> getOrderList(String cardno,Date s,Date e,String status,String isticket){
	ArrayList<OrderBase> list=new ArrayList<OrderBase>();
	ArrayList<OrderCache> listcache=getOrderCacheList(cardno,s,e,status,isticket);
	if(listcache!=null){
		for(OrderCache ordercache:listcache){
			list.add(ordercache);
		}
	}
	ArrayList<OrderMain> listmain=getOrderMainList( cardno,s,e,status,isticket);
	if(listmain!=null){
		for(OrderMain ordermain:listmain){
			list.add(ordermain);
		}
	}
	ArrayList<OrderRecent> listrecent=getOrderRecentList( cardno,s,e,status,isticket);
	if(listrecent!=null){
...
<center>
<table>
<tr><td valign="top" style="border:none;"><%@include file="ydyhleft.jsp"%></td><td style="border:none; width:100%;">

<%
String ticketno="mqydyh";
...
ArrayList<OrderBase> list= getOrderList(ticketno,s,e, orderstatus, isticket);
