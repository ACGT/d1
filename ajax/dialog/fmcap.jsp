...
<tr>
<td valign="middle" align="center" style="font-size:15px;"><span ><%if("1".equals(type)){%>恭喜您已经获得韩国进口777美甲套装，再购买</span><span style="color:red;"><%=Tools.getDouble(lastmoney, 2) %></span>元即可获得【FEEL MIND】印第安刺绣棒球帽 <%}else{ %>  <span> 再购买</span><span style="color:red;"><%=Tools.getDouble(lastmoney, 2) %></span> 元即可获得以下赠品。<%} %></td>
</tr>
<tr><td >
