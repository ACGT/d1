...
private static int Exits(String mbrid)
{
	int result=0;
     ...
     clist.add(Restrictions.ge("gdsbuyonedtl_mstid",new Long(54)));
     clist.add(Restrictions.le("gdsbuyonedtl_mstid",new Long(57)));
     ...
     if(blist!=null&&blist.size()>0)
     {
    	 for(BaseEntity be:blist)
    	 {
    		 if(be!=null){
    		    ...
    		    if(bld.getGdsbuyonedtl_gdsid()!=null&&(bld.getGdsbuyonedtl_gdsid().equals("01416238")||bld.getGdsbuyonedtl_gdsid().equals("01407682")||bld.getGdsbuyonedtl_gdsid().equals("01417179")||bld.getGdsbuyonedtl_gdsid().equals("01408474")))
    		    {
    		    	result++;
    		    }
    		 }
...
String end="2012-08-11 00:00:00";
...
if(allCartList!=null){
	for(Cart c_23894:allCartList){
		//if(product.getId().equals(c_23894.getProductId())&&c_23894.getType().longValue()==14){
			if((c_23894.getProductId().equals("01408474")||c_23894.getProductId().equals("01417179")||c_23894.getProductId().equals("01407682")||c_23894.getProductId().equals("01416238") )&&c_23894.getType().longValue()==14){
...
String start="2012-08-02 00:00:00";
...
float price=0f;
if("01416238".equals(gdsid)){
	price=9f;
}else if("01408474".equals(gdsid) ){
	price=39f;
}else if("01407682".equals(gdsid) || "01417179".equals(gdsid) ){
	price=29f;
}
price=price+diff-1;
if(price==0){
