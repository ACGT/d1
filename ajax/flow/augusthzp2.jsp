...
private static int Exits(String mbrid)
{
	int result=0;
     ...
     clist.add(Restrictions.ge("gdsbuyonedtl_mstid",new Long(58)));
     clist.add(Restrictions.le("gdsbuyonedtl_mstid",new Long(61)));
     ...
     if(blist!=null&&blist.size()>0)
     {
    	 for(BaseEntity be:blist)
    	 {
    		 if(be!=null){
    		    ...
    		    if(bld.getGdsbuyonedtl_gdsid()!=null&&(bld.getGdsbuyonedtl_gdsid().equals("01415488")||bld.getGdsbuyonedtl_gdsid().equals("01413684")||bld.getGdsbuyonedtl_gdsid().equals("01413849")||bld.getGdsbuyonedtl_gdsid().equals("01415120")))
    		    {
    		    	result++;
    		    }
    		 }
...
String end="2012-08-18 00:00:00";
...
if(allCartList!=null){
	for(Cart c_23894:allCartList){
		//if(product.getId().equals(c_23894.getProductId())&&c_23894.getType().longValue()==14){
			if((c_23894.getProductId().equals("01415120")||c_23894.getProductId().equals("01413849")||c_23894.getProductId().equals("01413684")||c_23894.getProductId().equals("01415488") )&&c_23894.getType().longValue()==14){
...
String start="2012-08-10 00:00:00";
...
float price=0f;
if("01415488".equals(gdsid)){
	price=25f;
}else if("01413849".equals(gdsid) ){
	price=45f;
}else if("01413684".equals(gdsid) || "01415120".equals(gdsid) ){
	price=19f;
}
price=price+diff-1;
if(price==0){
