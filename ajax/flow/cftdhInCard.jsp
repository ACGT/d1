...
if(false && t==0){
	...
	float ftuanprice=-1;
	String strgdsidOne="";
	if("01516241".equals(strgdsid)){
    	ftuanprice=119;
    }
	else if("01415218".equals(strgdsid)){
    	ftuanprice=49;
    }
	else if("01720068".equals(strgdsid)){
    	ftuanprice=99;
    }
	else if("01720159".equals(strgdsid)){
    	ftuanprice=69;
    }
	else if("01718124".equals(strgdsid)){
    	ftuanprice=98;
    }
	else if("01720843".equals(strgdsid) && strgdsdh_code.startsWith("mqcft1301wz")){
    	ftuanprice=0;
    }
	else if("01720843".equals(strgdsid)){
    	ftuanprice=39;
    }
	else if("03000046".equals(strgdsid)){
    	ftuanprice=25;
    }
	else if("01516824".equals(strgdsid)){
    	ftuanprice=39;
    }else if("01515468".equals(strgdsid)){
    	ftuanprice=59;
    }else if("01412054".equals(strgdsid)){
    	ftuanprice=69;
    }else if("03000042".equals(strgdsid)){
    	ftuanprice=89;
    }else if("02000034".equals(strgdsid)){
    	ftuanprice=85;
    }
    else if("02000027".equals(strgdsid)){
    	ftuanprice=89;
    }  else if("03000048".equals(strgdsid)){
    	ftuanprice=99;
    } else if("01517024".equals(strgdsid)){
    	ftuanprice=65;
    }else if("01506312".equals(strgdsid)){
    	ftuanprice=479;
    }
    else if("01417074".equals(strgdsid)){
    	ftuanprice=19;
    }
    else if("03000039".equals(strgdsid)){
    	ftuanprice=69;
    }
    else if("01516971".equals(strgdsid)){
    	ftuanprice=89;
    } else if("01511839".equals(strgdsid)){
    	ftuanprice=79;
    }else if("02000396".equals(strgdsid)){
    	ftuanprice=29;
    }else if("01517302".equals(strgdsid)){
    	ftuanprice=59;
    }else if("01714156".equals(strgdsid)){
    	ftuanprice=99;
    }else if("01516990".equals(strgdsid)){
    	ftuanprice=49;
    }else if("01517367".equals(strgdsid)){
    	ftuanprice=19;
    }else if("03300036".equals(strgdsid)){
    	ftuanprice=109;
    }else if("02000482".equals(strgdsid)){
    	ftuanprice=19;
    }else if("01719213".equals(strgdsid)){
    	ftuanprice=24;
    }else if("03300029".equals(strgdsid)){
    	ftuanprice=69;
    }
    else if("01721269".equals(strgdsid)){
    	ftuanprice=22;
    }
    else if("01417188".equals(strgdsid)){
    	ftuanprice=49;
    }
    else if("01517418".equals(strgdsid)){
    	ftuanprice=39;
    }else if("01719626".equals(strgdsid)){
    	ftuanprice=89;
    } else if("01516824".equals(strgdsid)){
    	ftuanprice=39;
    }else if("01512997".equals(strgdsid)){
    	ftuanprice=89;
    }else if("01517448".equals(strgdsid)){
    	ftuanprice=169;
    }else if("01516782".equals(strgdsid)){
    	ftuanprice=139;
    }else if( "01511126".equals(strgdsid)){
		ftuanprice=159;
	}else if( "01516698".equals(strgdsid)){
		ftuanprice=48;
	}else if( "01719955".equals(strgdsid)){
		ftuanprice=49;
	...
	if( "01511126".equals(strgdsid)){
		...
		cart2.setMoney(Tools.getFloat(new Float(0),2));
		cart2.setOldPrice(Tools.getFloat(new Float(0),2));
		cart2.setPoint(new Long(0));
		cart2.setPrice(Tools.getFloat(new Float(0),2));
		cart2.setSkuId("");//?
		cart2.setTuanCode("");//注意parentId值
		cart2.setProductId("01511167");
		cart2.setType(new Long(14));
		cart2.setUserId(CartHelper.getCartUserId(request, response));
		cart2.setVipPrice(Tools.getFloat(new Float(0),2));
		cart2.setTitle("【赠品】"+ProductHelper.getById("01511167").getGdsmst_gdsname());
