...
//}else{
	//直接加入购物车。，数量默认1.
String dhgdsstr="03000117,03000118,03000119,03000120,03000121,03000122,03000123,03000124,03000125";
	if(tuandh.getTuandh_memo().indexOf(gdsid)==-1&&dhgdsstr.indexOf(gdsid)==-1){
