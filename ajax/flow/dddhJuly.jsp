...
if(false && t==0){
	...
	float ftuanprice=-1;
	String strgdsidOne="";
	/*if("01720843".equals(strgdsid) && strgdsdh_code.indexOf("mqdd212wz")>=0){
    	ftuanprice=0;
    }
	...
	else if("01718807".equals(strgdsid)){
    	ftuanprice=19;
    }
    	...
    	ftuanprice=0;
    }else if("02001160".equals(strgdsid)){
    	ftuanprice=0;
    }else if("01719683".equals(strgdsid)){
    	ftuanprice=0;
    }else if("01517367".equals(strgdsid)){
    	ftuanprice=0;
    }else if("01417366".equals(strgdsid)){
    	ftuanprice=0;
    }else if("01417256".equals(strgdsid)){
    	ftuanprice=0;
    }else if("01417237".equals(strgdsid)){
    	ftuanprice=0;
    }*/
	if("02000919".equals(strgdsid)||"02001290".equals(strgdsid)||"02000749".equals(strgdsid)){
		ftuanprice=0;
	}else if("01415010".equals(strgdsid)||"01416363".equals(strgdsid)||"01415028".equals(strgdsid)){
    	ftuanprice=0;
	}else if("02200027".equals(strgdsid)||"02200184".equals(strgdsid)||"01517367".equals(strgdsid)){
    	ftuanprice=0;
	}else if("01516150".equals(strgdsid)||"01410770".equals(strgdsid)||"01517367".equals(strgdsid)){
    	ftuanprice=0;
    }
