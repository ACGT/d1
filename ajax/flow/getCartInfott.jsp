...
//int cartnum000=CartShopCodeHelper.getTotalProductCount(request, response, "00000000");
//if(cartnum000==0)giftList=null;
int giftCount =1;// (giftList == null ? 0 : giftList.size());
//System.out.println("赠品 数："+giftCount);
