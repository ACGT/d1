...
boolean istx=hasZqProduct(request,response);//中秋领拖鞋 是否只购买拖鞋
...
if(istuanDH && Tools.floatCompare(totalMoney,0) == 0){//totalMoney==0
	...
	return;
}else if(istuanDH || iswyDH || istx){//totalMoney>0
...
SimpleDateFormat fmt = new SimpleDateFormat("yyyy-MM-dd");
	...
	try{
		   	 dStartDate =fmt.parse("2012-07-01");
		 }
	catch(Exception ex){
		ex.printStackTrace();
	}
	...
	{
		sb.append("<a href=\"http://www.d1.com.cn/zhuanti/20120531980SJK/980SJK.jsp \" style=\"color:red;text-decoration:none;\" target=\"_blank\">手机支付亿元电子券大派送！</a>");
	}		
...
sb.append("<td class=\"t00\" colspan=\"2\">即时到帐，支持绝大数银行借记卡及部分银行信用卡，使用网上支付购物满<strong class=\"t14\">99</strong>元享受免邮费优惠。</td>");
sb.append("</tr>");
...
sb.append("<td colspan=\"3\" class=\"t01\">");
	...
	sb.append("<tr><td colspan=\"8\"><span class=\"t00\">支持以下支付平台：</span></td></tr>");
...
sb.append("<tr><td colspan=\"5\" >货到付款北京、上海、广东实际支付满<span style=\"color:#ff0000\">100</span>元免运费，其它城市满<span style=\"color:#ff0000\">200</span>元免运费，不满足条件时，全国每单收取<span style=\"color:#ff0000\">10</span>元运费</td></tr>");
