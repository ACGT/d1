...
if(false && t==0){
	...
	float ftuanprice=0;
	String strgdsidOne="";
	if("01516824".equals(strgdsid)&&strgdsdh_code.startsWith("mq1391405jp")){
		ftuanprice=0;
		b=true;
	 }else if("03300070".equals(strgdsid)&&strgdsdh_code.startsWith("mq1391405jp")){
		ftuanprice=0;
		b=true;
 	}else if("03000122".equals(strgdsid)&&strgdsdh_code.startsWith("mq1391405jp")){
		ftuanprice=0;
		b=true;
 	}else if("05002758".equals(strgdsid)){//2014.6.1结束
			ftuanprice=39;
     }else if("08000076".equals(strgdsid)){
			ftuanprice=75;
     }else if("03100812".equals(strgdsid)){
			ftuanprice=59;
     }else if("05002642".equals(strgdsid)){
			ftuanprice=39;
     }else if("08000106".equals(strgdsid)){
			ftuanprice=65;
     }else if("05002695".equals(strgdsid)){
			ftuanprice=29;
     }else if("04001075".equals(strgdsid)){
			ftuanprice=39;
     }else if("04001038".equals(strgdsid)){
			ftuanprice=29;
     }else if("03004132".equals(strgdsid)){//7月1号结束
			ftuanprice=39;
     }else if("03100864".equals(strgdsid)){
			ftuanprice=59;
     }else if("08000150".equals(strgdsid)){
			ftuanprice=69;
     }else if("01512997".equals(strgdsid)){
			ftuanprice=89;
     }else if("01519050".equals(strgdsid)){
			ftuanprice=49;
     }else if("03100862".equals(strgdsid)){
			ftuanprice=49;
     }else if("01205704".equals(strgdsid)){
			ftuanprice=35;
     }else if("03004261".equals(strgdsid)){
			ftuanprice=45;
     }else if("08000078".equals(strgdsid)){//14.7.1
			ftuanprice=79;
     }else if("05002499".equals(strgdsid)){
			ftuanprice=49;
     }else if("03100762".equals(strgdsid)){
			ftuanprice=59;
     }else if("01519406".equals(strgdsid)){
			ftuanprice=68;
     }else if("04001052".equals(strgdsid)){
			ftuanprice=39;
     }else if("04001027".equals(strgdsid)){
			ftuanprice=29;
     }else if("08000183".equals(strgdsid)){
			ftuanprice=29;
     }else if("01519439".equals(strgdsid)){
			ftuanprice=58;
     }else if("08000106".equals(strgdsid)){
			ftuanprice=65;
     }else if("01519250".equals(strgdsid)){
			ftuanprice=88;
     }else if("04001038".equals(strgdsid)){//.8.1
			ftuanprice=29;
     }else if("08000072".equals(strgdsid)){
			ftuanprice=59;
     }else if("05002497".equals(strgdsid)){
			ftuanprice=29;
     }else if("03100762".equals(strgdsid)){
			ftuanprice=59;
     }else if("06000350".equals(strgdsid)){//8.1
			ftuanprice=29;
     }else if("01205808".equals(strgdsid)){
			ftuanprice=29;
     }else if("04001052".equals(strgdsid)){
			ftuanprice=39;
     }else if("05002696".equals(strgdsid)){
			ftuanprice=39;
     }else if("03000017".equals(strgdsid)){//9.1
			ftuanprice=39;
     }else if("02013721".equals(strgdsid)){
			ftuanprice=12.9f;
     }else if("05002586".equals(strgdsid)){
			ftuanprice=78;
     }else if("01519611".equals(strgdsid)){
			ftuanprice=79;
     }else if("01205775".equals(strgdsid)&&strgdsdh_code.startsWith("mq139yx140721")){
 		ftuanprice=0;
 		b=true;
	}
	if(ftuanprice==0&&!b){
	ftuanprice=tuandh.getTuandh_dhprice().floatValue();
	}
if(ftuanprice==0 && !b){
