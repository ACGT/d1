...
private static int Exits(String mbrid)
{
	int result=0;
     ...
     clist.add(Restrictions.ge("gdsbuyonedtl_mstid",new Long(28)));
...
String end="2012-07-26 10:00:00";
...
if(allCartList!=null){
	for(Cart c_23894:allCartList){
		//if(product.getId().equals(c_23894.getProductId())&&c_23894.getType().longValue()==14){
			if((c_23894.getProductId().equals("01404571")||c_23894.getProductId().equals("01404570")||c_23894.getProductId().equals("01404569")||c_23894.getProductId().equals("01404572") ||c_23894.getProductId().equals("01416056")||c_23894.getProductId().equals("01404602")||c_23894.getProductId().equals("01408522"))&&c_23894.getType().longValue()==14){
...
if("01404572".equals(gdsid) || "01404569".equals(gdsid) || "01404570".equals(gdsid) || "01404571".equals(gdsid)){
	...
	price=29f;
}else if("01404602".equals(gdsid) ){
	price=25f;
}else if("01408522".equals(gdsid) ){
	price=39f;
}
if(price==0){
	out.print("{\"code\":1,message:\"很抱歉，您输入的信息不正确，请确认后重试！\"}");
