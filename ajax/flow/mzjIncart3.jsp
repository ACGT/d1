...
private static int Exits(String mbrid)
{
	int result=0;
     ...
     clist.add(Restrictions.ge("gdsbuyonedtl_mstid",new Long(33)));
     clist.add(Restrictions.le("gdsbuyonedtl_mstid",new Long(46)));
     clist.add(Restrictions.eq("gdsbuyonedtl_mbrid",new Long(mbrid)));
     SimpleDateFormat   df2=new   SimpleDateFormat("yyyy-MM-dd HH:mm:ss");  
     SimpleDateFormat df3=new SimpleDateFormat("yyyy-MM-dd");
     String stime="2012-07-25 00:00:00";
     String etime ="2012-08-03 23:59:59";
     try {
     ...
     if(blist!=null&&blist.size()>0)
     {
    	 for(BaseEntity be:blist)
    	 {
    		 if(be!=null){
    		    ...
    		    if(bld.getGdsbuyonedtl_gdsid()!=null&&(bld.getGdsbuyonedtl_gdsid().equals("01416056")||bld.getGdsbuyonedtl_gdsid().equals("01416664")||bld.getGdsbuyonedtl_gdsid().equals("01414291")||bld.getGdsbuyonedtl_gdsid().equals("01404572") ||bld.getGdsbuyonedtl_gdsid().equals("01404569")||bld.getGdsbuyonedtl_gdsid().equals("01404570")||bld.getGdsbuyonedtl_gdsid().equals("01404571")))
    		    {
    		    	result++;
    		    }
    		 }
...
String end="2012-08-03 00:00:00";
...
//商品数量
int iCount = request.getParameter("count")!=null&&request.getParameter("count").length()>0?Tools.parseInt(request.getParameter("count")):0;
...
if(allCartList!=null){
	for(Cart c_23894:allCartList){
		//if(product.getId().equals(c_23894.getProductId())&&c_23894.getType().longValue()==14){
			if((c_23894.getProductId().equals("01404571")||c_23894.getProductId().equals("01404570")||c_23894.getProductId().equals("01404569")||c_23894.getProductId().equals("01404572") ||c_23894.getProductId().equals("01416056")||c_23894.getProductId().equals("01416664")||c_23894.getProductId().equals("01414291"))&&c_23894.getType().longValue()==14){
...
float price=0f;
if("01404572".equals(gdsid) || "01404569".equals(gdsid) || "01404570".equals(gdsid) || "01404571".equals(gdsid)){
	price=9.9f;
}else if("01416056".equals(gdsid) ){
	price=29f;
}else if("01414291".equals(gdsid) || "01416664".equals(gdsid) ){
	price=1f;
}
if(price==0){
	out.print("{\"code\":1,message:\"很抱歉，您输入的信息不正确，请确认后重试！\"}");
...
cart.setTitle("【夏日美妆节】"+product.getGdsmst_gdsname());
