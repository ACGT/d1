...
if(false && t==0){
	...
	if("01720843".equals(strgdsid)){
    	ftuanprice=0;
    }else if("01511403".equals(strgdsid)){
    	ftuanprice=0;
    }else if("02000480".equals(strgdsid)){
    	ftuanprice=0;
    }else if("01721269".equals(strgdsid)){
    	ftuanprice=0;
    }else if("02200125".equals(strgdsid)){
    	ftuanprice=0;
    }else if("01511168".equals(strgdsid)){
    	ftuanprice=0;
    }else if("03300077".equals(strgdsid)){
    	ftuanprice=0;
    }else if("02300233".equals(strgdsid)){
    	ftuanprice=0;
    }else if("01515468".equals(strgdsid)){
    	ftuanprice=0;
    }else if("01517598".equals(strgdsid)){
    	ftuanprice=0;
    }else if("02300233".equals(strgdsid)){
    	ftuanprice=0;
    	...
    	ftuanprice=0;
    }else if("01205411".equals(strgdsid)){
    	ftuanprice=0;
    }else if("01505433".equals(strgdsid)){
    	ftuanprice=0;
    }else if("05002653".equals(strgdsid)){
    	ftuanprice=0;
    }else if("01205712".equals(strgdsid)){
    	ftuanprice=0;
    }
