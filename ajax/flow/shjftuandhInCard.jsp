...
if(false && t==0){
	...
	float ftuanprice=0;
	String strgdsidOne="";
	if("01720159".equals(strgdsid)){
    	ftuanprice=79;
    }else if(strgdsdh_code.startsWith("mqsh1212sp")&& "01516824".equals(strgdsid)){
    	ftuanprice=49;
    }
	else if("01516021".equals(strgdsid)){
    	ftuanprice=59;
    }
	else if("02000396".equals(strgdsid)){
		ftuanprice=29;
	}else if("01721234".equals(strgdsid)){
		ftuanprice=0;
	}else if("01415154".equals(strgdsid)){
		ftuanprice=59;
	}else if("01417188".equals(strgdsid)){
		ftuanprice=49;
	}else if("01719683".equals(strgdsid)){
		ftuanprice=29;
	}else if("02000803".equals(strgdsid)){
		ftuanprice=49;
	}else if("01719626".equals(strgdsid)){
		ftuanprice=89;
	}else if("01721266".equals(strgdsid)){
		ftuanprice=39;
	}else if("01719683".equals(strgdsid)){
		ftuanprice=29;
	}else if("03000349".equals(strgdsid)){
		ftuanprice=79;
	}else if("01517528".equals(strgdsid)){
		ftuanprice=39;
	}else if("01408785".equals(strgdsid)){
		ftuanprice=79;
	}else if("01516824".equals(strgdsid)){
		ftuanprice=39;
	}else if("01517586".equals(strgdsid)){
		ftuanprice=69;
	}else if("03300021".equals(strgdsid)){
		ftuanprice=89;
	}else if("03100076".equals(strgdsid)){/*03-9-2*/
		ftuanprice=59;
	}else if("01517521".equals(strgdsid)){
		ftuanprice=129;
	}else if("01513987".equals(strgdsid)){
		ftuanprice=59;
	}else if("01417246".equals(strgdsid)){
		ftuanprice=39;
	}else if("01500235".equals(strgdsid)){
		ftuanprice=79;
	}else if("01205303".equals(strgdsid)){		///*13-4-1*/
		ftuanprice=9.9f;
	}else if("04000543".equals(strgdsid)){
		ftuanprice=19;
	}else if("01720843".equals(strgdsid)){
		ftuanprice=25;
	}else if("01721268".equals(strgdsid)){
		ftuanprice=25;
	}else if("03001646".equals(strgdsid)){
		ftuanprice=89;
		...
		ftuanprice=69;
	}else if("01518255".equals(strgdsid)&&strgdsdh_code.startsWith("mq20140127shh")){
		ftuanprice=0;
		freefalg=true;
	}

	if(ftuanprice==0 && !freefalg){
	...
	if(Tuandh_mid!=15&&Tuandh_mid!=25){
