...
private int getTuandhLength(String strgdsid,String mbrid){
	...
	clist.add(Restrictions.eq("tuandh_mid", new Long(34)));
...
if(false && t==0){
	...
	if("01720843".equals(strgdsid)){
	...
	else if("01516772".equals(strgdsid)){
    	ftuanprice=99;
    }
    	...
    	ftuanprice=55;
    }else if("01414291".equals(strgdsid)){
    	ftuanprice=9;
    }else if("02000396".equals(strgdsid)){
    	ftuanprice=29;
    }else if("03300024".equals(strgdsid)){
    	ftuanprice=79;
    }else if("01516971".equals(strgdsid)){
    	ftuanprice=89;
    }else if("01517302".equals(strgdsid)){
    	ftuanprice=59;
    }else if("01515961".equals(strgdsid)){
    	ftuanprice=159;
    	...
    	ftuanprice=0;
    }else if("03000091".equals(strgdsid)){
    	ftuanprice=0;
    }else if("01517339".equals(strgdsid)){
    	ftuanprice=19;
    }else if("01720203".equals(strgdsid)){
    	ftuanprice=49;
    }else if("01720202".equals(strgdsid)){
    	ftuanprice=49;
    }
