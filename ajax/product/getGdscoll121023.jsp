...
private static String getGdscollInDetail1(String outColor,String gdsColor,String overColor,String pid)
{
	...
	String bimg="";
	String img="";
	Product ps=ProductHelper.getById(pid);
	if(ps!=null&&ps.getGdsmst_brandname()!=null&&ps.getGdsmst_brandname().length()>0)
	{
		if(ps.getGdsmst_brandname().equals("FEEL MIND"))
		{
			img="<img src=\"http://images.d1.com.cn/images2012/index2012/oct/fm-e.jpg\"/>";
			bimg="<img src=\"http://images.d1.com.cn/zt2012/fm201209/fm-brandstory.jpg\"/>";
		}
		else if(ps.getGdsmst_brandname().equals("诗若漫"))
		{
			img="<img src=\"http://images.d1.com.cn/images2012/index2012/oct/srm.jpg\"/>";
			 bimg="<img src=\"http://images.d1.com.cn/zt2012/201205sheromo/brandstory.jpg\"/>";
		}
		else if(ps.getGdsmst_brandname().indexOf("AleeiShe 小栗舍")>=0)
		{
			 img="<img src=\"http://images.d1.com.cn/images2013/product/titlebar-collocation.jpg\"/>";
			 bimg="<img src=\"http://images.d1.com.cn/zt2011/aleeisheweb/images/title_15.jpg\"/><img src=\"http://images.d1.com.cn/zt2011/aleeisheweb/images/brandstory1.jpg\"/>";
				...
				if((i+1)%2==1)
				{
					...
					ArrayList<Gdscolldetail> gdetaillist=GdscollHelper.getGdscollBycollid(gdscoll.getId());
                      ...
                      String color="";
							...
							if(gd!=null)
							{
								...
								if(p!=null&&p.getGdsmst_ifhavegds().longValue()==0&&p.getGdsmst_validflag().longValue()==1&&ProductStockHelper.canBuy(p))
								{
									...
									else
									{
									 ...
									 sb.append("<span style=\"position:relative;+position:static; width:122px; +width:126px;\"><input type=\"checkbox\" "+check+" name=\"chks_"+i+"\" value=\""+p.getId()+"\" onClick=\"choosedp1('"+Tools.getFormatMoney(p.getGdsmst_memberprice())+"',this.checked,"+i+",'"+p.getId()+"')\" style=\"margin-right:4px;\"/><a href=\"/product/"+p.getId()+"\" target=\"_blank\"><img src=\""+gdsimg+"\" width=\"100\" height=\"100\"  style=\" vertical-align:middle; background:#fff;\"/></a>");
									 sb.append("<span id=\"spandps"+p.getId()+i+"\" style=\"position: absolute;+position:static; float:right;+margin-top:-102px; top:2px;right:1px;width: 99px;height: 99px;background-color: #ccc;filter: alpha(opacity=40);-moz-opacity: 0.4;opacity: 0.4;");
									 if(gd.getGdscolldetail_gdsflag()!=null&&gd.getGdscolldetail_gdsflag().longValue()==1)
									 {
						...
						sb.append("</ul>");
						sb.append("<div style=\"width:100%; padding-top:25px; padding-bottom:25px; line-height:20px; font-size:13px; padding-left:30px;\"><table><tr><td width=\"130\">共&nbsp;<font id=\"amounts"+i+"\">"+counts+"</font>&nbsp;件<br/>总价：￥<font id=\"memberPs"+i+"\">"+(int)sum1+"</font><br/><font color='cf0200'><b>组合价：￥<font id=\"pktPs"+i+"\">"+(int)zhprice+"</font></b></font><br/>共优惠：￥<font id=\"cheaps"+i+"\">"+(int)(sum1-zhprice)+"</font></td><td><font style=\"font-size:16px; color:#f00;\">搭配购买立享95折！</font></br/></br/><a href=\"javascript:void(0)\" code=\""+gdscoll.getId()+"\" onclick=\"add_gdscoll1(this,'"+i+"')\"><img src=\"http://images.d1.com.cn/images2012/index2012/zhgm_cj.jpg\"/></a></td></tr></table></div>");
						sb.append("</div>");
...
Map<String,Object> map = new HashMap<String,Object>();
     ...
     if(p.getGdsmst_brandname()!=null&&p.getGdsmst_brandname().length()>0&&(p.getGdsmst_brandname().equals("AleeiShe 小栗舍")||p.getGdsmst_brandname().equals("FEEL MIND")||p.getGdsmst_brandname().equals("诗若漫")))
     {
