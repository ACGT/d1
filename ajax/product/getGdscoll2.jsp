...
//获取商品详情的搭配显示
private static String getGdscollInDetail1(String outColor,String gdsColor,String overColor,String pid,String brand)
{
		...
		for(int i=0;i<gdscolllist.size();i++)
		{
			...
			if(gdscoll!=null)
			{
				...
				if((i+1)%2==1)
				{
					if(i==0){
					if ("f".equals(brand)){
						sb.append("<img src=\"http://images.d1.com.cn/zt2012/fm201209/fm-e.jpg\">");
					}else if("a".equals(brand)){
						sb.append("<img src=\"http://images.d1.com.cn//zt2012/20120521dpt/xls.jpg\">");
					}else if("s".equals(brand)){
						sb.append("<img src=\"http://images.d1.com.cn//zt2012/20120521dpt/srm.jpg\">");
					}
					}
							...
							if(gd!=null)
							{
								...
								if(p!=null&&p.getGdsmst_ifhavegds().longValue()==0&&p.getGdsmst_validflag().longValue()==1&&ProductStockHelper.canBuy(p))
								{
									...
									else
									{
									 ...
									 sb.append("<span><input type=\"checkbox\" "+check+" name=\"chks_"+i+"\" value=\""+p.getId()+"\" onClick=\"choosedp('"+Tools.getFormatMoney(p.getGdsmst_memberprice())+"',this.checked,"+i+")\" style=\"margin-right:4px;\"/><a href=\"/product/"+p.getId()+"\" target=\"_blank\"><img src=\""+gdsimg+"\" width=\"100\" height=\"100\"  style=\" vertical-align:middle; background:#fff;\"/></a></span>");
									 sb.append("<div>");
...
Map<String,Object> map = new HashMap<String,Object>();
     ...
     if(request.getParameter("brand")!=null&&request.getParameter("brand").length()>0)
     {
    	 brand=request.getParameter("brand");
     }
     String result="";
     result=getGdscollInDetail1(ocolor,gcolor,overcolor,id,brand);
     if(result.length()>0)
     {
