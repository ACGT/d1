...
static String getHeightInfo2(String gdsid,String mtype){
...
//if(p.getGdsmst_mwgid()!=null && p.getGdsmst_mwgid()>0){
	...
	if(dtllist!=null && dtllist.size()>0){
		...
		//mtype模特A=小栗舍，S=诗若漫，F=FM   如果模特不一样，就是A1,A2
		if(mtype.equals("F1")){
			topimg="http://images.d1.com.cn/images2012/product/F1_topimg_2.jpg";
			img1="http://images.d1.com.cn/images2012/product/F1_img1_2.jpg";
		}else if(mtype.equals("F2")){
				topimg="http://images.d1.com.cn/images2012/product/F2_topimg.jpg";
				img1="http://images.d1.com.cn/images2012/product/F2_img1.jpg";
		}else if(mtype.equals("S1")){
			topimg="http://images.d1.com.cn/images2012/product/S1_topimg_2.jpg";
			img1="http://images.d1.com.cn/images2012/product/S1_img1_2.jpg";
		}
		else{
			return "";
		}
...
if(Tools.isNull(mtype)){mtype=mtype.trim();}
Map<String,Object> map = new HashMap<String,Object>();
map.put("succ",new Boolean(true));
map.put("message",getHeightInfo2(gdsid,mtype));
