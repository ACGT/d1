...
<%!
public static ArrayList<PromotionProduct> getPProductlist(String code){
	ArrayList<PromotionProduct> rlist = new ArrayList<PromotionProduct>();
	        if (Tools.isNull(code)) return null;
	        code=code.trim();
			...
			List<BaseEntity> list = Tools.getManager(PromotionProduct.class).getList(clist, null, 0, 500);
...
List<PromotionProduct>  pplist=getPProductlist(code);
