...
private static Object[] getResultProductList(String productprice,String rackcode, String brandcode, String order, int start, int pagesize,HttpServletRequest request){
...
//////////////
Object[] obj = getResultProductList(productprice,productsort,brand,orderContent,0,10,request);
