...
<style>
   .alcontent .right .newbanner1120 {position: fixed;z-index: 20000; width:765px;top: 0px;text-align: left;height: 40px;background-image: url(http://images.d1.com.cn/images2012/aleeishe/images/002.jpg);background-repeat: no-repeat;padding-top: 15px;}
   .alcontent .right .newbanner1120 h4 {font-size: 14px;color: #712549;font-weight: 800;padding-left: 15px;float: left;width: 80px;}
   .alcontent .right .newbanner1120 li {margin-left: 10px;width: 80px;background-color: #D689AB;height: 20px;float: left;text-align: center;line-height: 20px;}
   .alcontent .right .newbanner1120 li a {color: white;text-decoration: none;}
</style>
	...
	<div class="autobody">
         ...
         <div class="altop">
			 ...
			 <ul>      
				...
				<li <% if(ps.equals("020010")) out.print("class=\"lifestyle\"");%>><a href="http://aleeishe.d1.com.cn/ascategorydisplay.htm?productsort=020010">裙子</a></li>
				...
				<li <% if(ps.equals("020008,020009")) out.print("class=\"lifestyle\"");%>><a href="http://aleeishe.d1.com.cn/ascategorydisplay.htm?productsort=020008,020009">裤子</a></li>
				<li <% if(ps.equals("020006")) out.print("class=\"lifestyle\"");%>><a href="http://aleeishe.d1.com.cn/ascategorydisplay.htm?productsort=020006">外套</a></li>
