...
<style>
   .fclass .newbanner1120 {position: fixed;z-index: 20000; width:765px;top: 0px;text-align: left;height: 40px;background-image: url(http://images.d1.com.cn/images2012/feelmind/images/007.jpg);background-repeat: no-repeat;padding-top: 15px;}
   .fclass .newbanner1120 li {margin-left: 10px;width: 80px;background-color: #484848;height: 16px;float: left;text-align: center;padding-top: 4px;}
   .fclass .newbanner1120 li a {color: #888;text-decoration: none;}
   .fclass .newbanner1120 h4 {font-size: 14px;color: #888;font-weight: normal;padding-left: 15px;float: left;width: 80px;}
</style>
</head>
        		   ...
        		   %>
        			  <table style="border:none;" cellpadding="0" cellspacing="0">
        	           ...
        	           for(Product goods : gList){
        	        	...
        	        	<tr>
        	        	 <% }
        	        	  if(productsort.startsWith("03")||productsort.startsWith("015009")||productsort.startsWith("021")||productsort.startsWith("022")){%>
        				...
        				<div style="padding-left:15px;">
        					 ...
        					 <tr><td style="color:#919191;"> <span><strong style="font-size:16px;"><%=Tools.getFormatMoney(goods.getGdsmst_memberprice()) %></strong></span>&nbsp;&nbsp;<span class="delprice" style="text-decoration: line-through;"><%=Tools.getFormatMoney(goods.getGdsmst_saleprice()) %></span></td></tr>
        	        	  ...
        	        	  {%>
        					 ...
        					 <table style="border:none;" cellpadding="0" cellspacing="0" style="text-align:center; width:245px;">
        					 <tr><td height="8px"></td> </tr>
        					 <tr><td><a href="http://www.d1.com.cn/product/<%=id %>" target="_blank">
        					 <%
        					 if(goods.getGdsmst_img240300()!=null&&goods.getGdsmst_img240300().length()>0)
        					 {%>
        						  <img src="http://images.d1.com.cn<%=goods.getGdsmst_img240300() %>" width="240" height="300" border="0" /></a></td></tr>
        					
        					 <%}
        					 else
        					 {%>
        						 <img src="http://images.d1.com.cn<%=ProductHelper.getImageTo400(goods) %>" width="240" height="240" border="0" /></a></td></tr>
