  ...
  <div class="autobody">
     ...
     <div class="fmanc">
	   ...
	   <div class="fmancl">
	       ...
	       ArrayList<BrandRck> brlist=new ArrayList<BrandRck>();
	         ArrayList<BrandRck> brlist1=new ArrayList<BrandRck>();
	          ...
	          if(flagbrand.equals("1"))
	   			{%>
	   			<h3 style="font-size:15px; color:#fff;">男装分类</h3>
		        ...
		        if(flagbrand.equals("1"))
				{%>
				<h3 style="font-size:15px; color:#fff;">女装分类</h3>
				<ul class="one" style="padding-left:20px;">			
	   ...
	   <div class="fmancr">
		 ...
		 <!-- 商品推荐 -->
		  <div class="plist">
		           <a href="http://feelmind.d1.com.cn/fmcategorydisplay.htm?productsort=030007" target="_blank"> <h3>棉服/羽绒服</h3></a>
		           <div class="newlist">
		              <%= getProduct("8203",6) %>
		           </div>
		        </div>
		        <div class="plist">
	                <a href="http://feelmind.d1.com.cn/fmcategorydisplay.htm?productsort=030006004,030006003" target="_blank" style="color:#919191;"><h3>大衣/风衣</h3></a>
	                <div class="newlist">
	                <%= getProduct("8204",6) %>
	                </div>
	              </div>
	              <div class="plist">
	                <a href="http://feelmind.d1.com.cn/fmcategorydisplay.htm?productsort=030004" target="_blank" style="color:#919191;"><h3>毛衣</h3></a>
	                <div class="newlist">
	                <%= getProduct("8205",6) %>
	                </div>
	              </div>
	              ...
	              <div class="plist">
	                <a href="http://feelmind.d1.com.cn/fmcategorydisplay.htm?productsort=030002,030001" target="_blank" style="color:#919191;"><h3>T恤/衬衫</h3></a>
	                <div class="newlist">
	                <%= getProduct("7866",6) %>
	                </div>
	              </div>
