    ...
    <div class="stop">
	     <div style="height:80px;"></div>
			 ...
			 <ul>      
				...
				<li <% if(ps.equals("020010")) out.print("class=\"lifestyle\"");%>><a href="http://sheromo.d1.com.cn/srmcategorydisplay.htm?productsort=020010">裙装</a></li>
				...
				<li <% if(ps.equals("020009")) out.print("class=\"lifestyle\"");%>><a href="http://sheromo.d1.com.cn/srmcategorydisplay.htm?productsort=020009">裤装</a></li>
        	    	 ...
        	    	 for(Product p:gList)
        	    	 {
        	    			...
        	    			counts++;
        	 				...
        	 				if(p!=null&&p.getGdsmst_validflag()!=null&&p.getGdsmst_validflag().longValue()==1&&p.getGdsmst_ifhavegds()!=null&&p.getGdsmst_ifhavegds().longValue()==0)
        	 				{
        		              ...
        		              <span class="newspan1"><a href="http://www.d1.com.cn/product/<%=p.getId()%>#cmt2" target="_blank" rel="nofollow">评论(<%=CommentHelper.getCommentLength(p.getId()) %>)</a></span>
        		              </p>
