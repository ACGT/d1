...
public static String DoneAct(String orderId, HttpServletRequest request,HttpServletResponse response,User user,String ip) throws UnsupportedEncodingException
{
	...
	// String strMerchantID = "d1bianli";
	 ...
	 String strYijifen = Tools.getCookie(request,"yijifen");//易积分
	 String str360 = Tools.getCookie(request,"CPS360");//360
	 String strC2345 = Tools.getCookie(request,"C2345");//2345导航
	 ...
	 //忆起发，成果，领可特，51返利 购物券在联盟中不返利
	 	...
	 	if(existstkt || bgdsdh){
	         ...
	         strWangYi = "";strYijifen="";str360="";strC2345="";
	 	}
	 ...
	 if(!Tools.isNull(strD1_Kefu)||ip.equals("211.103.223.202")){
	     ...
	     strYiqifa = "";strLele = "";strYeedou = "";strWEIYI = "";strAigoVip = "";strPingan = "";
	     strYOYI = "";strIPVGOU = "";strSOHUVIP = "";strFANLI = "";strLhdlTemp = "";strYiGao = "";
	     strWangYi = "";strYijifen="";str360="";strC2345="";strSubad="";strSrcurl="";
	     IntfUtil.KillsCookies(response , "d1_kefu");
	     IntfUtil.DelCookie(response , "d1.com.cn.peoplercm.subad");
	 ...
	 boolean isuseCT=false;
	 boolean isuse139=false;
	 if(strCardMemo.startsWith("mqtdx")){
		 isuseCT=true;
	 }
	 if(strCardMemo.startsWith("mqt139")){
		 isuse139=true;
	 }
	 if (isuseCT || isuse139)//使用电信、139优惠券
     {
	 ...
	 if (qqLogin!=null&&!qqLogin.equals("null")){
	...
	// }
	 	...
	 	if (!Tools.isNull(isQQLoginUser))//QQ登录或使用电信、139优惠券
	 	{
	 	strLianmeng = "";strPlinfo = "";strChanet = "";strLtinfo="";
	     strLele = "";strYeedou = "";strWEIYI = "";strAigoVip = "";strPingan = "";
	     strYOYI = "";strIPVGOU = "";strSOHUVIP = "";strFANLI = "";strLhdlTemp = "";strYiGao = "";
	     strWangYi = "";strYijifen="";str360="";strC2345="";strLtinfo="";
	     isuseCT=false;
		  isuse139=false;//QQ登录忽略使用电信、139优惠券
	 	}
	  }
	 ...
	 if(user.getMbrmst_uid().endsWith("@51fanli") && user.getMbrmst_temp().trim().equals("51fanli")){
		 ...
		 strLtinfo = "";strLianmeng = "";strPlinfo = "";strChanet = "";strEqifa = "";strYiqifa_Cid = "";
		     strYiqifa = "";strLele = "";strYeedou = "";strWEIYI = "";strAigoVip = "";strPingan = "";
		     strYOYI = "";strIPVGOU = "";strSOHUVIP = "";strLhdlTemp = "";strYiGao = ""; strWangYi = "";strYijifen="";
		     str360="";strC2345="";
	 }
	 //商户合作下单13、清空Cookie
...
mqlkt  领克特
mqcg  成果*/
		 if(!strSubad.startsWith("mqyqf")&&!strSubad.startsWith("mqlkt")&&!strSubad.startsWith("mqcg")
				 &&!strSubad.startsWith("mqbyzx1312")){
		 strLtinfo = "";strPlinfo = "";strChanet = "";strEqifa = "";strYiqifa_Cid = "";
	     strYiqifa = "";strLele = "";strYeedou = "";strWEIYI = "";strAigoVip = "";strPingan = "";
	     strYOYI = "";strIPVGOU = "";strSOHUVIP = "";strFANLI = "";strLhdlTemp = "";strYiGao = "";
	     strWangYi = "";strYijifen="";str360="";strC2345="";
		 }
	 ...
	 if(!Tools.isNull(strWangYi)&&!strWangYi.equals("null"))//网易返利
	 {
		 postWangyi(order,orderId,fdtltktra,strWangYi);
	 }
	 if(!Tools.isNull(strYijifen)&&!strYijifen.equals("null"))//易积分 
	 {
		 OrderHelper.updateOdrmstCacheTemp(orderId,"Yijifen" + strYijifen);
	 }
	 if(!Tools.isNull(str360)&&!str360.equals("null"))//360 
	 {
		 OrderHelper.updateOdrmstCacheTemp(orderId,"cps360|" + str360);
	 }
	 if((!Tools.isNull(strLtinfo)&&!strLtinfo.equals("null")) ||  isuseCT || isuse139)  //领克特strLtinfo
	 {
		 retUrl= postLKT(order,orderId,fdtltktra,isQQLoginUser,strLtinfo,strLt_user_id,isuseCT,isuse139);
	 }
	 if(!Tools.isNull(strPlinfo)&&!strPlinfo.equals("null"))//领克特多参数
	 {
		 retUrl=postPlinfo(order,orderId,fdtltktra,strPlinfo,user.getMbrmst_uid(), user.getMbrmst_name());
	 }
	 if(!Tools.isNull(strChanet)&&!strChanet.equals("null"))//成果网
	 {
		 retUrl=postChanet(order,orderId,fdtltktra,strChanet);
	 }
	 if(!Tools.isNull(strEqifa)&&!strEqifa.equals("null") )//亿起发
	 {
		retUrl2= postEqifa(order,orderId,fdtltktra,strEqifa,strEQIFAsrc);
	 }
	 if(!Tools.isNull(strYiqifa)&&!strYiqifa.equals("null")||!Tools.isNull(isQQLoginUser))//亿起发
	 {
		 retUrl= postYiqifa(order,orderId,fdtltktra,strYiqifa,strYiqifa_Cid,isQQLoginUser);
	 }
	 if(!Tools.isNull(strLele)&&!strLele.equals("null"))//乐乐
	 {
		 postLele(order,orderId,fdtltktra,strLele,strLele_S);
	 }
	 if(!Tools.isNull(strYeedou)&&!strYeedou.equals("null"))//一兜
	 {
		 retUrl=postYeedou(order,orderId,fdtltktra,strYeedou);
	 }
	 if(!Tools.isNull(strWEIYI)&&!strWEIYI.equals("null"))//唯一
	 {
		 postWeiyi(order,orderId,fdtltktra,strWEIYI,user.getId());
	 }
	 if(!Tools.isNull(strIPVGOU)&&!strIPVGOU.equals("null"))//联通IPVGOU
	 {
		 postIpvgou(order,orderId,fdtltktra,strIPVGOU);
	 }
	 if(!Tools.isNull(strSOHUVIP)&&!strSOHUVIP.equals("null"))//搜狐VIP
	 {
		 postSohuvip(order,orderId,fdtltktra,strSOHUVIP);
	 }
	 if(!Tools.isNull(strAigoVip)&&!strAigoVip.equals("null"))//贵宾网
	 {
	 ...
	 if(!Tools.isNull(strYOYI)&&!strYOYI.equals("null"))//优易互通
	 {
	...
	//	 retUrl=retUrl= postFanli(order,orderId,fdtltktra,strFANLI);
	 //}
	 if((!Tools.isNull(strFANLI) &&!strFANLI.equals("null")) || isfanli)//返利网
	 {
		// System.out.print("111111111111111111111111111111");
		 ...
		 postFanli(order,orderId,fdtltktra,strFANLI,user,tracking_code,username);
	 }
	...
	// }
	 ...
	 if(!Tools.isNull(strYiGao)&&!strYiGao.equals("null"))//亿起发亿告
	 {
		 retUrl= postYigao(order,orderId,strYiGao);
	 }
	 if(!Tools.isNull(strC2345)&&!strC2345.equals("null"))//2345导航
	 {
		 postC2345(order,orderId,fdtltktra,strC2345);
	 }
	 if(!Tools.isNull(strD1_Kefu))//D1优尚客服下单
	 {
		 OrderHelper.updateOdrmstCacheTemp(orderId,"D1客服下单_" + strD1_Kefu);
	 }
	 if ((!Tools.isNull(retUrl)||!Tools.isNull(retUrl2) )&& Tools.isNull(strPlinfo)){
		 if(!Tools.isNull(retUrl)){
		 retUrl= "<img src=\""+retUrl+"\" width=1 height=1 style=display:none>";
		 }
		 if(!Tools.isNull(retUrl2)){
		 retUrl=retUrl+"<img src=\""+retUrl2+"\" width=1 height=1 style=display:none>";
		 }
	 }
	 return retUrl;
}
...
public static void postWangyi(OrderBase order ,String orderId,double fdtltktra,String strWangYi)
{
  ...
  * @return
  */
public static String postLKT(OrderBase order ,String orderId,double fdtltktra,String isQQLoginUser,String strLtinfo,String strLt_user_id,boolean isdx,boolean is139)
{
	String strOdrmstTemp = "linktech" + strLtinfo;
	 if (!Tools.isNull(strLtinfo)){
		if(strLtinfo.indexOf("A100136514")>=0)
		{
			strOdrmstTemp="qq_caibei"+strLtinfo;
	...
	if(odrdtl != null && !odrdtl.isEmpty()){
	    	for(OrderItemCache dtlcache : odrdtl){
	    		...
	    		if (Tools.isNull(strLt_p_cd)){
	    			...
	    			if(!Tools.isNull(isQQLoginUser) && Tools.isNull(strLtinfo))
	    			{
	    				strLt_c_cd="qq_login";
	    			}
	    		}
	        ...
	        if (!Tools.isNull(strLtinfo)){
		        if (strLtinfo.startsWith("A100136514")) {
	                ...
	                aid = strLtinfo.replace("99999999", strLt_user_id);
		        }
	        ...
	        else if (!Tools.isNull(isQQLoginUser) || isdx || is139)
	        {
	        	if (!Tools.isNull(isQQLoginUser)){
	        		 stbUrl.append("a_id=A100136514" + isQQLoginUser);
		...
		List<OrderItemCache> odrdtl=OrderItemHelper.getOrderItemCacheByOrderId(orderId);
     	...
     	String strPostUrl="http://www.chanet.com.cn/ec.cgi";
	    	...
	    	for(OrderItemCache dtlcache : odrdtl){
               ...
               if (dtlcache.getOdrdtl_downflag().longValue()==20){
            		strChanet0=strChanet0+"MS/"+flOdrdtlFinalPrice+"/"+dtlcache.getOdrdtl_gdscount().toString()+ ":";
	    				...
	    				dtlcache.getOdrdtl_gdsname().indexOf("诗若曼")>=0)
               {
               	strChanet0=strChanet0+"FM/"+flOdrdtlFinalPrice+"/"+dtlcache.getOdrdtl_gdscount().toString()+ ":";
               }else if (!dtlcache.getOdrdtl_shopcode().equals("00000000")&&!dtlcache.getOdrdtl_rackcode().startsWith("014")){
            	strChanet0=strChanet0+"D/"+flOdrdtlFinalPrice+"/"+dtlcache.getOdrdtl_gdscount().toString()+ ":";
               } else
               {
...
private static String cps_chanet(String rackcode)
{
    ...
    if (rackcode.startsWith("015009") || rackcode.startsWith("02")|| rackcode.startsWith("03"))
    {
        strcps_chanet = "C";
    }
    else
 ...
 * @param strYiqifa_Cid
 */
public static String postYiqifa(OrderBase order ,String orderId,double fdtltktra,String strYiqifa,String strYiqifa_Cid,String isQQLoginUser)
{
	boolean cbflag=false;
	String strOdrmstTemp = strYiqifa_Cid +"yiqifa" + strYiqifa;
	 if (!Tools.isNull(strYiqifa)){
		 if(strYiqifa.startsWith("435983|")||strYiqifa.startsWith("435983|"))
			{
			 cbflag=true;
			strOdrmstTemp="325yiqifaqq_caibei"+strYiqifa_Cid+"|"+strYiqifa;

			if(!Tools.isNull(isQQLoginUser))
			{
				strOdrmstTemp = "325yiqifacaibei_qqlogin"+strYiqifa_Cid+"|"+strYiqifa;
			}
			}
	 }
	 else
	 {          cbflag=true;
				strOdrmstTemp = "325yiqifaqq_login";
	 }
		...
		List<OrderItemCache> odrdtl=OrderItemHelper.getOrderItemCacheByOrderId(orderId);
     	...
     	if(odrdtl != null && !odrdtl.isEmpty()){
           ...
           strPost.append("&on="+orderId);
           if(!Tools.isNull(isQQLoginUser)){
           strPost.append("&qqoid="+isQQLoginUser);
           strPost.append("&qqmid=d1youshang");
           }
           strPost.append("&pn="+(!Tools.isNull(strYiqifa_gdsid)?cutend(strYiqifa_gdsid):""));
           strPost.append("&pna="+(!Tools.isNull(strYiqifa_gdsname)?cutend(strYiqifa_gdsname):""));
          
           if (Tools.isNull(strYiqifa)){
           strPost.append("&ct=qqlogin1");
           strPost.append("&ta=1");
           strPost.append("&pp="+order.getOdrmst_acturepaymoney());
           }else{
        	   strPost.append("&ct="+(!Tools.isNull(strYiqifa_rackcode)?cutend(strYiqifa_rackcode):""));
               strPost.append("&ta="+cutend(strYiqifa_gdscount));  
               strPost.append("&pp="+cutend(strYiqifa_finalprice));
           }
           
           strPost.append("&sd="+sd+"&dt=web");
		...
		List<OrderItemCache> odrdtl=OrderItemHelper.getOrderItemCacheByOrderId(orderId);
     	...
     	if(odrdtl != null && !odrdtl.isEmpty()){
          ...
          //  String ret=InterfacePost.Postdata(strPostUrl, strPost.toString());
     		//System.out.println("d1gjllmpinganret:"+strPost.toString());
       ...
       String strFanli_comm ="";
     	if(odrdtl != null && !odrdtl.isEmpty()){
	    	for(OrderItemCache dtlcache : odrdtl){
               ...
               if ( "001346".equals(strGdsBrand)|| //F&M
	            		 "001561".equals(strGdsBrand) ||//YouSoo
	            		 "001564".equals(strGdsBrand))//小栗舍
 ...
 * @param strFANLI
 */
public static void postFanli(OrderBase order ,String orderId,double fdtltktra,String strFANLI,User user,String tracking_code,String username)
{
	String temp="";
	...
	if(Tools.isNull(strFANLI)&& Tools.isNull(username)){
	...
	temp+="|"+tracking_code;
		...
		List<OrderItemCache> odrdtl=OrderItemHelper.getOrderItemCacheByOrderId(orderId);
     	...
     	long iOdrdtlSpecialFlag=0;
     	double flOdrdtlFinalPrice=0;
     	String strPostUrl="http://data2.51fanli.com/index.php/DataHandle/handlePostData";
     	String strFanli_gdsid ="";
     	String strFanli_rackcode ="";
     	String strFanli_gdscount = "";
     	String strFanli_finalprice = "";
	...
	if(!Tools.isNull(strFANLI)){
     ...
     //  }
       String strPassCode =orderId+"d1"+strFanliUid+shopkey;
		strPassCode=MD5.to32MD5(strPassCode.toLowerCase());
		
		
       str.append( "<?xml version=\"1.0\" encoding=\"utf-8\" ?>");
		str.append("<fanli_data version=\"3.0\">");
		  str.append("<order order_time=\"");
		  str.append(Tools.stockFormatDate((order.getOdrmst_orderdate())));
		  str.append("\" order_no=\"");
		  str.append(orderId);
		  str.append("\"  shop_no=\"d1\"");
		  str.append(" total_price=\"");
		  str.append(Tools.getDouble(order.getOdrmst_gdsmoney().doubleValue()-order.getOdrmst_tktvalue().doubleValue(),2));
     	...
     	if(odrdtl != null && !odrdtl.isEmpty()){
     		  String str1=" <coupons_all>";
			  str.append(" <products_all>");
	    	for(OrderItemCache dtlcache : odrdtl){
	    		strRackcode=dtlcache.getOdrdtl_rackcode();
               iOdrdtlSpecialFlag=dtlcache.getOdrdtl_specialflag();
              // if (iOdrdtlSpecialFlag==1 || dtlcache.getOdrdtl_gdsname().indexOf("优惠特价")>=0 || "团购商品".equals(dtlcache.getOdrdtl_temp()))
            ...
            //   }
               ...
               strFanli_gdsid+=dtlcache.getOdrdtl_gdsid()+"|_|";   
               Product product=ProductHelper.getById(dtlcache.getOdrdtl_gdsid());
               strGdsBrand=product.getGdsmst_brand().trim();
               if ( "001346".equals(strGdsBrand)|| //F&M
	            		 "001561".equals(strGdsBrand) ||//YouSoo
	            		 "001564".equals(strGdsBrand))//小栗舍
               ...
               else if(strRackcode.startsWith("020") || strRackcode.startsWith("030") ||//服装
               		strRackcode.startsWith("015009"))//饰品
               {
               	fltFanLi_fl = 0.08f;
                   strFanLi_c_cd = "A";
               ...
               str.append("</product_id>");
               str.append("<product_url>http://www.d1.com.cn/product/");
               str.append(dtlcache.getOdrdtl_gdsid());
               str.append("</product_url>");
               str.append("<product_qty>");
               str.append(dtlcache.getOdrdtl_gdscount()+"");
               str.append("</product_qty>");
               str.append("<product_price>");
               str.append(Tools.getDouble(flOdrdtlFinalPrice,2));
               str.append("</product_price>");
               str.append("<product_comm>");
               str.append(Tools.getDouble(fltFanLi_fl,2));
               str.append("</product_comm>");
              // str.append("<consume> 0 </consume>");
               str.append("<comm_no>");
               str.append(strFanLi_c_cd);
               str.append("</comm_no>");
               str.append("</product>");
            
               str1+="<coupon><coupon_no>"+tktid+"</coupon_no><coupon_qty>1</coupon_qty><coupon_price>"+-Tools.getDouble((dtlcache.getOdrdtl_finalprice().doubleValue()*(1-lmtktra)),2)+"</coupon_price>";
			  str1+="<comm_no>"+strFanLi_c_cd+"</comm_no ></coupon>";
	    	}
	    	  str1+="</coupons_all>";
			  str.append("</products_all>"); 
			  str.append(str1);
...
public static void postC2345(OrderBase order ,String orderId,double fdtltktra,String strc2345)
{
	OrderHelper.updateOdrmstCacheTemp(orderId,"C2345" + strc2345);
	
	String strcp_key="0de04d25f205eddc9d521ea1f46dde9a";
  	String strPostUrl="http://cps.2345.com/server/push/";
  	
String params="";
	
    long acttime=(new Date()).getTime()/1000;
    String bid="2014070945";
    String signrnew=bid+"#"+acttime+"#"+strcp_key+"#"+0+"#";
    String signnew= MD5.to32MD5(signrnew, "Utf-8");
	  	 StringBuilder strPost=new StringBuilder();
	     strPost.append("bid="+bid);
         strPost.append("&passid=0");
         strPost.append("&username=");
         strPost.append("&active_time="+acttime);
         strPost.append("&sign="+signnew);
         strPost.append("&order_id="+orderId);
         System.out.println("C2345===="+strPost.toString());
      String ret= HttpUtil.getUrlContentByPost(strPostUrl, strPost.toString(),"utf-8");
      System.out.println("C2345===="+ret);
