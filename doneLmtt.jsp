...
public static String DoneAct(String orderId, HttpServletRequest request,HttpServletResponse response,User user) throws UnsupportedEncodingException
{
	...
	//14、来源地址
	 ...
	 {
		 System.out.println("d1gjllm:"+strSubad);
	 ...
	 if ("emar_cps".equals(strEQIFAsrc.toLowerCase()) && !Tools.isNull(strEQIFAsrc)){
		...
		List<OrderItemCache> odrdtl=OrderItemHelper.getOrderItemCacheByOrderId(orderId);
     	...
     	if(odrdtl != null && !odrdtl.isEmpty()){
           ...
           strPost.append("&order_user="+order.getOdrmst_rname());
