...
.wul{ overflow:hidden;}
.wul li{ width:326px; border-right:dashed 1px #c4c4c4; float:left; padding-bottom:5px; margin-bottom:25px;}
...
.nul{ padding-top:3px;}
table{ width:278px; font-size:12px; color:#000;}
...
table td em{ text-decoration:none; color:#ce0000; font-weight:bold;}
table td img{vertical-align:text-bottom; }
...
table td span{ font-size:45px; line-height:55px; color:#fff;  position:absolute;  font-family:'微软雅黑'; margin-left:-270px; _margin-left:-140px; +margin-left:-140px; margin-top:-5px;}
table td span font{  font-size:35px;}
	     ...
	     if(list!=null&&list.size()>0)
	     {
	    	 ...
	    	 for(int i=0;i<list.size();i++)
	    	 {
			     ...
			     <tr><td colspan="2" height="30" id="tjjs_<%=i%>"><img src="http://images.d1.com.cn/images2012/timer.jpg"/>&nbsp;剩余时间:<em>00</em>天<em>00</em>小时<em>00</em>分<em>00</em>秒
				  ...
				  <tr><td colspan="2" height="55"><a  href="###" attr="<%=pp.getId() %>" onclick="addCart(this);" class="posa"><img src="http://images.d1.com.cn/images2012/tuanbutton.gif" width="281" height="55" /></a><span><font>￥</font><%= tprice %></span></td>
				 </tr>
				 <tr>
...
().floatValue())*10,1) %>折</td><td><img src="http://images.d1.com.cn/images2012/person.jpg" style=" vertical-align:baseline"/><font class="font"><%= pp.getSpgdsrcm_tghit() %></font>人购买</td>
					    	   ...
					    	   <div class="tdiv">
					    	   <a href="/product/<%= pp.getSpgdsrcm_gdsid() %>" target="_blank" title="<%= Tools.clearHTML(pp.getSpgdsrcm_gdsname()) %>"  ><%= Tools.substring(pp.getSpgdsrcm_gdsname(),68)+"..." %></a>
					    	   </div>	  
