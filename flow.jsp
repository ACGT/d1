...
<script type="text/javascript" src="<%=com.d1.helper.ResourceHelper.getResourceVersion("/res/js/flow/flow.js")%>"></script>
...
.zplist li{ float:left;margin-left:20px;_margin-left:15px; width:200px; overflow:hidden;height:240px;}
...
.zplist li .cspan3{ display:block; margin-top:5px;color:#cb0000;font-weight:800;}
                                ...
                                int oldactid=0;
                                 for(Cart cart : cartList2){
									 ...
									 if(oldactid!=actid){
										...
										if(d1act.getD1acttb_acttype().longValue()==3){
...
d1优尚库房放假，暂停发货。
<br>
为了表示歉意，1月26日-2月14日付款的所有订单，都将获得一次领红包的机会（支付后在d1优尚手机端订单页面领取红包）<br>		
								  ...
								  <div class="goods_list" id="zengpin_area" style="padding-bottom:30px;">
...
if((!Tools.isNull(Dspeqifa)||(DspSubad!=null&&DspSubad.startsWith("mqyqfdsp")))&&1==2){
	String userid="";
