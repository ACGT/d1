			...
			if(p!=null)
			{
				...
				for(PromotionImagePos pip:piplist)
				{
					...
					if(pip!=null)
					{
						...
						if(product!=null)
						{
							 sb.append("<a href=\"/product/"+pip.getProductId()+"\" target=\"_blank\">"+Tools.substring(Tools.clearHTML(product.getGdsmst_gdsname()),50)+"</a>&nbsp;&nbsp;");
 ...
 <!-- 头部 -->
   ...
   <div class="gdscene_center">
       <div class="gdscene_top">
            <div id="dh">
              <a href="" target="_blank">首页</a> >场景搭配 ><a href="/html/cosmetic/">化妆品</a>>防晒集结号
             </div>   
         </div>
         <%= getCZlog("2947",2) %>
      <div class="clear"></div>
       ...
       <div class="gdtj">
          ...
          <img src="http://images.d1.com.cn/images2012/index2012/gdtj2012.jpg"/>
           <% request.setAttribute("code","7748");
