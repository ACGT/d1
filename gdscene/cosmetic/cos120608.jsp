		...
		if(list!=null&&list.size()>0&&list.get(0)!=null)
		{
			...
			for(PromotionImagePos pip:piplist)
			{
				...
				if(pip!=null)
				{
					...
					map.append("<area shape=\"rect\" coords=\"").append(pip.getPos_x()+",").append(pip.getPos_y()+",").append(pip.getExt1()+",").append(pip.getExt2()).append("\"").append(""); 
					Product product=ProductHelper.getById(pip.getProductId());
					if(product!=null)
					{
						sb.append("<li><a href=\"/product/"+pip.getProductId()+"\" target=\"_blank\">"+Tools.substring(Tools.clearHTML(product.getGdsmst_gdsname()),40)+"</a>");
			...
			if(p!=null)
			{
				...
				for(PromotionImagePos pip:piplist)
				{
					...
					if(pip!=null)
					{
						...
						if(product!=null)
						{
							 sb.append("<a href=\"/product/"+pip.getProductId()+"\" target=\"_blank\">"+Tools.substring(Tools.clearHTML(product.getGdsmst_gdsname()),59)+"</a>&nbsp;&nbsp;");
...
<style type="text/css">
    ...
    a img{ border:none;}
    .gdscene_center{ margin:0px auto; background:#fff; +margin-top:10px;}
    ...
    .gdscsne_logo{ margin:0px auto; width:980px; margin-top:10px; }
    ...
    .logofloat ul li{ width:150px; overflow:hidden; height:62px; padding-top:8px;line-height:18px; font-size:13px;  float:left; margin-right:32px; text-align:left;}
    font{ font-family:'微软雅黑'; font-size:12px; font-weight:bold; color:#4e4e4e;}
    .font1{ color:#be0000; }
    .font2{ color:#4e4e4e; }
    .imglists{ width:980px; margin:0px auto;margin-top:10px;}
    .imglists ul{ width:980px;  overflow:hidden; margin:0px auto;  list-style:none; padding:0px;}
    .imglists ul li{ width:480px; margin-right:20px; float:left; margin-bottom:10px;}
    .imglists ul li div{ width:445px; height:95px; padding-left:15px; padding-top:10px; line-height:22px;  background:none;background-color: #fff;position:absolute; _position:relatice; +position:relatice;  margin-top:-120px; margin-left:10px;filter: alpha(opacity=80);-moz-opacity: 0.8;opacity: 0.8;  -moz-border-radius: 10px; -webkit-border-radius: 10px;  border-radius: 10px;}
 ...
 <!-- 头部 -->
   ...
   <div class="gdscene_center">
       <div class="gdscene_top">
            <div id="dh">
              <a href="" target="_blank">首页</a> >场景搭配 ><a href="/html/cosmetic/">化妆品</a>>肌肤守护神，“膜”法到底
             </div>   
         </div>
         <%= getCZlog("3085",2) %>
      <div class="clear"></div>
       ...
       <div class="gdtj">
          ...
          <img src="http://images.d1.com.cn/images2012/index2012/gdtj2012.jpg"/>
           <% request.setAttribute("code","7767");
