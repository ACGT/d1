         ...
         <% 
             for(Gdsscene gt:glist)
        	 {
        	     ...
        	     <%}
        	      ...
        	      {%>
        	    	  <a href="/gdscene/index.jsp?id=<%=gt.getId() %>" target="_blank"><img src="http://images1.d1.com.cn<%=imgurl %>" width="80" height="80" style="margin-top:15px;" id="fimg<%=count %>"/></a>
		    	   ...
		    	   <%
		    	       for(Gdscolldetail gd:gdlist1)
		    	       {
		    	    	   ...
		    	    	   if(p!=null&&p.getGdsmst_ifhavegds().longValue()==0&&p.getGdsmst_validflag().longValue()==1&&gd.getGdscolldetail_gdsflag()!=null&&gd.getGdscolldetail_gdsflag().longValue()==1&&ProductStockHelper.canBuy(p))
		    	    	   {
		    	    		   ...
		    	    		   %>
		    	    		   <span><a href="/product/<%= p.getId() %>" target="_blank" style="color:#333"><%= gd.getGdscolldetail_title() %></a>:<font class="font1">￥<%= (int)Math.ceil(p.getGdsmst_memberprice().floatValue())%></font>&nbsp;&nbsp;&nbsp;&nbsp;
        		   ...
        		   { 
        			...
        			<div style="position:relative;">
        			 <div style=" width:316px; height:380px; overflow:hidden; background:url('http://images1.d1.com.cn<%= gdsscene.getGdsscene_imgbg()%>') repeat-x; ">
        			    <a href="/gdscoll/index.jsp?id=<%= gds.getId() %>&sf=<%= gdsscene.getId() %>" target="_blank"><img src="http://images1.d1.com.cn<%= gds.getGdscoll_brandimg() %>" style="left:-60px; position:absolute; margin-top:22px; z-index:22;" /></a>
        			        ...
        			        %>
        			    	   ...
        			    	   <%
        			    	       ...
        			    	       for(Gdscolldetail gd:gdlist)
        			    	       {
        			    	    	   ...
        			    	    	   if(p!=null&&p.getGdsmst_ifhavegds().longValue()==0&&p.getGdsmst_validflag().longValue()==1&&gd.getGdscolldetail_gdsflag()!=null&&gd.getGdscolldetail_gdsflag().longValue()==1&&ProductStockHelper.canBuy(p))
        			    	    	   {
        			    	    		   ...
        			    	    		   zhprice+=Tools.getFloat((int)(p.getGdsmst_memberprice().floatValue()*0.95), 2);
        			    	    		   %>
        			    	    		   <span><a href="/product/<%= p.getId() %>" target="_blank" ><%= gd.getGdscolldetail_title() %></a>:<font class="font1">￥<%= (int)Math.ceil(p.getGdsmst_memberprice().floatValue())%></font>&nbsp;&nbsp;&nbsp;&nbsp;
        			    	    		   <a href="javascript:void(0)" attr="<%= p.getId() %>" onclick="AddGdscollInCart(this);" ><img src="http://images.d1.com.cn/images2012/index2012/buy.gif" style="vertical-align:text-bottom;"/></a>
        			    	    	       </span>
        			    	   ...
        			    	   %>
                                ...
                                <strike>总价：￥<font id="memberP<%= count%>"><%=(int)sum %></font><br/></strike>组合价：<font style='color:#be0000; font-size:14px;'><b>￥<font id="pktP<%= count%>"><%= (int)zhprice %></font></b></font><br/>共优惠：￥<font id="cheap<%= count%>"><%= (int)(sum-zhprice) %></font>
                                 ...
                                 <span style="margin-top:5px;padding-left:1px; height:26px; ">
