	                ...
	                <ul>
		    	       ...
		    	       %>
		    	              <li>
		    	                 ...
		    	                 <input type="checkbox" name="chk_0" checked value="<%= gd.getGdscolldetail_gdsid() %>"  onClick="selectInitdp('<%=Tools.getFormatMoney(p.getGdsmst_memberprice())%>',this.checked,0)" >&nbsp;<%= gd.getGdscolldetail_title() %></input>
<font style="color:#be0000">￥<%= Tools.getFormatMoney(p.getGdsmst_memberprice().floatValue()) %></font>
	        					      ...
	        					      if(gdetail!=null&&gdetail.getGdscolldetail_gdsid()!=null&&gdetail.getGdscolldetail_gdsid().length()>0)
	        					      {
	        					    	  Product pro=ProductHelper.getById(gdetail.getGdscolldetail_gdsid());
	        					    	  {
	        					    		 if(pro!=null&&pro.getGdsmst_ifhavegds().longValue()==0&&pro.getGdsmst_validflag().longValue()==1&&ProductStockHelper.canBuy(pro))
	        					    		 {
		    	                                   ...
		    	                                   <input type="checkbox" name="chk_0"  value="<%= pro.getId() %>" onClick="selectInitdp('<%=Tools.getFormatMoney(pro.getGdsmst_memberprice())%>',this.checked,0)" >&nbsp;<%= gdetail.getGdscolldetail_title() %>
	                   ...
	                   <span>
	                    ...
	                    <table style="color:#000;">
	                       <tr><td width="100"></td><td width="100">共<em id="amount0"><%= counts%></em>件</td><td>组合价：<font id="pktP0"><%= (int)zhprice %></font></td><td width="40"></td><td rowspan="2"><font style="font-size:16px; color:#f00;">搭配购买立享95折！</font><br/><a href="javascript:void(0)" code="<%= tg.getId() %>" onclick="check_gdscoll20120710(this,'0')" style="color:#fff; font-size:14px;"><img src="http://images.d1.com.cn/images2012/index2012/JULY/ljzhgm.jpg"/></a></td></tr>
	                       <tr><td></td><td>总价：<font id="memberP0"><%=(int)sum %></font></td><td>共优惠：<font id="cheap0"><%= (int)(sum-zhprice) %></font></td><td></td></tr>
	                    </table>
	                   </span>
