...
<%@include file="/inc/head.jsp" %>
   ...
   <%  if(id!=null&&id.length()>0&&Tools.isMath(id)&&gdscoll!=null)
       ...
       <a href="<%= url%>" target="_blank"><img src="http://images1.d1.com.cn<% if(gdsser!=null&&gdsser.getGdsser_timg()!=null) out.print(gdsser.getGdsser_timg()); %>" style="position:absolute;" width="286" height="231"/></a>
       </div>
       <div class="otherdp">
       <%  
           String sf="";
          ...
          if(sf.length()>0&&Tools.isMath(sf))
          {
        	  ...
        	  if(sf!=null)
        	  {
        			...
        			for(int i=0;i<newstr.length;i++)
        			{
        				...
        				{%>
        					<table height="188">
           	             <tr><td width="88"><a href="/gdscoll/index.jsp?id=<%= g.getId() %>&sf=<%=sf %>" target="_blank">
           	             <img src="http://images1.d1.com.cn<%= g.getGdscoll_smallimgurl() %>" width="88" height="127"/></a></td>
           	                 <td>
           	               <%
           	               ...
           	               %>           
           	              <br/>
           	                     <a href="/gdscoll/index.jsp?id=<%= g.getId() %>&sf=<%= sf %>" target="_blank"><img src="http://images.d1.com.cn/images2012/index2012/look.jpg" width="65" heihgt="25"/></a>
           	                 </td>
           	             </tr>
           	          </table>
        			<%	}
          ...
          {%>
           ...
           if(list!=null&&list.size()>0)
           {
        	   ...
        	   for(Gdscoll gds:list)
        	   {
        		   ...
        		   %>
        			   <table height="188">
        	             <tr><td width="88"><a href="/gdscoll/index.jsp?id=<%= gds.getId() %>" target="_blank">
        	             <img src="http://images1.d1.com.cn<%= gds.getGdscoll_smallimgurl() %>" width="88" height="127"/></a></td>
	         			      ...
	         			      if(gdlist!=null&&gdlist.size()>0)
	         			      {
	         			    	  for(Gdscolldetail gd:gdlist)
	         			    	  {
	         			    		  if(gd!=null&&gd.getGdscolldetail_gdsflag().longValue()==1)
	         			    		  {
	         			    			  ...
	         			    			  {
	         			    				  %>
	         			    				  <a href="/product/<%= gd.getGdscolldetail_gdsid() %>" target="_blank"><%= gd.getGdscolldetail_title() %></a>:￥<%= (int)Math.ceil(p.getGdsmst_memberprice().floatValue()) %><br/>
	         			    			  <%}
	         			    		  }
	         			    	  }
	         			      }
        	               %>           
        	              <br/>
        	                     <a href="/gdscoll/index.jsp?id=<%= gds.getId() %>" target="_blank"><img src="http://images.d1.com.cn/images2012/index2012/look.jpg" width="65" heihgt="25"/></a>
        	                 </td>
        	             </tr>
        	          </table>
        		   <%}
	                ...
	                <ul>
		    	       ...
		    	       %>
		    	              <li>
		    	                 ...
		    	                 <input type="checkbox" name="chk_0" checked value="<%= gd.getGdscolldetail_gdsid() %>"  onClick="selectInitdp1209('<%=Tools.getFormatMoney(p.getGdsmst_memberprice())%>',this.checked,0)" >&nbsp;<%= gd.getGdscolldetail_title() %></input>
	        					    	  ...
	        					    	  Product pro=ProductHelper.getById(gdetail.getGdscolldetail_gdsid());
	        					    	  {
	        					    		 if(pro!=null&&pro.getGdsmst_ifhavegds().longValue()==0&&pro.getGdsmst_validflag().longValue()==1&&ProductStockHelper.canBuy(pro))
	        					    		 {
	        					    			 zzsum++;
		    	                                   ...
		    	                                   <input type="checkbox" name="chk_0"  value="<%= pro.getId() %>" onClick="selectInitdp1209('<%=Tools.getFormatMoney(pro.getGdsmst_memberprice())%>',this.checked,0)" >&nbsp;<%= gdetail.getGdscolldetail_title() %>
              ...
              for(Gdscolldetail gdetail:gdlist)
              {
            	  if(gdetail!=null)
            	  {
            		  ...
            		  if(p!=null)
            		  {
            			  ...
            			  {
            				  imgurl="http://images.d1.com.cn"+gci.getGdscutimg_300();
            			  }
            			  else
            			  {
                 ...
                 <a href="/product/<%= p.getId() %>" target="_blank"><img src="<%= imgurl %>" width="300" height="300"/></a> </td>
                 <td width="434" style="padding-left:50px;">
                    <span class="title"><a href="/product/<%= p.getId() %>" target="_blank"><%= p.getGdsmst_gdsname() %></a></span><br/>
				     ...
				     <div style="float:left;color:#204e99;"><a href="/product/<%= p.getId() %>#cmt2" target="_blank">(已有<%=contentcount %>人评价)</a></div>
				     <div class="clear"></div>
						 <div class="spgg">
						 <%          
