...
<td  class="td1"><a class="a1" href="index.jsp?productsort=020008004">牛仔裤</a></td>
<td  class="td1"><a class="a1" href="index.jsp?productsort=020010004">连衣裙</a></td>
<td  class="td1"><a class="a1"  href="index.jsp?productsort=020006" >外套/大衣</a></td>
...
<table width="980" border="0" cellspacing="0" cellpadding="0"  height="35" align="center">
    ...
    <table width="980" border="0" cellspacing="0" cellpadding="0"  height="15" align="center"></table>
<%
int total=0;
...
if(request.getParameter("productsort")==null)
{
	...
	total=getPageTotalByRCode(brandname, productname, productsort+"%");
	list=getProductListByRCode( brandname, productname, sequence, productsort+"%", sequenceprice,currentPageIndex,pagesize);
