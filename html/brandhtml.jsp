   ...
   if(gdscolllist!=null&&gdscolllist.size()>0)
   {
     int counts=0;
      %>
	             ...
	             <tr>
	             <td>
                    <div id="banner<%=gdsid+count %>" class="allb">    
                    <%  if(gdscolllist.size()>1){ %>
                      <div class="pre" id="pre2012<%=gdsid+count%>"><img src="http://images.d1.com.cn/images2012/index2012/left.png"/></div>
                      <div class="next" id="next2012<%=gdsid+count%>"><img src="http://images.d1.com.cn/images2012/index2012/right.png"/></div>
			          <%} %>
			    <div class="clear"></div>
			    <!-- 背景图片 -->
			    <%
			    ...
			    %>
			    <div id="banner_list<%=gdsid+count %>" class="allimglist"  style="background:url('<%= bgimg %>') no-repeat;">
			 ...
			 %>
              ...
              <script>scrollresult('#banner_list<%= gdsid+ count%>','#banner<%=gdsid+ count%>','<%=gdsid+count%>');</script>
	             </td>
	             </tr>
             </table>
