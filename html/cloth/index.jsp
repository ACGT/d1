...
%> 
<%response.sendRedirect("http://www.d1.com.cn/html/women/");
%>
...
<body>
	...
	<div class="clear"></div>
	 ...
	 <map name="maptc" id="maptc">
	            <area shape="rect" coords="0,0,120,55" href="http://www.d1.com.cn/result.jsp?productsort=020&order=3" target="_blank">
	          </map>
</body>
</html>
