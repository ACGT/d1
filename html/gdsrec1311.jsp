...
<div style="width:880px;  text-align:center;padding-left:50px">
<div style="width:880px; overflow:hidden;  padding-bottom:18px; ">
<%
String code="7006";
		...
		for(Product product:productlist){
			...
			if(pproductlist!=null && directory!=null){
			 ...
			 request.setAttribute("t", t);
			   ...
			   if(product.getGdsmst_rackcode().startsWith("014")){
				   %>
	<div style="  float:left;  width:212px;height:310px; /*FF*/ *height:310px;/*IE7*/ _height:310px;/*IE6*/ _width:212px; <%if (l!=0 && i%4!=0 ){ %>		  margin-left:5px; <%}else{%> margin-left:5px; _margin-left:5px;/*IE6*/ <% }%> margin-top:8px; padding-top:10px; line-height:21px; background-color:#FFFFFF; overflow:hidden;" >
...
<div style="  float:left;  width:212px;height:400px; /*FF*/ *height:400px;/*IE7*/ _height:400px;/*IE6*/ _width:212px; <%if (l!=0 && i%4!=0 ){ %>		  margin-left:5px; <%}else{%> margin-left:5px; _margin-left:5px;/*IE6*/ <% }%> margin-top:8px; padding-top:10px; line-height:21px; background-color:#FFFFFF; overflow:hidden;" >
<%}else{ %>
<div style="  float:left;  width:212px;height:360px; /*FF*/ *height:360px;/*IE7*/ _height:360px;/*IE6*/ _width:212px; <%if (l!=0 && i%4!=0 ){ %>		  margin-left:5px; <%}else{%> margin-left:5px; _margin-left:5px;/*IE6*/ <% }%> margin-top:8px; padding-top:10px; line-height:21px; background-color:#FFFFFF; overflow:hidden;" >

<%}} %>
<dl style="text-align:left;">
<dt style="width:200px; text-align:center;padding-left:6px; ">
<%if (product.getGdsmst_rackcode().startsWith("014")){ %>
		...
		out.print("</div>");
		 ...
		 if(code.equals("8996")){ %>
		 <div style=" height:24px;width:200px;color:#fff;background-color:#d70b52;text-align:center">双11销售：<%=pProduct.getSpgdsrcm_tghit() %>件</div>
		 <%} %>
</dd>
</dl>
</div>
