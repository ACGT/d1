...
<div style="  float:left;  width:231px;height:300px; /*FF*/ *height:300px;/*IE7*/ _height:300px;/*IE6*/ _width:232px; <%if (l!=0 && i%4!=0 ){ %>		  margin-left:15px; <%}else{%> margin-left:10px; _margin-left:5px;/*IE6*/ <% }%> margin-top:8px; padding-top:10px; line-height:21px; background-color:#FFFFFF; overflow:hidden;" >
...
<dt style="width:205px; text-align:center;padding-left:10px; ">
		...
		<!--  <span style="font-size:15px;font-weight:bold;color:#ff0000;">会员价:￥<%=sprice%>&nbsp;</span><br>-->
		<span style="font-size:12px;width:90px;color:#666666;display:block;float:left;">市场价：￥<%= ProductGroupHelper.getRoundPrice(product.getGdsmst_saleprice()) %>&nbsp;&nbsp;</span>
		<span style=" font-family:'微软雅黑';color:#C00000;display:block;float:left; font-weight:bold; font-size:30px;">￥<%=sprice%></span>
