...
<div style="width:950; background-color:#CCCCCC; text-align:center;">
<div style="width:950px;overflow:hidden;  padding-bottom:18px;">
<%
String code="7006";
		...
		for(Product product:productlist){
			...
			if(pproductlist!=null && directory!=null){
			 ...
			 request.setAttribute("t", t);
			   ...
			   if(code.equals("8978")||code.equals("8979")||code.equals("8980")){
				   sprice=ProductGroupHelper.getRoundPrice(product.getGdsmst_saleprice());
			   }
			   
			//   double dl= Tools.getDouble(product.getGdsmst_memberprice().doubleValue()*10/,1);
				 //String fl=ProductGroupHelper.getRoundPrice((float)dl);
	%>
	
	<div style="width:231px; float:left; height:290px; /*FF*/ *height:290px;/*IE7*/ _height:290px;/*IE6*/ <%if (l!=0 && i%4!=0 ){ %>		  margin-left:8px; <%}else{%> margin-left:5px; _margin-left:4px;/*IE6*/ <% }%> margin-top:8px; padding-top:10px; line-height:21px; background-color:#FFFFFF;" >
...
<dt style="width:205px; text-align:center;padding-left:10px; float:left">
		...
		<font style="font-size:10pt" color="#3c3c3c"><%=Tools.substring(product.getGdsmst_gdsname(),48)%></font></a></div>
		<span style="font-size:12px;font-weight:bold;color:#666666;"><strike>会员价:￥<%=sprice%></strike><%
		
		String imgstr="5z.gif";
		if(code.equals("8971")||code.equals("8979")){
			imgstr="6z.gif";
		}else if(code.equals("8972")||code.equals("8980")){
			imgstr="7z.gif";
		} %>
		<img src="http://images.d1.com.cn/zt2013/qc1108/<%=imgstr%>"></span><br>
		<span style="font-size:28px;font-weight:bold;color:#ff0000;"><img src="http://images.d1.com.cn/zt2013/cj1311/1111price.png" />
		 <%SimpleDateFormat   df=new   SimpleDateFormat("yyyy-MM-dd HH:mm:ss");  
              String end="2013-11-10 23:50:00";
