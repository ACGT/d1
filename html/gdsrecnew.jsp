...
<% 
           				...
           				if(Tools.isNull(product.getGdsmst_img240300())){
           					...
           					<p style="z-index:999;position:relative; padding-top:30px; padding-bottom:30px;"><a href="<%=ProductHelper.getProductUrl(product) %>" target="_blank" >
           								...
           								<%if (code.equals("8486")){ %>
           								<span style="position:absolute; width:62px; height:54px; dislay:block; background:url('http://images.d1.com.cn/zt2012/20130218sbj/new.png'); left:0px; top:-5px; z-index:5000;"></span>
           				<%}}else{
