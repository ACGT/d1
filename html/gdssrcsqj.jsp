...
<style type="text/css">
.newlist {width:961px;overflow:hidden; margin:0px auto; background-color:#f0f0f0; margin-left:12px; }
.newlist ul {width:961px;padding:0 0 0px; padding-left:24px;  padding-top:15px; padding-bottom:15px;}
.newlist li {float:left; margin-right:24px;overflow:hidden; width:210px; overflow:hidden; margin-bottom:20px;  }
...
<div style="width:980px; background:url('http://images.d1.com.cn/images2012/index2012/SEP/recbg.JPG') ; text-align:center;">
<div class="newlist" style="width:961px; overflow:hidden;  padding-bottom:18px; ">
<ul>
<%
String code="7006";
...
<% 
        ...
        if(com!=null){%>
      	  <div class="lb" title="<%= com.getGdscom_content() %>"><b><%= CommentHelper.GetCommentUid(com.getGdscom_uid())+"：" %></b><a href="/product/<%=product.getId()%>?st=com#cmt" target="_blank"><%= StringUtils.getCnSubstring(com.getGdscom_content(),0,45) %></a></div>
        <%  }else{%>
