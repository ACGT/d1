...
<%
List<Promotion> list=PromotionHelper.getBrandListByCode("3582", 2);
List<Promotion> list2=PromotionHelper.getBrandListByCode("3583", 3);
List<Promotion> list3=PromotionHelper.getBrandListByCode("3584", 3);

ArrayList<PromotionProduct> listgds=getPProductByCode("8853",9);
...
<% request.setAttribute("code","8854");
...
<%=getimgstr(list3,0)%>			
	...
	<tr>
		<td colspan="3" class="newbg001">
<% request.setAttribute("code","8855");
		request.setAttribute("length","8");%>
        <jsp:include   page= "/html/gdsrecnew.jsp"   />
</td>
	</tr>
