...
<%
List<Promotion> list=PromotionHelper.getBrandListByCode("3578", 2);
List<Promotion> list2=PromotionHelper.getBrandListByCode("3579", 3);
List<Promotion> list3=PromotionHelper.getBrandListByCode("3580", 3);

ArrayList<PromotionProduct> listgds=getPProductByCode("8850",9);
...
<% request.setAttribute("code","8851");
...
<%=getimgstr(list3,0)%>			
	...
	<tr>
		<td colspan="3" class="newbg001">
<% request.setAttribute("code","8852");
		request.setAttribute("length","8");%>
        <jsp:include   page= "/html/gdsrecnew.jsp"   />
</td>
	</tr>
