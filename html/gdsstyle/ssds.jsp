...
<%
List<Promotion> list=PromotionHelper.getBrandListByCode("3590", 2);
List<Promotion> list2=PromotionHelper.getBrandListByCode("3591", 3);
List<Promotion> list3=PromotionHelper.getBrandListByCode("3592", 3);

ArrayList<PromotionProduct> listgds=getPProductByCode("8858",9);
...
<% request.setAttribute("code","8859");
...
<%=getimgstr(list3,0)%>			
	...
	<tr>
		<td colspan="3" class="newbg001">
<% request.setAttribute("code","8860");
		request.setAttribute("length","8");%>
        <jsp:include   page= "/html/gdsrecnew.jsp"   />
</td>
	</tr>
