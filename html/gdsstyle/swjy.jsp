...
<%
List<Promotion> list=PromotionHelper.getBrandListByCode("3574", 2);
List<Promotion> list2=PromotionHelper.getBrandListByCode("3575", 3);
List<Promotion> list3=PromotionHelper.getBrandListByCode("3576", 3);

ArrayList<PromotionProduct> listgds=getPProductByCode("8846",9);
ArrayList<PromotionProduct> listgds2=getPProductByCode("8848",9);
...
<% request.setAttribute("code","8847");
			...
			<table width="738" height="13" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="468" height="13"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="182" rowspan="2">
                    <div class="gdsdiv"><%=getgdsstr(listgds2,0,180)%></div>
</td>
                    <td width="102"><div class="gdsdiv"><%=getgdsstr(listgds2,1,100)%></div></td>
                    <td rowspan="2"><div class="gdsdiv"><%=getgdsstr(listgds2,3,180)%></div></td>
                  </tr>
                  <tr>
                    <td><div class="gdsdiv"><%=getgdsstr(listgds2,2,100)%></div></td>
                  </tr>
                  
                </table>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="182" rowspan="2"><div class="gdsdiv"><%=getgdsstr(listgds2,4,180)%></div></td>
                      <td width="182" rowspan="2"><div class="gdsdiv"><%=getgdsstr(listgds2,5,180)%></div></td>
                      <td><div class="gdsdiv"><%=getgdsstr(listgds2,6,100)%></div></td>
                    </tr>
                    <tr>
                ...
                <td >
<%
if(listgds2!=null&&listgds2.size()>8&&listgds2.get(8)!=null)
{
	PromotionProduct gdsrec=listgds2.get(8);	
	Product p=ProductHelper.getById(gdsrec.getSpgdsrcm_gdsid());
	String cutimg="";
	if(!Tools.isNull(gdsrec.getSpgdsrcm_otherimg())){
		cutimg=gdsrec.getSpgdsrcm_otherimg();
...
<%=getimgstr(list3,2)%>				
	...
	<tr>
		<td colspan="3" class="newbg001">
<% request.setAttribute("code","8849");
		request.setAttribute("length","8");%>
        <jsp:include   page= "/html/gdsrecnew.jsp"   />
</td>
	</tr>
