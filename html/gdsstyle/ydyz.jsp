...
<%
List<Promotion> list=PromotionHelper.getBrandListByCode("3594", 2);
List<Promotion> list2=PromotionHelper.getBrandListByCode("3595", 3);
List<Promotion> list3=PromotionHelper.getBrandListByCode("3596", 3);

ArrayList<PromotionProduct> listgds=getPProductByCode("8861",9);
...
<% request.setAttribute("code","8862");
...
<%=getimgstr(list3,0)%>			
	...
	<tr>
		<td colspan="3" class="newbg001">
<% request.setAttribute("code","8863");
		request.setAttribute("length","8");%>
        <jsp:include   page= "/html/gdsrecnew.jsp"   />
</td>
	</tr>
