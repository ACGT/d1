...
ArrayList<PromotionProduct> listgds=getPProductByCode("8821",9);
ArrayList<PromotionProduct> listgds2=getPProductByCode("8822",9);
ArrayList<PromotionProduct> listgds5=getPProductByCode("8825",9);
ArrayList<PromotionProduct> listgds7=getPProductByCode("8827",9);
...
<div class="gdsdiv"><%=getgdsstr(listgds2,1,100)%></div>
                      ...
                      <td width="182" rowspan="2">
                      <div class="gdsdiv"><%=getgdsstr(listgds2,3,180)%></div>
                      </td>
                      <td rowspan="2"><div class="gdsdiv"><%=getgdsstr(listgds2,4,180)%></div></td>
                    </tr>
                    <tr>
                      <td width="102"><div class="gdsdiv"><%=getgdsstr(listgds2,2,100)%></div></td>
                    </tr>
                  </table>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td rowspan="2"><div class="gdsdiv"><%=getgdsstr(listgds2,8,180)%></div></td>
                      </tr>
                      <tr>
                        <td><div class="gdsdiv"><%=getgdsstr(listgds2,7,100)%></div></td>
                      </tr>
                  </table></td>
		...
		<td rowspan="2">
<%
if(list3!=null&&list3.size()>0&&list3.get(1)!=null)
{
	Promotion p=list3.get(1);	
	Gdscoll gdscoll=(Gdscoll)Tools.getManager(Gdscoll.class).get(p.getSplmst_name().trim()); 
	...
	out.print("<a href=\""+p.getSplmst_url()+"\" target=\"_blank\" >");
	out.print("<div class=\"imgdp\" style=\"background-image: url(http://images1.d1.com.cn"+ gdscoll.getGdscoll_bigimgurl()+");\" >");
	out.print("<span class=\"imgdpt2\">&nbsp;&nbsp;"+gdscoll.getGdscoll_tail()+"<br>");
	out.print("<span class=\"dppricet\">&nbsp;&nbsp;超值组合价：</span><span class=\"dpprice\">￥"+zhprice+" </span></span>");
	out.print("</div></a>");
     }
}
%>
	...
	<tr>
		<td colspan="2">
			<%=getimgstr(list3,2)%>		</td>
	</tr>
	<tr>
		<td colspan="3" class="newbg002">
<% request.setAttribute("code","8824");
	...
	<tr>
		<td colspan="3">
			<%=getimgstr(list4,0)%></td>
	</tr>
	<tr>
		<td rowspan="2">
<%
if(list4!=null&&list4.size()>0&&list4.get(1)!=null)
{
	Promotion p=list4.get(1);	
	Gdscoll gdscoll=(Gdscoll)Tools.getManager(Gdscoll.class).get(p.getSplmst_name().trim()); 
		...
		<td colspan="2">
			<table width="738" height="13" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="468" height="13"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="182" rowspan="2"><div class="gdsdiv"><%=getgdsstr(listgds5,0,180)%></div></td>
                      <td width="102"><div class="gdsdiv"><%=getgdsstr(listgds5,1,100)%></div></td>
                      <td rowspan="2"><div class="gdsdiv"><%=getgdsstr(listgds5,3,180)%></div></td>
                    </tr>
                    <tr>
                      <td><div class="gdsdiv"><%=getgdsstr(listgds5,2,100)%></td>
                    </tr>
                  </table>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="182" rowspan="2"><div class="gdsdiv"><%=getgdsstr(listgds5,4,180)%></div></td>
                      <td width="102"><div class="gdsdiv"><%=getgdsstr(listgds5,5,100)%></div></td>
                      <td rowspan="2"><div class="gdsdiv"><%=getgdsstr(listgds5,7,180)%></div></td>
                    </tr>
                    <tr>
                      <td><div class="gdsdiv"><%=getgdsstr(listgds5,6,100)%></div></td>
                    </tr>
                  </table></td>
                <td width="270" height="400">
<%
if(listgds5!=null&&listgds5.size()>0&&listgds5.get(8)!=null)
{
	PromotionProduct gdsrec=listgds5.get(8);	
	Product p=ProductHelper.getById(gdsrec.getSpgdsrcm_gdsid());
	String cutimg="";
	if(!Tools.isNull(gdsrec.getSpgdsrcm_otherimg())){
		cutimg=gdsrec.getSpgdsrcm_otherimg();
...
%>
	...
	<tr>
		<td colspan="2">
			<%=getimgstr(list4,2)%></td>
	</tr>
	<tr>
		<td colspan="3" class="newbg003">
<% request.setAttribute("code","8826");
		...
		<tr>
		<td colspan="3">
			<%=getimgstr(list5,0)%></td>
	</tr>
	<tr>
		<td rowspan="2">
<%
if(list5!=null&&list5.size()>0&&list5.get(1)!=null)
{
	Promotion p=list5.get(1);	
	Gdscoll gdscoll=(Gdscoll)Tools.getManager(Gdscoll.class).get(p.getSplmst_name().trim()); 
		...
		<td colspan="2">
			<table width="738" height="13" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="468" height="13"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="182" rowspan="2"><div class="gdsdiv"><%=getgdsstr(listgds7,0,180)%></div></td>
                      <td width="102"><div class="gdsdiv"><%=getgdsstr(listgds7,1,100)%></div></td>
                      <td rowspan="2"><div class="gdsdiv"><%=getgdsstr(listgds7,3,180)%></div></td>
                    </tr>
                    <tr>
                      <td><div class="gdsdiv"><%=getgdsstr(listgds7,2,100)%></td>
                    </tr>
                  </table>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="182" rowspan="2"><div class="gdsdiv"><%=getgdsstr(listgds7,4,180)%></div></td>
                      <td width="102"><div class="gdsdiv"><%=getgdsstr(listgds7,5,100)%></div></td>
                      <td rowspan="2"><div class="gdsdiv"><%=getgdsstr(listgds7,7,180)%></div></td>
                    </tr>
                    <tr>
                      <td><div class="gdsdiv"><%=getgdsstr(listgds7,6,100)%></div></td>
                    </tr>
                  </table></td>
                <td width="270" height="400">
<%
if(listgds7!=null&&listgds7.size()>0&&listgds7.get(8)!=null)
{
	PromotionProduct gdsrec=listgds7.get(8);	
	Product p=ProductHelper.getById(gdsrec.getSpgdsrcm_gdsid());
	String cutimg="";
	if(!Tools.isNull(gdsrec.getSpgdsrcm_otherimg())){
		cutimg=gdsrec.getSpgdsrcm_otherimg();
...
%>
	...
	<tr>
		<td colspan="2">
			<%=getimgstr(list5,2)%></td>
	</tr>
	<tr>
		<td colspan="3" class="newbg004">
<% request.setAttribute("code","8828");
	...
	<tr>
		<td colspan="3">
			<img src="http://images.d1.com.cn/images2013/gdsstyle/fgnew_22.jpg" width="980" height="155" alt="" usemap="#Mapfgd">
			<map name="Mapfgd"><area shape="rect" coords="14,15,319,146" href="http://www.d1.com.cn/zhuanti/201309/fkys0922" target="_blank"><area shape="rect" coords="333,14,641,147" href="http://www.d1.com.cn/zhuanti/201309/xls0911" target="_blank"><area shape="rect" coords="660,15,965,145" href="http://www.d1.com.cn/zhuanti/201309/fenggekan0926" target="_blank"></map>
			</td>
	</tr>
	<tr>
		<td colspan="3">
			<a href="http://www.d1.com.cn" target="_blank"><img src="http://images.d1.com.cn/images2013/gdsstyle/fgnew_23.jpg" width="980" height="49" alt="" border="0"></a></td>
	</tr>
	<tr>
		<td>
