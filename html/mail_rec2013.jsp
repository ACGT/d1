...
<%if (product.getGdsmst_rackcode().startsWith("014")){ %>
		...
		<dd style="width:205px; text-align:left; padding:0px 0px 0px 10px;margin:0px; float:left">
		<div style="height:42px;width:205px;">
		<a  href="<%if (pProduct.getSpgdsrcm_otherlink().trim().length()==0){%><%=subadurl %>http://www.d1.com.cn/product/<%=product.getId()%>
		<%}else{%>
		...
		<div style="float:left;width:52px;">
				<a href="<%=subadurl %>http://www.d1.com.cn/product/<%=product.getId()%>" target="_blank"><img src="http://images.d1.com.cn/zt2013/1203/nztj.jpg" border="0"></a>
		</div>
