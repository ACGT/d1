 ...
 * @return
 */
private String getnewmen(String code,int length)
{
...
.ntbanner{background:url('http://images.d1.com.cn/images2012/2012dhbgm.gif'); width:980px; height:219px; overflow:hidden; margin-top:10px; }
.ntbanner td a font{ font-weight:bold;}
.ntbanner td ul{ list-style-image:url('http://images.d1.com.cn/images2012/nwtip.jpg'); text-align:left;  height:174px; margin-top:5px; margin-left:25px;}
...
padding-left:10px; }
.ntt a{ color:#c8d3d5; font-size:14px;  filter:Alpha(opacity=80);  }
.ntt .font1{ color:#c8d3d5; font-size:13px; font-family:'微软雅黑'}
.ntt .font2{ color:#c8d3d5; font-size:13px; font-family:'微软雅黑'; text-decoration:line-through;}
.ngdlist ul{ margin:0px; padding:0px; list-style:none; over-flow:hidden;}
.ngdlist ul li{ margin-right:4px; float:left; width:240px; over-flow:hidden; height:362px; background:url('http://images.d1.com.cn/images2012/gdlistbg2.jpg'); border:solid 1px #ccc;  }
.gdlist{}
.newtab{position:fixed; _position:relative; +position:relative; top:0px; z-index:900000}
#nw_top{ width:980px; background:url('http://images.d1.com.cn/images2012/nmentop_bg1.gif'); width:980px; height:55px; overflow:hidden;}
...
.newgdsscene ul li{width:980px; height:531px; overflow:hidden;}
 .pricegd{  background:none;background-color: #fff;width:151px; height:225px;position:absolute; top:140px; left:140px; filter: alpha(opacity=80);-moz-opacity: 0.8;opacity: 0.8;  -moz-border-radius: 10px; -webkit-border-radius: 10px;  border-radius: 10px;
    ...
    .gdscoll{width:980px; margin:0px auto; overflow:hidden; padding-top:10px; background:#6e7f8f; padding-bottom:10px;}
...
<body>
	<div id="wrapper">
        ...
        <div class="newgdsscene">
         <%
              ArrayList<Promotion> list=PromotionHelper.getBrandListByCode("3029", 2);
             if(list!=null&&list.size()>0)
             {
            	 out.print("<ul>");
            	 for(Promotion p:list)
         ...
         %>
          ...
          <%
          String codelist="";
          ArrayList<Promotion> lists=PromotionHelper.getBrandListByCode("3031", 1);
             ...
             <div class="gdscoll">
        	   ...
        	   <% for(Gdscoll gds:gdscolllist)
        	   {
        		   ...
        		   { count++;
        			 ...
        			 <div style=" width:316px; height:413px; overflow:hidden; background:url('http://images.d1.com.cn/images2012/index2012/mendpbg.jpg') repeat-x;">
         ...
         <div class="cat">
          ...
          <%=getnewdh("2842",3) %>
           <table class="ntbanner">
              <tr height="40"><td width="170"></td><td width="195" ><font style=" font-size:14px; color:#333;">外套</font>&nbsp;<font style=" font-size:12px; color:#7e7475;">OUTERS</font></td>
              ...
              <tr height="179">
              <td></td>
              <td><%= Getnew2012clist("2843")%></td>
              <td><%= Getnew2012clist("2844")%></td>
              <td><%= Getnew2012clist("2845")%></td>
              <td><%= Getnew2012clist("2846")%></td>
              <td>
              <%= Getnew2012clist("2847")%></td>
              </tr>
           </table>
           
         </div>
         <div class="gdlist">
             <%= Getnew2012ImgBig1("2848")%>
            <%= Getnew2012glist("7556",8)%> 
            </div>
         <div class="clear"></div>
            <div class="gdlist">
             <%= Getnew2012ImgBig1("2849")%>
             <%= Getnew2012glist("7557",8)%> 
         </div>
         <div class="clear"></div>
            <div class="gdlist">
             <%= Getnew2012ImgBig1("2850")%>
             <%= Getnew2012glist("7558",8)%> 
         </div>
         <div class="clear"></div>
            <div class="gdlist">
             <%= Getnew2012ImgBig1("2851")%>
             <%= Getnew2012glist("7559",8)%> 
         </div>
         <div class="clear"></div>
            <div class="gdlist">
             <%= Getnew2012ImgBig1("2852")%>
             <%= Getnew2012glist("7560",8)%> 
         </div>
         <div class="clear"></div>
            <div class="gdlist">
             <%= Getnew2012ImgBig1("2853")%>
             <%= Getnew2012glist("7561",16)%> 
         </div>
    </div>
	<div class="clear"></div>
	...
	<map name="maptc" id="maptc">
	            <area shape="rect" coords="0,0,120,55" href="http://www.d1.com.cn/result.jsp?productsort=017002" target="_blank">
	          </map>
</body>
</html>
