...
<head>
<title>D1优尚网-男装专卖--全国货到付款！衬衫、大衣、POLO、裤子等2折起，30天无条件退换！</title>
...
<link href="<%=com.d1.helper.ResourceHelper.getResourceVersion("/res/css/twocss.css")%>" rel="stylesheet" type="text/css"  />
	...
	$(function(){
		...
		if(wd>=1200){	
		Getmen_rec(wd,"7987",8,1);
		Getmen_rec(wd,"8536",8,2);
		Getmen_rec(wd,"8537",8,3);
		Getmen_rec(wd,"8211",8,4);
		Getmen_rec(wd,"8538",8,5);
		Getmen_rec(wd,"7770",8,6);
		Getmen_rec(wd,"7768",8,7);
		Getmen_rec(wd,"9180",8,8);
		}else{
			Getmen_rec(wd,"7987",6,1);
			Getmen_rec(wd,"8536",6,2);
			Getmen_rec(wd,"8537",6,3);
			Getmen_rec(wd,"8211",6,4);
			Getmen_rec(wd,"8538",6,5);
			Getmen_rec(wd,"7770",6,6);
			Getmen_rec(wd,"7768",6,7);
			Getmen_rec(wd,"9180",6,8);
		}
	});
    ...
    <div class="mbodyl" id="mbodyl">
	   ...
	   <div class="lbad">
		    <div class="scrollimglist">
                ...
                <script>                     		
                ShowCenter(<%= ScrollImgNew("3087",flagsmen) %>,<%= ScrollTextNew("3087",flagsmen) %>);
                </script>
	   ...
	   <%
		   String showad=PromotionHelper.getImgPromotion("3633",1);
	   out.println(showad);
		    //男3633  化妆品3614
		%>
	   </div>
