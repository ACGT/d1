...
if(list!=null && list.size()>0){
	...
	if (i==0 || (float)i/3==(int)i/3){%>
				...
				<p class="retime" > <a href="<%=ProductHelper.getProductUrl(product) %>" target="_blank" style="font-size:12px; color:#fff; "><%=StringUtils.getCnSubstring(pProduct.getSpgdsrcm_gdsname(),0,46)%></a> </p>
				</div>
				</td>
    ...
    <td height="20"><span style="color:#404040;font-size:16px;font-family: '微软雅黑'; ">原价￥<%=oldmprice %></span></td>
