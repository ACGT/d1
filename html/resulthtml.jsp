			            	...
			            	<% for(Gdscolldetail gd:egdlist)
			            	   {
			            		   ...
			            		   %>
			            			   <a href="http://www.d1.com.cn/product/<%= gd.getGdscolldetail_gdsid() %>" target="_blank"  title="<%= Tools.clearHTML(p.getGdsmst_gdsname()) %>" style="background:#fff;"><img src="<%= imgurl %>" width="75" height="75"/></a>
			            		   <%}
			            		   }
			            	   }
			            	%>
