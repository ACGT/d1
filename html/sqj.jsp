...
if(list!=null && list.size()>0){
	...
	<%} 
	%>
	<td style="background:url('http://images.d1.com.cn/zt2012/20120919sqj/sqj_07-bg.jpg') no-repeat;" width="227" width="319" align="center">
	<table height="319">
	...
	<%if(i%4!=0){
		...
		<td width="10">&nbsp;</td>
		<%}if(i%4==0){ %>
		<td width="21">&nbsp;</td></tr><tr><td height="15">&nbsp;</td></tr>
		<%} %>
