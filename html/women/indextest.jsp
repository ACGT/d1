...
<link href="<%=com.d1.helper.ResourceHelper.getResourceVersion("/res/css/twocss.css")%>" rel="stylesheet" type="text/css"  />
	...
	$(function(){
		...
		if(wd>=1200){	
			Getmen_rec(wd,"7988",8,1);
			Getmen_rec(wd,"7775",8,2);
			Getmen_rec(wd,"7776",8,3);
			Getmen_rec(wd,"7777",8,4);
			Getmen_rec(wd,"7778",8,5);
			Getmen_rec(wd,"8214",8,6);	
			Getmen_rec(wd,"8213",8,7);	
		
		}else{
			Getmen_rec(wd,"7988",6,1);
			Getmen_rec(wd,"7775",6,2);
			Getmen_rec(wd,"7776",6,3);
			Getmen_rec(wd,"7777",6,4);
			Getmen_rec(wd,"7776",6,5);
			Getmen_rec(wd,"8214",6,6);	
			Getmen_rec(wd,"8213",6,7);	
		}
	});
    ...
    <div class="mbodyl" id="mbodyl">
	   ...
	   <div class="lbad">
		    <div class="scrollimglist">
                ...
                <script>ShowCenter(<%= ScrollImgNew("3088",flagsmen) %>,<%= ScrollTextNew("3088",flagsmen) %>)</script>
            
         </div>
         </div>
	   <div class="picad" id="picad">
	   <%
		   String showad=PromotionHelper.getImgPromotion("3614",1);
	   out.println(showad);
		    //男3633  化妆品
		%>
	   </div>
