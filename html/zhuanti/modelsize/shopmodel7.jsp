...
<!-- 240*300*4/行春节模板 -->
<dl style="width:240px;height:350px;padding-left:4px;">
  <dd>
  <table width="240" height="350" border="0" cellpadding="0" cellspacing="0" >
  <tr>
    <td width="240" height="300" colspan="3">
    <a href="http://www.d1.com.cn/Product/<%= p.getId() %>" target="_blank" title="<%= p.getGdsmst_gdsname()%>">
	<div class="imgdp" style="background-image: url(<%= !Tools.isNull(p.getGdsmst_img240300())&&p.getGdsmst_img240300().indexOf("shopadmin")>0?"http://images.d1.com.cn":"http://images1.d1.com.cn" %><%= Tools.isNull(p.getGdsmst_img240300())?"":p.getGdsmst_img240300()%>);">
