...
<dt style="width:205px; text-align:center;padding-left:10px; ">
		...
		<span style="font-size:12px;font-weight:bold;color:#666666;"><strike>市场价:￥<%=sprice%></strike> &nbsp;    <strike>原售价:￥<%=oldmprice %></strike></span><br>
		<span style="font-size:14px;font-weight:bold;color:#ff0000;">会员价:￥<%=strmprice%>&nbsp;</span><br>
