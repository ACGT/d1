...
String end="2012-09-29 00:00:00";
...
if(allCartList!=null){
	for(Cart c_23894:allCartList){
		//if(product.getId().equals(c_23894.getProductId())&&c_23894.getType().longValue()==14){
			if((c_23894.getProductId().equals("02103005")||c_23894.getProductId().equals("02103004")||c_23894.getProductId().equals("02103003")||c_23894.getProductId().equals("02103002") )&&c_23894.getType().longValue()==14){
...
cart.setTitle("【中秋巨献】"+product.getGdsmst_gdsname());
