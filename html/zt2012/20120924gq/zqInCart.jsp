...
String strgdsidOne="02300190";
String strgdsidOne2="02300189";
   ...
   ArrayList<Cart> cartList = CartHelper.getCartItems(request, response);	
	...
	if(cartList!=null){
		for(Cart c123:cartList){
			if((c123.getType().longValue()==14 || c123.getType().longValue()==0)&& (c123.getProductId().equals(strgdsidOne) || c123.getProductId().equals(strgdsidOne2))){
	...
	if(hasOne){
		if(productid.equals(gid)){
			...
			out.print("{\"code\":1,message:\"活动赠品二选一，您已领取。\"}");
			return;
		}
	...
	cart.setTitle("【国庆免费领】"+productname);
