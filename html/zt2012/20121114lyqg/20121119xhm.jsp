...
<% 
           				...
           				<%	}
           				    ...
           				    {%>
           				    <p style="z-index:999; height:270px; padding-top:30px; vertical-align:middle; background:#fff;"><a href="<%=ProductHelper.getProductUrl(product) %>" target="_blank" >
		...
		<div style="background:#747474; width:240px;height:50px;padding:0px;">
		<div  style="font-size:12px;padding-left:5px;padding-right:5px;padding-top:3px; padding-bottom:0px;height:50px;">
		 <table style="height:50px;width:100%;">
		<tr>
		<td height="50" style="color:#fff; font-size:14px; font-weight:bold;text-align:left; width:200px;">
		<%=StringUtils.getCnSubstring(Tools.clearHTML(pProduct.getSpgdsrcm_gdsname()),0,20)%>
		</td>
		<td style="color:#fff; font-size:25px; font-weight:bold;width:70px; text-align:center;"><%= Tools.getFloat(product.getGdsmst_memberprice(),1) %></td>
		</tr>
