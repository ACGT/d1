	...
	<tr>
		<td width="762" height="57" bgcolor="#FFD200">
			...
			<%  if(lUser==null)
				...
				{%>
				<%= Tools.substring(lUser.getMbrmst_uid(), 6) %>***您好，欢迎进入积分兑换页面，您当前的积分是：<span style="color: #EC5658;font-size: 16px;"><%=UsrPointHelper.getRealScore(lUser.getId()) %></span>
				<%}%>       
...
<tr>
	...
	<tr>
	  ...
	  <table width="100%" height="0%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="50%" height="100%"><a href="#" attr="67" onclick="op(this);"><img src="http://images.d1.com.cn/zt2013/jifen0826/jfhhl980_06_01-2.jpg" width="491" height="196" alt=""></a></td>
          <td width="50%"><a href="#" attr="36" onclick="op(this);"><img src="http://images.d1.com.cn/zt2013/jifen0826/jfhhl980_06_02-3.jpg" width="489" height="196" alt=""></a></td>
        </tr>
      </table></td>
  </tr>
