...
<table width="980"  border="0" cellpadding="0" cellspacing="0" style="margin:0px auto;">
	<tr>
		<td colspan="8">
			<img src="http://images.d1.com.cn/zt2012/20121203jfhd/jfhd_01.jpg" width="980" height="261" alt=""></td>
	</tr>
	<tr>
		<td colspan="8">
			<img src="http://images.d1.com.cn/zt2012/20121203jfhd/jfhd02.jpg" width="980" height="148" alt=""></td>
	</tr>
	<tr>
		   	    		    ...
		   	    		    if(a.getAward_gdsid()!=null&&a.getAward_gdsid().length()>0)
		   	    		    {
		   	    		    	...
		   	    		    	{%>
		   	    		               ...
		   	    		               <p style=" margin-top:22px;+margin-top:0px; width:230px;font-size:14px; color:#595757">
		   	    		                   <span style="font-family:'方正大黑简体';display:block; font-size:28px; text-align:center; color:#e72756; height:50px; +height:40px; line-height:60px;+line-height:40px;">
