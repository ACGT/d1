...
%>
<%
ArrayList<PromotionProduct> pproductlist=getPProductByCode("8319",100);
...
if(pproductlist!=null && pproductlist.size()>0){
	...
	for(PromotionProduct pproduct:pproductlist){
		...
		long lcount=((new Date().getTime()-pproduct.getSpgdsrcm_begindate().getTime())/1000/60)*hit;//每分钟**个
