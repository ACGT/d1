...
<style type="text/css">
   ...
   .show1{ width:980px; background:#dfe8e3;}
   .show1 ul { list-style:none; width:980px; padding-top:5px;  background:#dfe8e3; }
   .show1 ul li{ float:left; width:220px;margin-left:20px;_margin-left:14px; margin-bottom:10px; text-align:left;  background:#fff;}
   .show1 ul li a{ display:block; width:100%; overflow:hidden; text-align:left; }
   .show1 ul li a:hover{color:#a40545;}   
   .show1 ul li .font1{ font-size:12px; color:#787a79;}
   .show1 ul li .font2{ font-size:14px; color:#f00; font-weight:bold;}
   .show1 ul li .font3{ font-size:14px; color:#787a79; font-weight:bold;}
</style>
</head>
<body>
   <center>
   ...
   <div class="center">
        ...
        <tr><td><a href="/product/01720637" target="_blank"><img src="http://images.d1.com.cn/zt2012/Mayczzk/top_03-1.jpg"/></a></td></tr>
        </table>
                   </div>
        <div class="show">
