		 ...
		 PromotionProduct pProduct=pproductlist.get(0);
			 ...
			 request.setAttribute("t", t);
			   ...
			   double dl= Tools.getDouble(product.getGdsmst_memberprice().doubleValue()*10/product.getGdsmst_saleprice().doubleValue(),1);
				 ...
				 out.print("<li style=\"height:380px; position:relative;\">");
	%>
...
<% 
		...
		<%=StringUtils.getCnSubstring(Tools.clearHTML(pProduct.getSpgdsrcm_gdsname()),0,66)%>
			              ...
			              <table wiudth="100%">
			              <tr>
			              <td valign="middle"><span >会员价：￥<%=Tools.getFormatMoney(product.getGdsmst_oldmemberprice()) %>&nbsp;&nbsp;</span></td>
			              <td> <span style=" font-family:'微软雅黑';color:red; font-weight:bold; font-size:20px;">&nbsp;&nbsp;特价：￥<%=Tools.getFormatMoney(product.getGdsmst_memberprice()) %></span></td></tr>
			              </table>
