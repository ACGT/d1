...
<% 
		...
		<%=StringUtils.getCnSubstring(Tools.clearHTML(pProduct.getSpgdsrcm_gdsname()),0,66)%>
			              ...
			              <table>
			              <tr>
			             <td cospan="2" valign="middle"><span >市场价:￥<%=Tools.getFormatMoney(product.getGdsmst_saleprice()) %>&nbsp;&nbsp;</span>
			             <span style=" font-family:'微软雅黑';color:red; font-weight:bold; font-size:20px;">会员价:￥<%=Tools.getFormatMoney(product.getGdsmst_memberprice()) %></span></td></tr>
			             </tr>
			              </table>
