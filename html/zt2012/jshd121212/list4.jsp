...
if(productlist!=null){
	...
	%>
		 ...
		 <div  style="font-size:12px;padding-left:5px;padding-right:5px;"> 
			              <table>
			              <tr>
			             <td cospan="2" valign="middle"><span style=" font-family:'微软雅黑';color:red; font-weight:bold; font-size:20px;">抢购价:￥<%=Tools.getFormatMoney(product.getGdsmst_memberprice()) %></span>
			             &nbsp;&nbsp;<span >原售价:￥<%=Tools.getFormatMoney(product.getGdsmst_saleprice()) %>&nbsp;&nbsp;</span>
			             </td></tr>
			             </tr>
			              </table>
