...
%>
<div class="newlist1" style=" text-align:center;overflow:hidden;  padding-bottom:18px; ">
<ul>
<%
String code="7006";
		 ...
		 PromotionProduct pProduct=pproductlist.get(0);
			 ...
			 request.setAttribute("t", t);
			   ...
			   double dl= Tools.getDouble(product.getGdsmst_memberprice().doubleValue()*10/product.getGdsmst_saleprice().doubleValue(),1);
				 ...
				 out.print("<li style=\"height:310px;\">");
	%>
	
                <div class="lf">
           			<p style="z-index:999; "><a href="http://www.d1.com.cn/product/<%= product.getId() %>" target="_blank" >
           			<img src="<%= theimgurl%>" width="230" height="230"  /></a> 
           	  </p>	
		  <div style="background:#fff8df; width:230px;height:80px;padding:0px;">
		 ...
		 <div  style="font-size:12px;padding-left:5px;padding-right:5px;"> 
			              <table>
			              <tr>
			             <td cospan="2" valign="middle"><span style=" font-family:'微软雅黑';color:red; font-weight:bold; font-size:20px;">会员价:￥<%=Tools.getFormatMoney(product.getGdsmst_memberprice()) %></span>
			             &nbsp;&nbsp;<span >市场价:￥<%=Tools.getFormatMoney(product.getGdsmst_saleprice()) %>&nbsp;&nbsp;</span>
			             </td></tr>
			             </tr>
			              </table>
