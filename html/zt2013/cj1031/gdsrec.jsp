...
<dt style="width:205px; text-align:center;padding-left:10px; ">
		...
		<%if (code.equals("8963")||code.equals("8965")||code.equals("8966")||code.equals("8967")||code.equals("8968")||code.equals("8969")){ %>
		...
		<%}else{ %>
		 <span style="font-family: '微软雅黑';font-size:12px;font-weight:bold;color:#666666;">会员价:￥<%=strmprice%></span><br>
		<span style="font-family: '微软雅黑';font-size:15px;font-weight:bold;color:#ff0000;">双11价敬请期待！</span><br>
		<%} 
