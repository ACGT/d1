...
private static int Exits(String mbrid)
{
	int result=0;
     ...
     clist.add(Restrictions.ge("gdsbuyonedtl_mstid",new Long(94)));
     clist.add(Restrictions.le("gdsbuyonedtl_mstid",new Long(95)));
     clist.add(Restrictions.eq("gdsbuyonedtl_mbrid",new Long(mbrid)));
     SimpleDateFormat   df2=new   SimpleDateFormat("yyyy-MM-dd HH:mm:ss");  
     SimpleDateFormat df3=new SimpleDateFormat("yyyy-MM-dd");
     String stime="2013-05-27 00:00:00";
     String etime ="2013-06-15 23:59:59";
     try {
     ...
     if(blist!=null&&blist.size()>0)
     {
    	 for(BaseEntity be:blist)
    	 {
    		 if(be!=null){
    		    ...
    		    if(bld.getGdsbuyonedtl_gdsid()!=null&&(bld.getGdsbuyonedtl_gdsid().equals("01404570")
    		    		||bld.getGdsbuyonedtl_gdsid().equals("01412279"))){
    		    	//7日之内只可领一次
...
String end="2013-06-16 00:00:00";
...
if(allCartList!=null){
	for(Cart c_23894:allCartList){
		//if(product.getId().equals(c_23894.getProductId())&&c_23894.getType().longValue()==14){
			if((c_23894.getProductId().equals("01404570")||c_23894.getProductId().equals("01412279"))
...
cart.setTitle("【年中倾情回馈专享9元】"+product.getGdsmst_gdsname());
