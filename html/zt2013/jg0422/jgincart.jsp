...
private static int Exits(String mbrid)
{
	int result=0;
     ...
     clist.add(Restrictions.ge("gdsbuyonedtl_mstid",new Long(90)));
     clist.add(Restrictions.le("gdsbuyonedtl_mstid",new Long(93)));
     clist.add(Restrictions.eq("gdsbuyonedtl_mbrid",new Long(mbrid)));
     SimpleDateFormat   df2=new   SimpleDateFormat("yyyy-MM-dd HH:mm:ss");  
     SimpleDateFormat df3=new SimpleDateFormat("yyyy-MM-dd");
     String stime="2013-04-18 00:00:00";
     String etime ="2013-04-30 23:59:59";
     try {
     ...
     if(blist!=null&&blist.size()>0)
     {
    	 for(BaseEntity be:blist)
    	 {
    		 if(be!=null){
    		    ...
    		    if(bld.getGdsbuyonedtl_gdsid()!=null&&(bld.getGdsbuyonedtl_gdsid().equals("01410254")||bld.getGdsbuyonedtl_gdsid().equals("02000793")
    		    		||bld.getGdsbuyonedtl_gdsid().equals("02001490")||bld.getGdsbuyonedtl_gdsid().equals("01517532") )){
    		    	//7日之内只可领一次
...
if(allCartList!=null){
	for(Cart c_23894:allCartList){
		//if(product.getId().equals(c_23894.getProductId())&&c_23894.getType().longValue()==14){
			if((c_23894.getProductId().equals("01410254")||c_23894.getProductId().equals("02000793")
					||c_23894.getProductId().equals("02001490")||c_23894.getProductId().equals("01517532") )
					&&c_23894.getType().longValue()==14){
...
cart.setTitle("【7天0元抢】"+product.getGdsmst_gdsname());
