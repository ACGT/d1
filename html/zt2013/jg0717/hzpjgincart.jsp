...
private static int Exits(String mbrid,String gdsid)
{
    ...
    /* long mstid=0;
     ...
     clist.add(Restrictions.ge("gdsbuyonedtl_mstid",new Long(132)));
...
if(df.parse(end).before(new Date())){
	out.print("{\"code\":1,\"message\":\"此感恩0元送已经结束！\"}");
	return;
}
...
if(limitlist==null||limitlist.size()==0){
	out.print("{\"code\":1,\"message\":\"此感恩0元送活动已经结束！\"}");
	return;
}
...
cart.setTitle("【感恩0元送】"+product.getGdsmst_gdsname());
