...
149	01416298
     ...
     */
     long mstid=0;
     if(gdsid.equals("01417614")){
     	mstid=135;
     }else if(gdsid.equals("01417367")){
     	mstid=136;
     }else if(gdsid.equals("01408560")){
     	mstid=137;
     }else if(gdsid.equals("01417756")){
     	mstid=138;
     }else if(gdsid.equals("01417341")){
     	mstid=139;
     }else if(gdsid.equals("01417693")){
     	mstid=140;
     }else if(gdsid.equals("01411066")){
     	mstid=141;
     }else if(gdsid.equals("01417354")){
      	mstid=142;
     }else if(gdsid.equals("01417692")){
      	mstid=143;
     }else if(gdsid.equals("01415587")){
      	mstid=144;
     }else if(gdsid.equals("01416036")){
      	mstid=145;
     }else if(gdsid.equals("01415376")){
      	mstid=146;
     }else if(gdsid.equals("01414169")){
      	mstid=147;
     }else if(gdsid.equals("01413289")){
       	mstid=148;
     }else if(gdsid.equals("01416298")){
       	mstid=149;
     }
...
if(limitlist==null||limitlist.size()==0){
	out.print("{\"code\":1,\"message\":\"此秒杀已经结束！\"}");
	return;
}
...
cart.setTitle("【双旦一元秒杀】"+product.getGdsmst_gdsname());
