...
private static int Exits(String mbrid,String gdsid)
{
	...
	if(Tools.isNull(gdsid))return result;
     ...
     List<SimpleExpression> clist = new ArrayList<SimpleExpression>();
     long mstid=0;
     if(gdsid.equals("01407682")){
     	mstid=96;
     }else if(gdsid.equals("01417535")){
     	mstid=97;
     }
...
Date now=new Date();
String end="2013-12-7 00:00:00";
if(df.parse(end).before(new Date())){
	out.print("{\"code\":1,\"message\":\"此限购活动已经结束！\"}");
	return;
}
...
cart.setTitle("【年终倾情回馈专享29元】"+product.getGdsmst_gdsname());
