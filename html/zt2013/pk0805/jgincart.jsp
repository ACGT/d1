...
private static int Exits(String mbrid)
{
	int result=0;
     ...
     clist.add(Restrictions.eq("gdsbuyonedtl_mstid",new Long(112)));
     clist.add(Restrictions.eq("gdsbuyonedtl_mbrid",new Long(mbrid)));
     SimpleDateFormat   df2=new   SimpleDateFormat("yyyy-MM-dd HH:mm:ss");  
     SimpleDateFormat df3=new SimpleDateFormat("yyyy-MM-dd");
     String stime="2013-08-06 00:00:00";
     String etime ="2013-09-06 00:00:00";
     try {
...
String end="2013-09-06 00:00:00";
...
String gdsid = "01205287";
//request.getParameter("id");//商品编号
...
cart.setTitle("【0元抢】"+product.getGdsmst_gdsname());
