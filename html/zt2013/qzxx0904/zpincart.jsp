...
private static int Exits(String mbrid)
{
	int result=0;
     ...
     clist.add(Restrictions.eq("gdsbuyonedtl_mstid",new Long(113)));
...
cart.setTitle("【0元赠品】"+product.getGdsmst_gdsname());
