...
private static String getrec(String code,int len){
	...
	for(int i=0;i<list.size();i++){
		...
		String gdsimglfag="http://images.d1.com.cn/zt2014/0121qc/qc001.png";
...
.qcbanner2{
	margin:10px auto;
	background-image: url(http://images.d1.com.cn/zt2014/0121qc/qc002-3.jpg);
	height:450px;
	background-position: center;
}

.topbannerdiv{	position:relative; width:980px; height:150px; margin: 0px auto;padding-top:300px;}
.link1{ position:absolute;  width:310px; height:150px; bottom:0; left:340px; }
...
String strLtinfo = Tools.getCookie(request,"LTINFO");
if((Tools.isNull(strSubad)||!strSubad.equals("pcshqc28"))&&Tools.isNull(strLtinfo)){ %>
<div class="qcbanner">
</div>
<%}else{ %>
<div class="qcbanner2">
