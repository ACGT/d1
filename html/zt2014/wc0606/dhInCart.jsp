...
boolean gdsexist=false;
ArrayList<PromotionProduct> pp=null;
if(cid.equals("1")&&(strgdsdh_code.startsWith("A")||strgdsdh_code.startsWith("B"))){
	 pp=PromotionProductHelper.getPProductByCodeGdsid("9358" , gdsid);
}else if(cid.equals("2")&&strgdsdh_code.startsWith("B")){
	pp=PromotionProductHelper.getPProductByCodeGdsid("9359" , gdsid);
}
...
if(false && t==0){
	...
	float ftuanprice=pp.get(0).getSpgdsrcm_tjprice().floatValue();
	String strgdsidOne="";
