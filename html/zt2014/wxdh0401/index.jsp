...
//获取所有参与兑换的商品
List<DhGdsM> dhgdsmList = getdhgdsmList("pltwx1304a");
int lcount=0;
int contentcount=0;
	    ...
	    <div class="goodsshow">
			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<h1>FEEL MIND】FM男装9色彩虹舒适纯棉短袖POLO恤<br><font color="red">活动截止日期：2014年4月9日 0:00 在此之前截图成功收到兑换码的用户仍可使用。</font>
					</h1>
					</div>
					<hr class="newhr"/>
					<!-- 商品展示-->
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/zt2014/0401/03000125-400.jpg" width="400" height="400" />
