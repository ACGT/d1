	    ...
	    <div class="goodsshow">
			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<h1><%=gdsname %><br><font color="red">活动截止日期：2014年4月9日 0:00 在此之前截图成功收到兑换码的用户仍可使用。</font></h1>

					</div>
					<hr class="newhr"/>
					<!-- 商品展示-->
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/zt2014/0401/01516824-400X400.jpg" width="400" height="400" />
...
function ShowAJaxdh(){
	...
	$.ajax({
		...
		url: 'wydhInCart.jsp',
		cache: false,
		data: {gdsid:'01516824',cardno:cardno,skuId:sku2},
