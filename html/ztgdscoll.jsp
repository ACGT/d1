       ...
       for(int i=1;i<=gdscolllist.size();i++)
       {
    	   ...
    	   if(gdscoll!=null&&gdscoll.getGdscoll_flag()!=null&&gdscoll.getGdscoll_flag().longValue()==1)
    	   {
    		  // System.out.println(gdscoll.getId()+"MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM");
	    	   ...
	    	   sb.append("<div style=\"width:200px;_width:200px;\">");
	    	  
	    	   sb.append("<a href=\"http://www.d1.com.cn/gdscoll/index.jsp?id="+gdscoll.getId()+"\" target=\"_blank\">");
	    	  
	    	  
	    	   sb.append("<img src=\"http://images1.d1.com.cn"+gdscoll.getGdscoll_brandimg()+"\"  style=\"_width:180px;\"/> </a> </div>");
				...
				if(gdetaillist!=null&&gdetaillist.size()>0)
				{
					...
					for(Gdscolldetail gd:gdetaillist)
					{
					    if(gd!=null&&gd.getGdscolldetail_gdsid()!=null&&gd.getGdscolldetail_gdsid().length()>0)
					    {
					    	...
					    	if(p!=null&&p.getGdsmst_ifhavegds()!=null&&p.getGdsmst_ifhavegds().longValue()==0&&p.getGdsmst_validflag()!=null&&p.getGdsmst_validflag().longValue()==1&&ProductStockHelper.canBuy(p))
					    	{
					    	    ...
					    	    sb1.append("<li><a href=\"http://www.d1.com.cn/product/"+p.getId()+"\" target=\"_blank\"><img src=\""+gdsimg+"\" width=\"100\" height=\"100\" style=\"border:solid 1px #000;background:#fff;\"></a><br/>");
					...
					//是否显示上下按钮
	    			 if(gdcount>3)
		             {
	    				 ...
	    				 sb1.append("<a href=\"javascript:void(0)\" onclick=\"scoll0718t('"+code+i+"',this);\"><img id=\"tprev"+code+i+"\" src=\"http://images.d1.com.cn/images2012/index2012/JULY/jts.png\" width=\"68\" height=\"23\"></a>");
						 sb1.append("</div>");
						 sb1.append("<div class=\"preNext1 next20121\">");
						 sb1.append("<a href=\"javascript:void(0)\" onclick=\"scoll0718b('"+code+i+"',this);\"><img id=\"bprev"+code+i+"\" src=\"http://images.d1.com.cn/images2012/index2012/JULY/jtx.png\" width=\"68\" height=\"23\"></a>");
						 sb1.append("</div>");
				         sb1.append("<div class=\"clear\"></div>");
		             }
					//获取价格字符串
					
					sb2.append("<div style=\"color:#343434;\">");
		            sb2.append("<table><tr><td width=\"5\"></td>");
		            sb2.append("<td><br/>共<em id=\"amount"+code+i+"\">"+ counts+"</em>件<br/><strike>总价：￥<font id=\"memberP"+code+i+"\">"+(int)sum1 +"</font></strike><br/><font style=\"font-size:12px;font-weight:bold; color:#f00;\" face=\"微软雅黑\">组合价：￥</font><font id=\"pktP"+i+"\" style=\"font-size:12px;font-weight:bold; color:#f00;\" face=\"微软雅黑\">"+ (int)zhprice+"</font><br/>共优惠：￥<font id=\"cheap"+code+i+"\">"+ (int)(sum1-zhprice)+"</font><br/><br/></td>");
		            sb2.append("<td width=\"10\" ></td><td  ><font style=\"font-size:12px;font-weight:bold; color:#f00;\">搭配购买95折！<br/>满200减50</font><br/><a href=\"javascript:void(0)\" code=\""+gdscoll.getId()+"\" onclick=\"check_gdscoll20120710(this,'"+code+i+"')\"><img src=\"http://images.d1.com.cn/zt2012/20121108qcdp/ann.jpg\" width='95'/></a></td></tr></table>");
    			    sb2.append("</div>");
