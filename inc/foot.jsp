...
<link href="<%=com.d1.helper.ResourceHelper.getResourceVersion("/res/css/foot2014.css?"+System.currentTimeMillis())%>" rel="stylesheet" type="text/css" media="screen" />
<!--底部信息-->
