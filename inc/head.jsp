	...
	<div class="h_top">
	 ...
	 <div class="ht_wid wrap">
      ...
      <a href="http://www.d1.com.cn">
       ...
       <div class="hm_search" style="padding-left:10px;">
          <div class="hms_but">
         ...
         <div class="hm_sglist"  style="padding-left:10px;">
    ...
    $(document).ready(function() {
     ...
     <div class="hmenu_txt" style="width:980px;">
          <ul style="font-size:14px;">
           ...
           <li class="r"><a id="style010" href="http://www.d1.com.cn/shop/788/2">创意家居</a></li>
          </ul>
