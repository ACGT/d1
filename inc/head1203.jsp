...
%>
<link href="<%=com.d1.helper.ResourceHelper.getResourceVersion("/res/css/head2014new.css?"+System.currentTimeMillis())%>" rel="stylesheet" type="text/css" media="screen" />
	...
	<div class="h_top">
	 ...
	 <div class="ht_wid wrap">
      ...
      <a href="http://www.d1.com.cn">
       ...
       <div class="hm_search">
          <div class="hms_but">
           <input name="hm_searchtxt" id="ffb9_input" class="hm_searchtxt"  value="请输入您要搜索的商品名称或编码" type="text" /><input name="hm_searchbut"  id="hm_searchbut" onclick="searchbut()" class="hm_searchbut" type="submit" value="搜索"  />         
           </div>
            <div class="hms_key">
                <ul>
    ...
    %>
     ...
     <div class="hmenu_txt" style="width:1210px;">
        <ul style="font-size:14px;">
            ...
            <li class="r"><a id="styleindex" href="http://www.d1.com.cn/html/sg" class="cur0311">首页</a></li>
            <li class="r"><a id="stylesg" href="http://www.d1.com.cn/html/sg">超值闪购</a></li>
           <li class="r"><a id="style014" href="http://www.d1.com.cn/result.jsp?productsort=014">化妆品</a></li>
           <li class="r"><a id="style020" href="http://www.d1.com.cn/result.jsp?productsort=020">女装</a></li>
           <li class="r"><a id="style030" href="http://www.d1.com.cn/result.jsp?productsort=030">男装</a></li>
           <li class="r"><a id="style012" href="http://www.d1.com.cn/result.jsp?productsort=012">居家生活</a></li>
           <li class="r"><a id="style015" href="http://www.d1.com.cn/result.jsp?productsort=015">名品配饰</a></li>
           <li class="r"><a id="style050" href="http://www.d1.com.cn/result.jsp?productsort=050">箱包皮具</a></li>
          </ul>
 
       </div>
       <!--浮动层-->
	<div id="head_floatdiv" style="margin:0px auto;max-width:1210px;position:relative;z-index:10000;">
	<!--全部分类-->
	<div id="allfl" class="allfl"  >
	  <script type="text/javascript" src="/inc/head1204.jsp"></script>
	</div>
	<!--全部分类结束-->
	</div>
	 <!-- 浮动层结束    -->
