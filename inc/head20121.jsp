...
<div class="header wrap">
      ...
      <a href="http://www.d1.com.cn">
       ...
       <div class="hm_search">
          ...
          <div style="float:left;"><div id="ffb9"></div></div><input name="hm_searchbut" style="float:left;"  id="hm_searchbut" onclick="searchbut()" class="hm_searchbut" type="submit" value="搜索"  />         
           ...
           <!-- <div id="ffb9">
           <input name="hm_searchtxt" id="ffb9_input"  class="hm_searchtxt"  value="请输入您要搜索的商品名称或编码" type="text" />
           </div> -->
    ...
    $(document).ready(function() {
     ...
     <div class="hmenu_txt" style="width:980px;">
       ...
       <!--浮动层-->
	<div id="head_floatdiv" style="margin:0px auto;max-width:980px;position:relative;z-index:10000;">
	<!--全部分类-->
