...
%>
<link href="<%=com.d1.helper.ResourceHelper.getResourceVersion("/res/css/head2014.css?"+System.currentTimeMillis())%>" rel="stylesheet" type="text/css" media="screen" />
<script type="text/javascript" src="<%=com.d1.helper.ResourceHelper.getResourceVersion("/res/js/head2014.js")%>"></script>
...
<div class="header wrap">
	<div class="h_top">
	 ...
	 <div class="ht_wid wrap">
      ...
      <a href="http://www.d1.com.cn">
         ...
         <div class="hm_sglist">
        <div style="height: 80px; width: 208px;"></div>
      	  <!--
       ...
       <div class="hm_search">
          <div class="hms_but">
           <input name="hm_searchtxt" id="hm_searchtxt" class="hm_searchtxt"  value="请输入您要搜索的商品名称或编码" type="text" /><input name="hm_searchbut"  id="hm_searchbut" onclick="searchbut()" class="hm_searchbut" type="submit" value="搜索"  />         
           </div>
            <div class="hms_key">
                <ul>
    ...
    $(document).ready(function() {
	    ...
	    }else if(url_idsy != null && url_idsy.indexOf("http://www.d1.com.cn/index.jsp") >= 0){//是首页的情况下，限时抢购被选中
	    	$('.hmenu_txt li a').removeClass("cur0311");
	    	$('#style1').addClass("cur0311");
	    }else{
	    	$('.hmenu_txt li a').removeClass("cur0311");
	    }
    });
      ...
      <div class="hmenu_txt">
          <ul>
           <li><a id="style1" href="http://www.d1.com.cn" class="cur0311" >限时抢购</a></li>
           <li><a id="head_allfl"  class="cur" >全部商品<b></b></a></li>
           <li><a id="style014" href="http://www.d1.com.cn/result.jsp?productsort=014">化妆品</a></li>
           <li><a id="style020" href="http://www.d1.com.cn/result.jsp?productsort=020">女装</a></li>
           <li><a id="style030" href="http://www.d1.com.cn/result.jsp?productsort=030">男装</a></li>
           <li><a id="style012" href="http://www.d1.com.cn/result.jsp?productsort=012">居家生活</a></li>
           <li><a id="style015" href="http://www.d1.com.cn/result.jsp?productsort=015">名品配饰</a></li>
           <li><a id="style050" href="http://www.d1.com.cn/result.jsp?productsort=050">箱包皮具</a></li>
          </ul>
 
       </div>
          <div id="head_floatdiv" style="margin: 0px auto; position: relative; z-index: 10000; width: 980px;">
              <div id="allfl" class="allfl" style="display:none;" >
	              <div class="hmenu_nav l">
                      <div class="hmnav_item">
                           <h3><a href="http://www.d1.com.cn/result.jsp?productsort=020" target="_blank">女装&nbsp;></a></h3>
             
							<%=getHeadPromotionMemu("3677",50,true,2) %>
                      <div class="clear"></div>
                      </div>
                       <div class="hmnav_item">
                           <h3><a href="http://www.d1.com.cn/result.jsp?productsort=014" target="_blank">化妆品&nbsp;></a></h3>
 
							<%=getHeadPromotionMemu("3676",50,true,2) %>
                           <div class="clear"></div>
                      </div> <div class="hmnav_item">
                           <h3><a href="http://www.d1.com.cn/result.jsp?productsort=050" target="_blank">箱包皮具&nbsp;></a></h3>
							<%=getHeadPromotionMemu("3679",50,true,2) %>
                           <div class="clear"></div>
                      </div> <div class="hmnav_item" style="border-bottom: 0px;">
                           <h3><a href="http://www.d1.com.cn/result.jsp?productsort=015" target="_blank">名品饰品&nbsp;></a></h3>
                        <%=getHeadPromotionMemu("3681",50,true,2) %>
                           <div class="clear"></div>
                      </div>
                  </div>
                  <div class="hmenu_nav">
                   <div class="hmnav_item">
                           <h3><a href="http://www.d1.com.cn/result.jsp?productsort=030" target="_blank">男装&nbsp;></a></h3>
                         <%=getHeadPromotionMemu("3678",50,true,2) %>
                          <div class="clear"></div>
                      </div> <div class="hmnav_item">
                           <h3><a href="http://www.d1.com.cn/result.jsp?productsort=012" target="_blank">家居生活&nbsp;></a></h3>
                           <%=getHeadPromotionMemu("3682",50,true,2) %>
                          <div class="clear"></div>
                      </div> <div class="hmnav_item">
                           <h3>鞋靴&nbsp;></h3>
                           <%=getHeadPromotionMemu("3680",50,true,2) %>
                          <div class="clear"></div>
                      </div> <div class="hmnav_item" style="border-bottom: 0px;">
                           <h3><a href="http://www.d1.com.cn/result.jsp?productsort=060" target="_blank">婴童&nbsp;></a></h3>
                            <%=getHeadPromotionMemu("3683",50,true,2) %>
                          <div class="clear"></div>
                      </div>
                  </div>
	           </div>
