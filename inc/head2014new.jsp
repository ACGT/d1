...
<script type="text/javascript" src="/res/js/jsSource/jquery.flexbox.js"></script>
  <script type="text/javascript" src="<%=com.d1.helper.ResourceHelper.getResourceVersion("/res/js/head201309.js")%>?1.21"></script>
    ...
    %>
     ...
     <div class="hmenu_txt" style="width:1210px;">
        <ul style="font-size:14px;">
            ...
            <li class="r"><a id="styleindex" href="http://www.d1.com.cn" class="cur0311">首页</a></li>
