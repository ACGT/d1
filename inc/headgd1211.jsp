...
ArrayList<SplRck> head_splrcklist=new ArrayList<SplRck>(); %>
 ...
 document.write('<dt attr=\"0\">');<%
		...
		if(head_splrcklist!=null&&head_splrcklist.size()>0)
		 {
			for(int j=1;j<head_splrcklist.size()-1;j++)
			{
		...
		<% 
		head_plist.clear();
		//head_plist=PromotionHelper.getBrandListByCode((head_splrcklist.size()-1)+"",3);
		...
		if(head_splrcklist!=null&&head_splrcklist.size()>0)
		 {
			for(int j=1;j<head_splrcklist.size();j++)
			{
				...
				if(!srl.getId().equals("3522")){
				 ...
				 <% 
					 for(int i=0;i<head_plist.size()-1;i++)
					 {
						 Promotion p=head_plist.get(i);
						 if(p!=null)
						 {%>
	   ...
	   document.write(' <dl>');
		...
		<%
		 ...
		 if(head_splrcklist!=null&&head_splrcklist.size()>0&&head_splrcklist.get(0)!=null&&head_splrcklist.get(0).getId()!=null)
		 {
			 ...
			 {
				 %>
				  document.write('<b><a href=\"http://www.d1.com.cn/result.jsp?productsort=040,015002\" target=\"_blank\" style=\"font-size:14px;font-family: 微软雅黑; color:#333;\">配饰名品</a>&nbsp;&nbsp;></b>'); 
					<%for(int i=0;i<head_plist.size();i++)
					 {
						 Promotion p=head_plist.get(i);
						 if(p!=null)
	   ...
	   document.write(' <dl>');
		...
		<%
		 ...
		 if(head_splrcklist!=null&&head_splrcklist.size()>0&&head_splrcklist.get(0)!=null&&head_splrcklist.get(0).getId()!=null)
		 {
			 ...
			 {
				 %>
				  document.write('<b><a href=\"http://www.d1.com.cn/result.jsp?productsort=015009\" target=\"_blank\" style=\"font-size:14px;font-family: 微软雅黑; color:#333;\">居家</a>&nbsp;&nbsp;></b>'); 
					<%for(int i=0;i<head_plist.size();i++)
					 {
						 Promotion p=head_plist.get(i);
						 if(p!=null)
