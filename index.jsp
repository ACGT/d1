...
.productadright{position: fixed;_position: absolute;right: 0px;bottom: 0px;width: 100px;font-size: 12px;_top: expression(documentElement.scrollTop+documentElement.clientHeight-this.offsetHeight);overflow: hidden;z-index: 200000;display: block;}
.page_f{
