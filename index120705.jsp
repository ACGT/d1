...
if(list!=null&&list.size()>0)
{
	...
	{ 
		if(p!=null)
		{
			...
			sb.append("<li><font style=\"font-size:13px\">▪</font>&nbsp;").append("<a href=\""+p.getSplmst_url()+"\" target=\"_blank\" style=\"color:#fff;\">"+Tools.clearHTML(p.getSplmst_name())).append("</a></li>");
...
if(list!=null&&list.size()>0)
{
	...
	{
		result=list.get(0).getSplmst_url();
	}
}
return result;
}
...
<link href="<%=com.d1.helper.ResourceHelper.getResourceVersion("/res/css/index2012new.css?"+System.currentTimeMillis())%>" rel="stylesheet" type="text/css" media="screen" />
...
<%
   ...
   <div style="background:url('http://images.d1.com.cn/images2012/index2012/index98050bg2.jpg')  "><a href="http://www.d1.com.cn/zhuanti/20120629qchd/qchd.jsp" style=" width:980px; display:block; margin:0px auto;" target="_blank"><img src="http://images.d1.com.cn/images2012/index2012/980X50new2.jpg"/></a></div>
   ...
   <!-- page开始 -->
	...
	<!-- 首页全场活动 -->
	  <div class="allhd" id="allhd">
	     <a href="http://www.d1.com.cn/zhuanti/20120703sp/sp.jsp" target="_blank"><img src="http://images.d1.com.cn/images2012/index2012/fubiao.png" /></a>
	     <a href="javascript:void(0)" onclick="closeallhd();" style="position:absolute;top:0px;left:105px;">
	...
	<div id="center">
	   <table width="100%" height="840" cellspacing="0" cellpadding="0" border=0 >
	        <tr>
	        <td rowspan="5" width="270" style="overflow:hidden;">
	             ...
	             <table width="100%">
	                   ...
	                   <span <% String lsstr=getLogo("2865"); if(lsstr.length()>0) { %> style="background:url('<%= lsstr %>') no-repeat bottom left;" <%} %>>
	                      ...
	                      <div>
	                        <div id="sdiv2012_1" class="sdiv2012_1" style="height:48px; _height:45px; padding:0px;" onmouseover="overcate(this,'1')" onmouseout="outcate(this,'1')">
	                            <a href="/brand/aleeishe"  target="_blank" >
	               ...
	               <tr><td height=157><div class="feelmind" >
	                ...
	                <div>
	                          <div id="sdiv2012_2" class="sdiv2012_2" style="height:28px; _height:25px; padding:0px; padding-top:12px;" onmouseover="overcate(this,'2')" onmouseout="outcate(this,'2')">
	                            <a href="/brand/feelmind" onmouseover="" target="_blank">
	               ...
	               <span <% String lsstr2=getLogo("2867"); if(lsstr2.length()>0) { %> style="background:url('<%= lsstr2 %>') no-repeat bottom left;" <%} %>>
	                ...
	                <div>
	                          <div id="sdiv2012_3" class="sdiv2012_3" style="height:39px; _height:35px; padding:0px; padding-top:4px;" onmouseover="overcate(this,'3')" onmouseout="outcate(this,'3')">
	                            <a href="/brand/sheromo" onmouseover="" target="_blank">
	               ...
	               <tr><td height=148><div class="zp" >
	                ...
	                <div>
	                            ...
	                            <a href="/html/cosmetic/" onmouseover="" target="_blank">
	       ...
	       <%= getScrollNews("2922")%> 
	        ...
	        <tr>
	        <td height="336" style="padding-left:4px; padding-top:4px;" width="710">
	        ...
	        <tr><td>
	           <table>
	               <tr  height="25"><td rowspan="5"></td></tr>
	               <tr><td width="180"></td><td width="60"><a href="http://www.d1.com.cn/brand/aleeishe/" target="_blank"><img src="http://images.d1.com.cn/images2012/index2012/kittylogo.jpg"/></a></td>
	               <td width="75">凯蒂<br/>时尚淑女装</td>
	               <td width="60"><a href="http://www.d1.com.cn/brand/feelmind/" target="_blank"><img src="http://images.d1.com.cn/images2012/index2012/kslogo.jpg"/></a></td>
	               <td width="75">昆少<br/>休闲男装</td>
	               <td width="60"><a href="http://www.d1.com.cn/brand/sheromo/" target="_blank"><img src="http://images.d1.com.cn/images2012/index2012/rgglogo.jpg"/></a></td>
	               <td width="75">蓉格格<br/>休闲女装</td>
	               <td width="60"><a href="http://www.d1.com.cn/html/brand/brand181.htm" target="_blank"><img src="http://images.d1.com.cn/images2012/index2012/fslogo.jpg"/></a></td>
	               <td width="75">风帅<br/>欧美饰品</td>
	               </tr>
	           </table>
	        ...
	        <tr><td>
	           <table width=100% >
	             <tr height="43" width="100%"><td colspan="2"></td></tr>
	              <tr>
	...
	<!--右侧弹出层结束-->
	   ...
	   <script type="text/javascript" src="/inc/getProduct1.jsp"></script>
...
function openSc()
{
  ...
  $(document).ready(function() {
	  startmarquee(19,30,3000,0);
	    ...
	    openSc();
		//$(".focus").find("img").lazyload({ effect: "fadeIn", placeholder: "http://images.d1.com.cn/Index/images/grey.gif" });
		//$(".hot_fl_left").find("img").lazyload({ effect: "fadeIn", placeholder: "http://images.d1.com.cn/Index/images/grey.gif" });
		//$(".likelist").find("img").lazyload({ effect: "fadeIn", placeholder: "http://images.d1.com.cn/Index/images/grey.gif" });
	});
 </script>
</body>
</html>