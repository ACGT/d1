...
//session.setAttribute("flaghead", "2");
//String flags=session.getAttribute("flaghead")==null?"2":session.getAttribute("flaghead").toString();//默认为北方
String flags="2";
%>
...
<style type="text/css">
.allhd2{position: fixed;_position: absolute;right: 0px;bottom: 0px;width: 115px;font-size: 12px;_top: expression(documentElement.scrollTop+documentElement.clientHeight-this.offsetHeight);overflow: hidden;z-index: 200000;display: block;}
.branddiv{z-index:999;position:relative; margin-top:12px;}
.branddivspan{position:absolute; width:171px; height:171px; dislay:block;  left:10px; top:-6px; z-index:5000;}
.branddivspanfmw{background:url('http://images.d1.com.cn/images2012/index2012/SEP/LOGO-FMw.jpg');}
.branddivspanfmm{background:url('http://images.d1.com.cn/images2012/index2012/SEP/LOGO-FMm.jpg');}
.branddivspanxls{background:url('http://images.d1.com.cn/images2012/index2012/SEP/LOGO-xls.jpg');}
.branddivspansrm{background:url('http://images.d1.com.cn/images2012/index2012/SEP/LOGO-srm.jpg');}
.branddivtxt{height:36px;line-height:36px; background:#f9f9f9;}
.brandmore{float:right;width:120px;font-size:13px; font-weight:bold;color:#3f3939;}
.branddivtxt span a{color: #727272;}
.newgdscollh1{height:353px;}
</style>
</head>
<body>
<div>
<%
	...
	<div class="main_area">
		...
		String showmsguid = Tools.getCookie(request,"showmsg");
			...
			}%>&nbsp;<a class='my_caibei' href="<%=session.getAttribute("jifenurl").toString()%>">我的彩贝积分</a></div>
	</div>
</div>
 <div class="clear"></div>
		<%}
...
<div class="clear"></div>
   ...
   <!-- page开始 -->
	...
	<!-- 首页全场活动  -->
  <div class="allhd2">
	<!--<table width="115" height="125"  id="allhd">
	<tr>
	<td>
	<a href="http://www.d1.com.cn/html/zt2013/20130116hd/index.jsp" target="_blank">
	<img src="http://images.d1.com.cn/images2012/index2012/des/20130118float.jpg"/>
    </a>
    </td>
    </tr>   
    </table>
        <a href="javascript:void(0)" onclick="closeallhd(this);" style="position:absolute;top:0px;right:10px; ">
	 ...
	 <a href="http://www.d1.com.cn/zhuanti/201302/sbj0218/" target="_blank"><img src="http://images.d1.com.cn/images2013/index/index200-30.jpg"/></a>
 </div>
	...
	<div style="display:block;width:980px; height:30px;background:#f4f4f4;color:#9fa0a0; line-height:30px;">
	  <marquee behavior="alternate" onmouseover="this.stop()"  onmouseout="this.start()" scrolldelay="300">网购温馨提示：年末诈骗猖獗，接到任何购物网站通知中奖或低价促销电话，均为诈骗信息，D1优尚也从不通过电话进行促销，请提高警惕</marquee>
	</div>
               ...
               <table width="100%"  valign="center">
                  <tr>
                      <td width="140" style="padding-left:20px;">
                          <span class="rmflspantitle" style="color:#9c0000">女装精选</span>
                         
                          <span style="font-size:13px; font-weight:bold;color:#3f3939; height:29px;line-height:29px;width:110px;background:url('http://images.d1.com.cn/images2012/index2012/des/newmew.png') no-repeat center right;">春装上新</span>
                         <%=getHotKeys1("3304",3) %>
                          <span style="display:block;height:8px;"></span>
                           <span style="font-size:13px; font-weight:bold;color:#3f3939; height:29px; line-height:29px;width:110px;background:url('http://images.d1.com.cn/images2012/index2012/des/hotnew.png') no-repeat center right;">超值活动</span>
                          <%=getHotKeys1("3305",3) %>
          ...
          <tr>
             <td style="background:#f9f9f9;height:250px;">
               <table width="100%"  valign="center">
                  <tr>
                      <td width="140" style="padding-left:20px;">
                          <span class="rmflspantitle" style="color:#000856">男装精选</span>
...
function openSc()
{
  ...
  $(document).ready(function() {
         ...
         $("#wmain img").hover(function() {
          ...
          $("#cosmetic img").hover(function() {
        		//$(this).closest("div").find("img").css("opacity",0.7);
        		$("#cosmetic").find("img").not('#cosmetictitle').css("opacity",0.7);
        		$(this).css("opacity",1);
        	},function() {
