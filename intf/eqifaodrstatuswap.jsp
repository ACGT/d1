	...
	if(orderlist!=null){
	  ...
	  for(OrderBase base:orderlist){
		 ...
		 // int j=temp.indexOf("|");
		  ...
		  str.append("</favorable>");
		  str.append("<favorable_code><![CDATA[");
		  if(base.getOdrmst_d1actmoney().floatValue()>0f&&!Tools.isNull(base.getOdrmst_cardmemo())){
			  str.append("满减活动，优惠券："+base.getOdrmst_cardmemo());
		  }else if(base.getOdrmst_d1actmoney().floatValue()>0f){
			  str.append("满减活动");
		  }else{
		  str.append(base.getOdrmst_cardmemo());
		  }
		  str.append("]]></favorable_code>");
		  str.append("</order>"); 
		}
	  }
	  }
