...
ArrayList<OrderBase> listT139=OrderHelper.getOrderList("139ticket",dStartDate, dEndDate);
...
if(listcaibei2!=null){
	for(OrderBase base5:listcaibei2){
		listall.add(base5);
	}
}
if(listTdx!=null){
	for(OrderBase base6:listTdx){
		listall.add(base6);
	}
}
if(listT139!=null){
	for(OrderBase base7:listT139){
		listall.add(base7);
	}
}
