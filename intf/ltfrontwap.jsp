...
if (!Tools.isNull(httpurl)){
    ...
    {
    	Tools.outJs(out,"LPMS:不能连接，请咨询网站负责人!","http://m.d1.cn");
		return;
    }
    else
    {
    	IntfUtil.setCookieWap(response,"d1.com.cn.srcurl",httpurl,(int)(Tools.DAY_MILLIS/1000*3));//3天过期
    	 response.setHeader("P3P", "CP=NOI DEVa TAIa OUR BUS UNI");
    	 IntfUtil.setCookieWap(response,"WAPLTINFO",stra_id+"|"+strc_id+"|"+strl_id+"|"+strl_type1+"|",(int)(Tools.DAY_MILLIS/1000*3));//3天过期
    	 IntfUtil.KillsCookiesWap(response, "WAPLTINFO");
