    ...
    <div class="login">
    	<div style="float:left;width:542px;padding-top:0px;">
			...
			<%if(session.getAttribute("d1lianmengsubad")!=null&&session.getAttribute("d1lianmengsubad").toString().equals("p1304012tmkh")){
					%>
					<a href="/interface/login/alipay.jsp" class="newa"><img src="http://images.d1.com.cn/images2013/login/login_left2-2.jpg"/></a>
					<%} else if(session.getAttribute("d1lianmengsubad")!=null&&session.getAttribute("d1lianmengsubad").toString().startsWith("ptenpay")){%>
			<a href="/login.do" ><img src="http://images.d1.com.cn/images2013/login/login_left3-2.jpg"/></a>
			<%	}else{
				%>
				<%
                     		ArrayList<Promotion> head_plist=new ArrayList<Promotion>(); 
							head_plist=PromotionHelper.getBrandListByCode("3674", 1);//女装3677
							if(head_plist!=	null&&head_plist.size()>0){
								for(Promotion p:head_plist){
									if(p!=null){%>
										<span><a href="<%= p.getSplmst_url()!=null?p.getSplmst_url():"" %>"> <img src="<%= p.getSplmst_picstr()!=null?p.getSplmst_picstr():"" %>"/></a></span>
		...
		<div style="float:right;width:402px;position:relative;height:458px;">
			...
			<div class="floatdiv">
				<table cellpadding="0" cellspacing="0" width="100%">
					 <tr>
						 <td style=" text-align:right" width="80">用户名：</td><td style="text-align:left;"><input type="text" id="login_Name" tabIndex="1" maxlength="255" value="<%=username!=null?username:"" %>" /></td>
					 </tr>
					 <tr><td></td><td><span id="errUsername" class="spanmsg" style="display:none;width:160px;" >用户名/Email不能为空！</span></td></tr>
					 <tr><td colspan="2" height="8"></td></tr>
					 <tr>
						 <td style=" text-align:right" width="80">密码：</td><td style="text-align:left;"><input type="password" tabIndex="2" id="login_Pwd" maxlength="14" />&nbsp;&nbsp;&nbsp;&nbsp;
					 ...
					 <tr><td></td><td><span id="errPassword" class="spanmsg"  style="display:none;">密码不能为空！</span></td></tr>
					  ...
					  <tr>
						 <td style=" text-align:right" width="80" >验证码：</td><td style="text-align:left;"> <span class="spanmsg2"><input type="text" tabIndex="3" name="code" id="code"  maxlength="4" style="width:80px;" onkeyup="key_up(this);"/>&nbsp;&nbsp;
					 ...
					 <tr><td  colspan="2" style=" text-align:left; padding-left:95px;"><img onclick="AjaxLogin();" tabIndex="4"  onkeydown="if(event.keyCode==13){AjaxLogin();}" src="http://images.d1.com.cn/images2012/New/login_new.gif" style="float:left;cursor:pointer;" />
...
<td valign="middle">&nbsp;&nbsp;|&nbsp;<a href="/interface/login/139mail.jsp" class="newa"><img src="http://images.d1.com.cn/images2012/login/139.jpg" border="0"/></a></td><td  valign="top"><a href="/interface/login/139mail.jsp" class="newa">&nbsp;139邮箱</a></td>
					...
					<div class="msdiv" style=" line-height:18px; _line-height:14px; _width:330px;">
					   ...
					   <br/>
					   <a href="http://help.d1.com.cn/hphelpnew.htm?code=0505" target="_blank"><font color="red"> 如果您不想错过诱人的促销活动通知，请点击此处</font></a>
					</div>
					<table width="200">
