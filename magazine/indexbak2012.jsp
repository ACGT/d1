...
$(document).ready(function() {
	...
	ShowTuanNew();
	setInterval("closeSC()", 30000);
	
	$(".img_list .goods_list .goods_listnew").find("img").lazyload({ effect: "fadeIn", placeholder: "http://images.d1.com.cn/Index/images/grey.gif" });
});
</script>
</head>
<body>
