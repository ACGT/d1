      	  ...
      	  if(list!=null&&list.size()>0){
      		...
      		ArrayList<ProductGroup> elist=new ArrayList<ProductGroup>();//已结束的团购
      		     for(int i=0;i<list.size();i++)
      		     {
      		    	 ...
      		    	 if(pg!=null)
      		    	 {
      		    		 if(pg.getTgrpmst_priority()==5&&i==0)
      		    		 {
      		    			 tlist.add(pg);
      		    		 }
		       ...
		       <table>
				...
				<tr><td></td><td height="2" ></td></tr>
				 ...
				 <% 
				    ...
				    {%>
				    	<span>倒计时:<font color="#b51014" style="font-size:19px; font-weight:bold; padding-left:2px; padding-right:2px; ">00</font>天
				        ...
				        onmouseover="mouseover(<%=l+1+ilist.size()%>,this)" onmouseout="mouseout(<%=l+1+ilist.size()%>,this)">
					     <table width="490" style=" float:left; " >
							 ...
							 <tr>
							     <td></td>
							    <td >
							    <font><img src="/res/images/tuan/clock.jpg" style=" vertical-align:text-bottom;" />&nbsp;倒计时：
