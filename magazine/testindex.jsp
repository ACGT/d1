...
.mod_top_banner{height:35px;width:100%;background:url(http://imgcache.qq.com/vipstyle/act/caibei_110826_tips/img/bg2.png);color:#333333;font-size:12px}
	...
	#ImgTable{table-layout:auto; z-index:99; }
	#ImgTable tr td a img{margin:1px;margin-top:0px;padding:0px;}
     #idNum{float:right;position:absolute;top:180px;right:10px; z-index:1000;}
     #idNum li{float:left;list-style:none;color: #000;text-align: center;line-height: 7px;width: 10px;height: 10px;	font-family:"微软雅黑";font-size: 6px; font-weight:bold; cursor: pointer;margin: 2px;color:#e6dfe7;background:#e6dfe7;}
     #idNum li.on{line-height: 7px;width: 10px;height: 10px;color:#fff;background:#a92e29; color:#a92e29;}
     
     .oldstyle1{ position:fixed; _position: absolute;  right:0px; bottom:0px; background:#fff; width: 339px;height:232px;over-flow:hidden; border:solid 1px #000;font-size:12px; _top:expression(documentElement.scrollTop+documentElement.clientHeight-this.offsetHeight);
            background:url('http://images.d1.com.cn/images2012/tckbg.gif'); width:339px; height:232px;
            }
.newstyle1{ position:fixed; _position: absolute;  right:0px; bottom:0px; background:#fff; width: 339px;height:0px;over-flow:hidden;border:1px solid #b0465a;font-size:12px; _top:expression(documentElement.scrollTop+documentElement.clientHeight-this.offsetHeight); display:none;}
...
function closeSC(){
	...
	//$("#sc").removeClass("oldstyle1");
	//$("#sc").addClass('newstyle1');	
...
<%
   ...
   <!-- page开始 -->
	<div id="page">
	<script type="text/javascript" language="javascript" src="<%=com.d1.helper.ResourceHelper.getResourceVersion("/res/js/indextclb.js")%>"></script>
       
	<div id="sc" class="oldstyle1">
	    <table width="100%">
	        <tr><td style="text-align:right; line-height:27px; padding-right:6px;" height="27">
	        <a href="javascript:void(0)" onclick="closeSC();"><img src="http://images.d1.com.cn/images2012/tckcha.gif"/></a></td></tr>
	        <tr>
	           <td style="text-align:center;">
	          <script>ShowCenter(<%= ScrollImg("2859") %>,<%= ScrollText("2859") %>)</script>
	        </td></tr>
	    </table>
	</div>
	<!-- banner -->
