...
//}else{
	...
	if(cartList!=null){
		for(Cart c123:cartList){
			if(c123.getType().longValue()==13&&c123.getTuanCode().startsWith("mqdd140102xg")){
				hasOne = true ;
				break;
			}
		}
	...
	if(hasOne){
		out.print("{\"code\":1,message:\"一个订单只能订购一个此类0元商品！\"}");
		return;
	}
	...
	*/
	...
	float ftuanprice=0;
		if( "02103002".equals(gdsid) || "02103003".equals(gdsid) || "02103004".equals(gdsid) || "02103005".equals(gdsid)){
			ftuanprice=9.9f;
		}else if( "01715915".equals(gdsid) || "01715916".equals(gdsid)|| "01715917".equals(gdsid)|| "01715918".equals(gdsid)
				|| "01715919".equals(gdsid)){
			ftuanprice=75;
		}else if( "02000792".equals(gdsid) || "02000793".equals(gdsid)|| "02000794".equals(gdsid)|| "02000796".equals(gdsid)
				|| "02000797".equals(gdsid)){
			ftuanprice=9.9f;
		}else if( "03300092".equals(gdsid) || "03300091".equals(gdsid) || "03300090".equals(gdsid) ){
			ftuanprice=49;
			 
		}else if( "03000498".equals(gdsid) || "03000497".equals(gdsid) || "03000496".equals(gdsid) || "03000495".equals(gdsid)
				|| "03000494".equals(gdsid)|| "03000493".equals(gdsid)|| "03000492".equals(gdsid)|| "03000491".equals(gdsid)
				|| "03000490".equals(gdsid)|| "03000489".equals(gdsid)|| "03000488".equals(gdsid)|| "03000487".equals(gdsid)){
					ftuanprice=59;
		}else if("02001587".equals(gdsid) || "02001588".equals(gdsid)|| "02001589".equals(gdsid)){
					ftuanprice=49;
		}else if("03000480".equals(gdsid) || "03000469".equals(gdsid)|| "03000468".equals(gdsid)){
					ftuanprice=49;
		}else if("02001571".equals(gdsid) || "02001572".equals(gdsid)|| "02001594".equals(gdsid)|| "02001595".equals(gdsid)
						|| "02001596".equals(gdsid)){
					ftuanprice=39;
		}else if("02000026".equals(gdsid) || "02000027".equals(gdsid)){
			ftuanprice=59;
		}else if("03200078".equals(gdsid) || "03200077".equals(gdsid)){
			ftuanprice=35;
		}else if("01517028".equals(gdsid) || "01517029".equals(gdsid)|| "01517027".equals(gdsid)|| "01517026".equals(gdsid)){
			ftuanprice=119;
		}else if("02001627".equals(gdsid) || "02001626".equals(gdsid)){
			ftuanprice=79;
		}else if(("01517382".equals(gdsid) || "01512997".equals(gdsid)|| "01511839".equals(gdsid)|| "01516349".equals(gdsid))&&!strgdsdh_code.startsWith("mqdd131212sp")){
			ftuanprice=89;	
		}else if("03100026".equals(gdsid) || "03100027".equals(gdsid)){
			ftuanprice=69;
		}else if("03000777".equals(gdsid) || "03000778".equals(gdsid)){
			ftuanprice=25;
		}else if("04000534".equals(gdsid) || "04000533".equals(gdsid)){
			ftuanprice=69;
		}else if(("03000330".equals(gdsid) || "03000331".equals(gdsid)|| "03000332".equals(gdsid)
				|| "03000333".equals(gdsid))&&strgdsdh_code.startsWith("mqdd1312yjy")){
			ftuanprice=0;
			zoflag=true;
		}else if(("02000873".equals(gdsid) || "02000875".equals(gdsid)|| "02000872".equals(gdsid)
				|| "02000871".equals(gdsid)|| "02000874".equals(gdsid))&&strgdsdh_code.startsWith("mqdd1312ejz")){
			ftuanprice=0;
			zoflag=true;
		}else if("01413326".equals(gdsid) || "01414432".equals(gdsid)|| "01413325".equals(gdsid)
				|| "01415617".equals(gdsid)|| "01413324".equals(gdsid)){
			ftuanprice=19;
		}else if("02004189".equals(gdsid) || "02004190".equals(gdsid)|| "02004191".equals(gdsid)
				|| "02004192".equals(gdsid)){
			ftuanprice=69;
		}else if("02004177".equals(gdsid) || "02004178".equals(gdsid)|| "02004179".equals(gdsid)){
			ftuanprice=169;
		}else if("02004180".equals(gdsid) || "02004181".equals(gdsid)|| "02004182".equals(gdsid)){
			ftuanprice=89;
		}else if("03000863".equals(gdsid) || "03000865".equals(gdsid)|| "03000866".equals(gdsid)
				|| "03000867".equals(gdsid)|| "03000868".equals(gdsid)|| "03000869".equals(gdsid)){
			ftuanprice=59;
		}else if(("03000779".equals(gdsid)&&strgdsdh_code.startsWith("mqdd131212fz"))){
			ftuanprice=49;
		}else if(("03000330".equals(gdsid) || "03000331".equals(gdsid)|| "03000332".equals(gdsid)
				||"03000333".equals(gdsid))&&strgdsdh_code.startsWith("mqdd131212fz")){
			ftuanprice=69;
		}else if(("02000873".equals(gdsid) || "02000875".equals(gdsid)|| "02000872".equals(gdsid)
				||"02000871".equals(gdsid)|| "02000874".equals(gdsid))&&strgdsdh_code.startsWith("mqdd131212fz")){
			ftuanprice=59;
		}else if(("01511839".equals(gdsid)&&strgdsdh_code.startsWith("mqdd131212sp"))){
			ftuanprice=85;
		}else if(("01517871".equals(gdsid)||"01517623".equals(gdsid))&&strgdsdh_code.startsWith("mqdd131212sp")){
			ftuanprice=39;
		}else if("02007515".equals(gdsid)||"02007522".equals(gdsid)){
			ftuanprice=45;
		}else if(("01417693".equals(gdsid) || "01414170".equals(gdsid))&&strgdsdh_code.startsWith("mqdd140102xg")){
			ftuanprice=0;
			zoflag=true;
		}else if("02007980".equals(gdsid) || "02007981".equals(gdsid)|| "02007982".equals(gdsid)
				|| "02007983".equals(gdsid)){
			ftuanprice=45;
		}else if("03003450".equals(gdsid) || "03003449".equals(gdsid)){
			ftuanprice=69;
		}else if("03003448".equals(gdsid) || "03003447".equals(gdsid)){
			ftuanprice=55;
		}else if("02008209".equals(gdsid) || "02008210".equals(gdsid)|| "02008211".equals(gdsid)){//2014-2-28结束
			ftuanprice=39;
		}else if("02008202".equals(gdsid) || "02008203".equals(gdsid)){
			ftuanprice=29;
		}else if("06000063".equals(gdsid) || "06000064".equals(gdsid) || "06000065".equals(gdsid)){
			ftuanprice=29;
		}else if("01205425".equals(gdsid)){
			ftuanprice=79;
		}else if("01205426".equals(gdsid)){
			ftuanprice=99;
		}else if("01414008".equals(gdsid) || "01414563".equals(gdsid) || "01414078".equals(gdsid) || "01414561".equals(gdsid)
				 || "01411951".equals(gdsid) || "01411510".equals(gdsid) || "01417542".equals(gdsid) || "01417188".equals(gdsid)
				 || "01415003".equals(gdsid)){
			ftuanprice=49;
		}else if("01517990".equals(gdsid) || "01517991".equals(gdsid)){
			ftuanprice=29;
		}
		if(ftuanprice==0&&!zoflag){
			out.print("{\"code\":1,message:\"此兑换码信息错误！\"}");
			return;
		}
	Cart cart = new Cart();
