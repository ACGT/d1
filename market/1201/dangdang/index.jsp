			...
			if(json.code==1){
				...
				var s="";if((typeof c)!="undefined"){s="?c="+encodeURIComponent(c);}else{s=""+document.location;s=s.replace("http://","");s=s.substring(s.indexOf("/"));s="?c="+encodeURIComponent(s);}$.load("选择商品",400,"choosesku.jsp?code="+code);
				 ...
				 $('#imageField').attr('attr',code);
				    $.inCart(obj,{ajaxUrl:'/ajax/flow/dddhInCard.jsp',width:400,align:'center'});
			}
		},beforeSend: function(){
		},complete: function(){
		}
...
<table id="__01" width="980"  border="0" cellpadding="0" cellspacing="0" align="center">
	<tr>
		<td colspan="2">
			<a href="http://www.d1.com.cn/product/01718807" target="_blank"><img src="http://images.d1.com.cn/market/1201/dangdang/dangdangtop.jpg" alt="" width="270" height="46" border="0"></a></td>
		<td colspan="6">
			</td>
		<td></td>
	</tr>
	...
	List<Promotion> recommendList = PromotionHelper.getBrandListByCode("2856" , (int)50);
