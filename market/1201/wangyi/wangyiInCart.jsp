...
if(Tools.isNull(memo)){
	...
	*/
	float ftuanprice=-1;
		if( "03200047".equals(gdsid) || "03200047".equals(gdsid) || "03300070".equals(gdsid) || "03300071".equals(gdsid)){
			ftuanprice=0;
		}
		else if("03300077".equals(gdsid) || "03300076".equals(gdsid)){
			ftuanprice=0;
		}else if("03000117".equals(gdsid) || "03000118".equals(gdsid)|| "03000119".equals(gdsid)|| "03000120".equals(gdsid)|| "03000121".equals(gdsid)
				|| "03000122".equals(gdsid)|| "03000123".equals(gdsid)|| "03000124".equals(gdsid)|| "03000125".equals(gdsid)){
				ftuanprice=0;
		}else if("01715915".equals(gdsid) || "01715916".equals(gdsid)|| "01715917".equals(gdsid)|| "01715918".equals(gdsid)|| "01715919".equals(gdsid)
				){
				ftuanprice=0;
		}else if("03000481".equals(gdsid) || "03000482".equals(gdsid)|| "03000483".equals(gdsid)|| "03000484".equals(gdsid)
				|| "03000485".equals(gdsid)|| "03000486".equals(gdsid)|| "03000505".equals(gdsid)|| "03000504".equals(gdsid)){
				ftuanprice=0;
		}else if("02001587".equals(gdsid) || "02001588".equals(gdsid)|| "02001589".equals(gdsid)){
				ftuanprice=0;
		}else if("02000026".equals(gdsid) || "02000027".equals(gdsid)|| "03000047".equals(gdsid)|| "03000048".equals(gdsid)){
			ftuanprice=0;
		}else if("02001583".equals(gdsid) || "02001584".equals(gdsid)|| "02001585".equals(gdsid)|| "02001586".equals(gdsid)){
			ftuanprice=0;
		}
