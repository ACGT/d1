...
//}else{
	...
	if(Tuandh_mid!=9 && Tuandh_mid!=36  && Tuandh_mid!=39 && Tuandh_mid!=40){
	...
	*/
	float ftuanprice=0;
	if(Tuandh_mid==9){
		if( "01516553".equals(gdsid) || "01516782".equals(gdsid) || "01517453".equals(gdsid)){
			ftuanprice=139;
		}else if( "02000859".equals(gdsid) || "02000860".equals(gdsid) || "02000861".equals(gdsid)|| "02000862".equals(gdsid) || "02000863".equals(gdsid)|| "02000864".equals(gdsid)){
			ftuanprice=79;
		}else if( "01517448".equals(gdsid) || "01516554".equals(gdsid) ){
			if("mqljt1211rksb".equals(tgid)){
				ftuanprice=129;	
			}else{
				ftuanprice=169;
			}
		...
		}else if( "03200048".equals(gdsid) || "03200047".equals(gdsid) ){
			ftuanprice=19;
		}else if( "01509447".equals(gdsid) || "01515179".equals(gdsid) ){
			ftuanprice=219;
		}
		else{
			out.print("{\"code\":1,message:\"此兑换码错误！\"}");
	...
	else if(Tuandh_mid==39){
		if( "01516234".equals(gdsid) || "01516235".equals(gdsid) || "01517049".equals(gdsid) || "01516236".equals(gdsid)){
			ftuanprice=69;
		}else if( "01517448".equals(gdsid) || "01516554".equals(gdsid) ){
			ftuanprice=129;
		}else{
	...
	else if(Tuandh_mid==36){
		if( "02000771".equals(gdsid) || "02000772".equals(gdsid) || "02000773".equals(gdsid) || "02000774".equals(gdsid) || "02000775".equals(gdsid) || "02000776".equals(gdsid) || "02000770".equals(gdsid)){
			ftuanprice=69;
		}else{
			out.print("{\"code\":1,message:\"此兑换码错误！\"}");
			return;
	...
	else if(Tuandh_mid==40){
		if("01505429".equals(gdsid) || "01507153".equals(gdsid) || "01505430".equals(gdsid) || "01505399".equals(gdsid) || "01511027".equals(gdsid) || "01507154".equals(gdsid) || "01505427".equals(gdsid) || "01514486".equals(gdsid) || "01505428".equals(gdsid) || "01514487".equals(gdsid)){
		ftuanprice=229;
		}else{
			out.print("{\"code\":1,message:\"此兑换码错误！\"}");
			return;
