...
function CheckForm(obj){
    ...
    $.inCart(obj,{ajaxUrl:'/ajax/flow/rxtuandhInCard.jsp',width:400,align:'center'});
}
</script>
<style type="text/css">
<!--
...
<table id="__01" width="980"  align="center"  border="0" cellpadding="0" cellspacing="0">
	...
	List<Promotion> recommendList = PromotionHelper.getBrandListByCode("2863" , (int)21);
  ...
  <%
	...
	<tr>
		<td colspan="7">
			<img src="http://images.d1.com.cn/market/1203/qqtuan/qqtdh1203_04.jpg" width="980" height="59" alt=""></td>
	</tr>
	<tr>
		<td colspan="2">
