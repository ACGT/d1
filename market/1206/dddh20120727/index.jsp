...
<div id="center">
			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/market/1206/wydh/dddh1.jpg" width="400" height="400" />
  ...
  <tr>
							  ...
							  <div class="frgwc_div" id="frgwc" style="display:none;">
								...
								<li>
									...
									<br/><br/>
									    ...
									    总计金额:￥<font id="countgdsmst3">48</font><br/>
									</div>
	...
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1206/wydh/dddh2.jpg" width="750" height="196" alt=""></td>
	</tr>
	<tr>
		<td>
...
function ShowAJaxdh(){
	...
	$.ajax({
		type: "get",
		dataType: "json",
		url: '/ajax/flow/dddhInCart20120727.jsp',
		cache: false,
