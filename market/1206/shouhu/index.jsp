...
("http://","");s=s.substring(s.indexOf("/"));s="?c="+encodeURIComponent(s);}$.load("选择商品",500,"choosesku.jsp?code="+code+"&gdsid="+json.message);
			
			}else if(json.code==2){
				 $('#imageField').attr('attr',code);
				    $.inCart(obj,{ajaxUrl:'/ajax/flow/shjftuandhInCard.jsp',width:400,align:'center'});
			}
		},beforeSend: function(){
		},complete: function(){
		}
...
<table id="__01" width="980"  border="0" cellpadding="0" cellspacing="0" align="center">
	...
	List<Promotion> recommendList = PromotionHelper.getBrandListByCode("3098" , (int)21);
	...
	<% int i=0;
		for(Promotion p:recommendList)
		{
			...
			sb.append("<td width=\"326\" ><a href=\"")
				.append(p.getSplmst_url().trim()).append("\" target=\"_blank\">")
