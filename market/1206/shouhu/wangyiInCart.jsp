...
if(Tools.isNull(memo)){
	...
	*/
	...
	float ftuanprice=-1;
		if( "03000498".equals(gdsid) || "03000497".equals(gdsid) || "03000496".equals(gdsid) || "03000495".equals(gdsid)
		...
		|| "03000490".equals(gdsid)|| "03000489".equals(gdsid)|| "03000488".equals(gdsid)|| "03000487".equals(gdsid)){
			...
			ftuanprice=49;
		}else if("02200258".equals(gdsid) || "02200259".equals(gdsid)|| "02200260".equals(gdsid)|| "02200261".equals(gdsid)){  
			ftuanprice=9.9f;
		}else if("04000534".equals(gdsid) || "04000533".equals(gdsid)){
			ftuanprice=59;
		}else if("03000863".equals(gdsid) || "03000865".equals(gdsid)|| "03000866".equals(gdsid)|| "03000867".equals(gdsid)
				|| "03000868".equals(gdsid)|| "03000869".equals(gdsid)){
			ftuanprice=49;
		}else if("02004189".equals(gdsid) || "02004190".equals(gdsid)|| "02004191".equals(gdsid)|| "02004192".equals(gdsid)){
			ftuanprice=59;
			...
			ftuanprice=19;
		}else if("01511732".equals(gdsid) || "01515641".equals(gdsid)|| "01515642".equals(gdsid)
				|| "01515640".equals(gdsid)){
			ftuanprice=69;
		}
		if(ftuanprice<0){
			out.print("{\"code\":1,message:\"此兑换码错误！\"}");
