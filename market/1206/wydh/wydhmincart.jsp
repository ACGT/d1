...
if(strgdsdh_code!=null&&!strgdsdh_code.startsWith("mqwyjfd1304qbpl")&&!strgdsdh_code.startsWith("mqwyjfd1304spcs")){
...
//}else{
	...
	String gdslist="03000117,03000118,03000119,03000120,03000121,03000122,03000123,03000124,03000125";

	if(gdslist.indexOf(gdsid)==-1||gdslist.indexOf(gdsid)==-1){
