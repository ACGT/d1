...
<title>【Sheromo 诗若漫】夏季新品韩版莫代尔棉防晒空调开衫（多色可选）</title>
<meta name="keywords" content="【Sheromo 诗若漫】夏季新品韩版莫代尔棉防晒空调开衫（多色可选）" />
<meta name="description" content="优尚网热卖产品【Sheromo 诗若漫】夏季新品韩版莫代尔棉防晒空调开衫（多色可选），在这你可以看到【Sheromo 诗若漫】夏季新品韩版莫代尔棉防晒空调开衫（多色可选）怎么样，让您买的放心，用的开心。" />
	    ...
	    <div class="goodsshow">
			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<h1>【Sheromo 诗若漫】夏季新品韩版莫代尔棉防晒空调开衫（多色可选）<font style="color:#f00">
</font></h1>
					...
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/images2012/market/wangyi/02000396_400_1.jpg" width="400" height="400" />
  ...
  <tr>
    ...
    <div style="float:left;padding-left:10px;height:26px;_height:24px;padding-bottom:11px;"> <input type="text" style="width:180px" name="cardno" id="cardno" style="border:none;"/></div>
				...
				<div  class="zh_title"><a href="###" class="newa">网易独享</a></div>
					<div class="clear"></div>
				 <div><%
		request.setAttribute("reccode","7908");
...
function ShowAJaxdh(){
	...
	$.ajax({
		...
		url: 'wydhmincart.jsp',
		cache: false,
		data: {gdsid:'02000396',cardno:cardno,skuId:sku2},
