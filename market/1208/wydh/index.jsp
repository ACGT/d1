...
<title>【AleeiShe 小栗舍】立体泡泡长袖打底衫（白色、黑色、玫红、粉红、紫色）</title>
<meta name="keywords" content="【AleeiShe 小栗舍】立体泡泡长袖打底衫（白色、黑色、玫红、粉红、紫色）" />
<meta name="description" content="优尚网热卖产品【AleeiShe 小栗舍】立体泡泡长袖打底衫（白色、黑色、玫红、粉红、紫色），在这你可以看到【AleeiShe 小栗舍】立体泡泡长袖打底衫（白色、黑色、玫红、粉红、紫色）怎么样，让您买的放心，用的开心。" />
	    ...
	    <div class="goodsshow">
			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<h1>【AleeiShe 小栗舍】立体泡泡长袖打底衫（白色、黑色、玫红、粉红、紫色）<font style="color:#f00">
</font></h1>
					...
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/images2012/market/wangyi/02000482_400_3.jpg" width="400" height="400" />
  ...
  <tr>
    ...
    <div style="float:left;padding-left:10px;height:26px;_height:24px;padding-bottom:11px;"> <input type="text" style="width:180px" name="cardno" id="cardno" style="border:none;"/></div>
							  ...
							  <div class="frgwc_div" id="frgwc" style="display:none;">
								...
								<li>
									...
									<br/><br/>
									    ...
									    总计金额:￥<font id="countgdsmst3">29.9</font><br/>
									</div>
				...
				<div  class="zh_title"><a href="###" class="newa">网易独享</a></div>
					<div class="clear"></div>
				 <div><%
		request.setAttribute("reccode","8025");
...
function ShowAJaxdh(){
	...
	$.ajax({
		type: "get",
		dataType: "json",
		url: '/market/1208/wydh/wydhInCart.jsp',
		cache: false,
		data: {gdsid:'02000482',cardno:cardno,skuId:sku2},
