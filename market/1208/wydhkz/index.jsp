			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/market/1304/xiaojk.jpg" width="400" height="400" />
...
function ShowAJaxdh(){
	...
	$.ajax({
		type: "get",
		dataType: "json",
		url: '/market/1208/wydhkz/wydhInCart.jsp',
		cache: false,
		data: {gdsid:'02000480',cardno:cardno,skuId:sku2},
