			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/images2012/market/wangyi/01721266_400.jpg" width="400" height="400" />
							  ...
							  <div class="frgwc_div" id="frgwc" style="display:none;">
								...
								<li>
									...
									<br/><br/>
									    ...
									    总计金额:￥<font id="countgdsmst3">25</font><br/>
									</div>
...
function ShowAJaxdh(){
	...
	http://misc.360buyimg.com/jd2008/skin//i/icon-veri.png
	$.ajax({
		type: "get",
		dataType: "json",
		url: '/market/1301/wydhwz/incart.jsp',
		cache: false,
		data: {gdsid:'01721266',cardno:cardno,skuId:sku2},
		error: function(XmlHttpRequest){
			...
			//	alert(json.cardimg);
				...
				if(json.message==-1){
					$.confirm("您未输入兑换码，是否以原价<%=memberprice%>元购买？","提示","$.close();ShowAJax('01721266');");
				}
					//if($.confirm('您未输入兑换码，是否以原价购买？')) {
					//ShowAJax("01721266");
				else{
					$.alert(json.message);	
				}
