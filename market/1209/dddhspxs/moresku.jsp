...
if(!Tools.isNull(product.getGdsmst_skuname1())){
    ...
    if(skuList != null && !skuList.isEmpty()){
    	int size = skuList.size();
    		...
    		sb.append("<div style=\"float:left;clear:both;\"><p><span style=\"color:#FC7C17;\">第二步</span>选择颜色：<font id=\"sizecount\">未选择</font></p></div>");
 ArrayList<GdsAtt> list=GdsAttHelper.getGdsAttByGdsid(gdsid);
    			...
    			sb.append("<div id=\"ccdzb_img\" style=\"position:absolute;display:none;clear:both;\" onmouseover=\"ccdzb()\" onmouseout=\"ccdzb1()\">");
    			sb.append("<img src=\"http://images.d1.com.cn/market/1206/wydh/fm9stx2_27.jpg\" border=\"0\"></div><div style=\"clear:both;\"></div>");
