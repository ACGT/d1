...
//获取所有参与兑换的商品
List<DhGdsM> dhgdsmList = getdhgdsmList("mqdd1208yf");
			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/images2012/market/dd/400-400-1.jpg" width="400" height="400" />
      ...
      String selectgdsid = "";
									    ...
									    if(dhgdsmList != null){
										    	...
										    	for(DhGdsM dhgds : dhgdsmList){
										    		...
										    		if(!"02000480".equals(dhgds.getDhgdsm_gdsid()) && !"02000482".equals(dhgds.getDhgdsm_gdsid()) ){
										    			title="T恤（"+title+"）";
										    		}
										    		String gId = Tools.trim(dhgds.getDhgdsm_gdsid());
										    		Product goods = ProductHelper.getById(gId);
										    		String imgurl=ProductHelper.getImageTo80(goods);
										    		if("02000482".equals(dhgds.getDhgdsm_gdsid()) ){
										    			imgurl="http://images.d1.com.cn/images2012/market/dd/tx.jpg";
										    		}
										    		//if(goods!=null&&goods.getGdsmst_validflag().longValue()==1)
										    		//{
										    		%><li <%if(i==1){ %> class="select"<%} %>>
										    		<A hideFocus title="<%=title %>" ptitle="<%=goods.getGdsmst_gdsname() %>" onclick=choosegdsid(this)  href="javascript:void(0);" attr="<%=dhgds.getDhgdsm_gdsid()%>" <%if(i==1){ %> class="current"<%} %>><img  height=80 width=80 src="<%=imgurl %>" />
										    		</a>
					...
					<span style="display:none">
					 <div class="goods_info">
						...
						<div class="goods_content_list">
							<img src="http://images.d1.com.cn/images2012/market/dd/yibuf.jpg"></img>
						</div>
						...
						<table id="__01" width="750" height="8452" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td>
			<a href="http://www.d1.com.cn/product/02000482" target="_blank"><img src="http://images.d1.com.cn/market/1209/dangdang/19yuanduih_01.jpg" alt="" width="750" height="43" border="0"></a></td>
	</tr>
	<tr>
		<td>
			<a href="http://www.d1.com.cn/product/02000482" target="_blank"><img src="http://images.d1.com.cn/market/1209/dangdang/19yuanduih_02.jpg" alt="" width="750" height="515" border="0"></a></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1209/dangdang/19yuanduih_03.jpg" width="750" height="538" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1209/dangdang/19yuanduih_04.jpg" width="750" height="810" alt=""></td>
	</tr>
	<tr>
		<td>
			<a href="http://www.d1.com.cn/product/02000480" target="_blank"><img src="http://images.d1.com.cn/market/1209/dangdang/19yuanduih_05.jpg" alt="" width="750" height="59" border="0"></a></td>
	</tr>
	<tr>
		<td>
			<a href="http://www.d1.com.cn/product/02000480" target="_blank"><img src="http://images.d1.com.cn/market/1209/dangdang/19yuanduih_06.jpg" alt="" width="750" height="934" border="0"></a></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1209/dangdang/19yuanduih_07.jpg" width="750" height="358" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1209/dangdang/19yuanduih_08.jpg" width="750" height="341" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1209/dangdang/19yuanduih_09.jpg" width="750" height="266" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1209/dangdang/19yuanduih_10.jpg" width="750" height="581" alt=""></td>
	</tr>
	<tr>
		<td>
			<a href="http://www.d1.com.cn/product/02000192" target="_blank"><img src="http://images.d1.com.cn/market/1209/dangdang/19yuanduih_11.jpg" alt="" width="750" height="61" border="0"></a></td>
	</tr>
	<tr>
		<td>
			<a href="http://www.d1.com.cn/product/02000192" target="_blank"><img src="http://images.d1.com.cn/market/1209/dangdang/19yuanduih_12.jpg" alt="" width="750" height="828" border="0"></a></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1209/dangdang/19yuanduih_13.jpg" width="750" height="402" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1209/dangdang/19yuanduih_14.jpg" width="750" height="1873" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1209/dangdang/19yuanduih_15.jpg" width="750" height="740" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1209/dangdang/19yuanduih_16.jpg" width="750" height="103" alt=""></td>
	</tr>
</table>
						</div>
