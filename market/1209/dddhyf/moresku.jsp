...
if(!Tools.isNull(product.getGdsmst_skuname1())){
   ...
   String c=size==1?skuList.get(0).getSkumst_sku1():"未选择" ;
    		sb.append("<div style=\"float:left;clear:both;\"><p><span style=\"color:#FC7C17;\">第二步</span>选择颜色和尺寸：<font id=\"sizecount\">").append(c).append("</font></p></div>");
