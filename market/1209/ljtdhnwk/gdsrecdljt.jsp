...
<dt style="width:145px; text-align:center;float:left">
		...
		<img src="<%=theimgurl.trim()%>" width=140 height=140 style="border: 1px solid #E1E1E1" >
		</a></div>
		...
		<%}%>" target=_blank style='text-decoration:none' >
		 <font style="font-size:10pt" color="#3c3c3c"><%=Tools.substring(pProduct.getSpgdsrcm_gdsname(),len)%></font></a></div>
		<%
		 if(booldx && dxprice>0){
			 %> 
		    ...
		    <span style="font-size:13px;font-weight:bold;color:#E96210;">领奖台独享价:￥<%=ProductGroupHelper.getRoundPrice(dxprice)%></span><br>
			 </div>
