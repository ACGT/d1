			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/images2012/market/wangyi/01721269_400_4[1].jpg" width="400" height="400" />
...
function ShowAJaxdh(){
	...
	$.ajax({
		...
		url: 'wydhmincart.jsp',
		cache: false,
		data: {gdsid:'01721269',cardno:cardno,skuId:sku2,giftgds:giftgds,zpsku:zpsku},
