...
//}else{
	...
	if(!"01721269".equals(tuandh.getTuandh_gdsid().trim())){
	...
	if(tuandh.getTuandh_mid()!=4){
		out.print("{\"code\":1,message:\"此兑换码错误11111！\"}");
		return;
	}
	...
	*/
	...
	if (!Tools.isNull(strgdsdh_giftgds)){
		...
		cart2.setTitle("【网易兑换赠品】【YOUSOO】一款三戴爱心の守候水晶项链");
		...
		String cardimg="http://images.d1.com.cn/images2012/market/wangyi/"+product.getId().trim()+"_"+skuId.trim()+".jpg";
		String color="";
		Sku sku=SkuHelper.getById(skuId);
		if(sku!=null){
			color=sku.getSkumst_sku1();
		}
		String pname="【诗若漫】时尚多用途双层扣糖果色女士钱包（"+color+"）";
