...
//获取所有参与兑换的商品
List<DhGdsM> dhgdsmList = getdhgdsmList("mqyl1209ssb");
int lcount=0;
int contentcount=0;
...
<meta name="description" content="<%=gname %>，在这你可以看到<%=gname %>的图片、评价、价格以及用户对他的使用感受，告诉你<%=gname %>怎么样，让您买的放心，用的开心。" />
			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/market/1209/yl/ssb400.jpg" width="400" height="400" />
