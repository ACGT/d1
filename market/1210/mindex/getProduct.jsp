...
<%
   ...
   {
	   price=Tools.parseFloat(request.getParameter("price"));
   } 
	 ...
	 //获取背景图片
	    ...
	    String imgurl="";
	     ...
	     if(width>784){%>
			 ...
			 <tr><td></td><td>
			 <a href="http://juhui.tenpay.com/commodity_detail.shtml?product_id=<%= product.getId() %>&sp_id=1212236301" target="_blank" ><img src="<%= imgurl %>"  style="background:#fff;"/></a></td>
			 <td></td></tr>
			 <tr><td coslpan="3" height="3"></td></tr>
			 <tr><td width="8"></td>
			 <td><a href="http://juhui.tenpay.com/commodity_detail.shtml?product_id=<%= product.getId() %>&sp_id=1212236301" target="_blank" style="font-size:13px;<%= namec%>">
			 ...
			 <font style=" font-family:微软雅黑;font-size:13px;<%= mpc%>">聚惠价：<b>￥<%= price==0?Tools.getFormatMoney(product.getGdsmst_memberprice()):price%></b></font>
		...
		{%>
			...
			<tr><td coslpan="3" height="3"></td></tr>
			<tr><td width="8"></td><td><a href="http://juhui.tenpay.com/commodity_detail.shtml?product_id=<%= product.getId() %>&sp_id=1212236301" target="_blank" style="font-size:13px;<%=namec%>"><%= Tools.substring(Tools.clearHTML(product.getGdsmst_gdsname()),64)%></a></td>
			<td width="8"></td></tr>
