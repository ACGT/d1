			...
			if(p!=null)
			{
				...
				for(PromotionImagePos pip:piplist)
				{
					...
					if(pip!=null)
					{
					    ...
					    map.append("<area shape=\"rect\" coords=\"").append(pip.getPos_x()+",").append(pip.getPos_y()+",").append(pip.getExt1()+",").append(pip.getExt2()).append("\" onmouseover=\"mdmoverf11105(\'"+ pip.getProductId().toString()+"\',"+(pip.getPos_x()+70)+",\'"+pip.getId()+"\',\'"+left+"px\',\'"+position+"\',\'"+endtop+"\',\'"+tf+"\',\'"+Tools.getFloat(pip.getPprice(),1)+"\')\" onmouseout=\"mdmoutf1105(\'"+flag+"\')\" onblur=\"mdmoutf1105(\'"+flag+"\')\""); 
