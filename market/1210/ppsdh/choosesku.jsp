...
<%
										    	...
										    	for(int i=0;i<strs.length;i++){
										    		...
										    		if(goods!=null&&goods.getGdsmst_validflag()!=null&& (goods.getGdsmst_validflag().longValue()==1 || goods.getGdsmst_validflag().longValue()==4))
										    		{
										    			...
										    			if(gg!=null){
										    				Product p = ProductHelper.getById(gg.getGdsgrpdtl_gdsid());
										    				if(p!=null && p.getGdsmst_validflag()!=null &&(p.getGdsmst_validflag().longValue()==1 && p.getGdsmst_ifhavegds().longValue()==0)){
										    				//	System.out.println(i+">>>"+gId);
