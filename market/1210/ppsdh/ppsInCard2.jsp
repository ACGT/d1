...
if(Tools.isNull(memo)){
	...
	float ftuanprice=0;
	 if( "05002090".equals(gdsid) || "05002091".equals(gdsid)|| "05002092".equals(gdsid)
			 || "05002093".equals(gdsid)|| "05002094".equals(gdsid)){
		ftuanprice=59;
	}
	if(ftuanprice==0){
	...
	Tools.getManager(Cart.class).create(cart);
		...
		out.print("{\"code\":0,\"success\":true,\"message\":\"添加成功！\",\"cardimg\":\""+cardimg+"\",\"pname\":\""+pname+"\"}");
		return;
//}
%>