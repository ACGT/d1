...
//获取所有参与兑换的商品
List<DhGdsM> dhgdsmList2 = getdhgdsmList("mqwyjfjm1210wj");
...
<div align="center"><img src="http://images.d1.com.cn/market/1206/wydh/wydh120601.jpg" width="980" height="45"></div>	 
	    ...
	    <div class="goodsshow">
			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<h1>【Sheromo 诗若漫】春秋百搭多色竹炭纤维加绒显瘦连脚打底裤
					</h1>
					</div>
					<hr class="newhr"/>
					<!-- 商品展示-->
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/images2012/market/wangyi/1210wyddk-1.jpg" width="400" height="400" />
					...
					<!-- 商品展示结束-->
				     ...
				     <div class="gs_right_spContent">
                         ...
                         <tr height="40">
						     ...
						     <tr>
							     <td colspan="3">
								     <div class="spgg" style="padding-bottom:0px; margin-bottom:0px;">
  ...
  <tr>
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
      <%
      String zpgdsid="01719683";
      Product p=ProductHelper.getById(zpgdsid);
      %>
        <td width="15%"><input type="checkbox" name="giftgds" id="giftgds" value="<%=zpgdsid %>"  onclick= "cbclick(this); "/></td>
        <td width="16%"><a href="http://www.d1.com.cn/product/<%=zpgdsid %>" target="_blank"><img src="http://images.d1.com.cn<%=p.getGdsmst_smallimg().trim() %>" width="80" height="80" border="0" /></a></td>
        <td width="69%">
        
        <font color="#FF0000" size="+1"><b>+39元</b></font>获得市场价<font color="#FF0000" size="+1"><b>159元</b></font>【AleeiShe 小栗舍】超大玛雅民族图案仿羊绒大披肩</td>
       </tr>
    </table></td>
  </tr>
...
<td colspan="2">
           <div class="spgg1" style="padding-bottom:0px; margin-bottom:0px;">
        	 <%String gdsarrstr2="";
      String selectgdsid2 = "";
      String skuname2=  p.getGdsmst_skuname1();                    
      if(!Tools.isNull(skuname2)){
	    	int showsku2=1;
		    ...
		    List<Sku> skuList = SkuHelper.getSkuListViaProductIdO(zpgdsid,showsku2);
		    if(skuList != null && !skuList.isEmpty()){
		    	int size = skuList.size();
		    	%><div id="skuname3" class="skuname1">
		    		<p>选择<%=skuname2 %>：<font id="sizecount3"><%=size==1?skuList.get(0).getSkumst_sku1():"未选择" %></font>
		    		 </p>
		    		...
		    		for(int i=0;i<size;i++){
		    			...
		    			if(p.getGdsmst_stocklinkty()!=null&&(p.getGdsmst_stocklinkty().longValue()==1||p.getGdsmst_stocklinkty().longValue()==2)){
		    				if(CartItemHelper.getProductOccupyStock(p.getId(), sku.getId())<ProductHelper.getVirtualStock(p.getId(), sku.getId())){
			    				%><li<%if(size==1){ %> class="select"<%} %>><a href="javascript:void(0);" title="<%=skuname %>" attr="<%=sku.getId() %>" onclick="chooseskuname3(this)" hidefocus="true"<%if(size==1){ %> class="current"<%} %>><img  height=80 width=65 src="http://images.d1.com.cn/images2012/market/wangyi/<%=zpgdsid %>_<%=sku.getId().trim()%>.jpg " />
		    		</a>
		    		<br/><br/><br/><%=skuname%></li><%
		    				}
		    				else
		    				{
		    					if(sku.getSkumst_vstock().longValue()==0){ %>
		    						<li><a href="javascript:void(0);" title="售罄"   hidefocus="true"  style="height:21px;line-height:21px;padding:0 9px;border:1px solid #dcdddd;background:#fff;color:#dcdddd;text-decoration:none;"><img  height=80 width=65 src="http://images.d1.com.cn/images2012/market/wangyi/<%=zpgdsid %>_<%=sku.getId().trim()%>.jpg " />
		    		</a>
		    		<br/><br/><br/><%=skuname%></li>
		    					<%}
		    					else
				...
				<%
									   ...
									   // if(!Tools.isNull(skuname1)){
									    	...
									    	//}
									    	//System.out.println(showsku);
										    List<Sku> skuList2 = SkuHelper.getSkuListViaProductIdO(selectgdsid2,showsku);
										    if(skuList2 != null && !skuList2.isEmpty()){
										    	int size = skuList2.size();
										    	%><div id="skuname3" class="skuname">
										    	<p>选择尺寸：<font id="sizecount3"><%=size==1?skuList2.get(0).getSkumst_sku1():"未选择" %></font>
										  
										    	  <%  ArrayList<GdsAtt> list=GdsAttHelper.getGdsAttByGdsid(id);
										    		 if(list!=null&&list.size()>0 || (p.getGdsmst_sizeid()!=null && p.getGdsmst_sizeid()>0))
										    		   {
										    			   String sizeinfo="";
											    		   if(p.getGdsmst_sizeid()!=null && p.getGdsmst_sizeid()>0){
											    			   sizeinfo= getsizeinfo(p);
											    		   }
										    			   if((list.size()>0&& list.get(0).getGdsatt_content().length()>0) || !Tools.isNull(sizeinfo)){
										    		    %>
										    			  	<font id="ccdzb2" style=" color:#020399; cursor:hand;padding-left:15px;" onmouseover="ccdzb3()" onmouseout="ccdzb4()">(尺寸对照表)</font> </p>
										    		      <div id="ccdzb_img2" style="position:absolute;display:none;<%if(!Tools.isNull(sizeinfo)) {%>border:1px solid black;background-color:#ffffff;<%} %>" onmouseover="ccdzb3()" onmouseout="ccdzb4()">
										    		    <%
...
Tools.setCookie(response,"rcmdusr_rcmid","110",(int)(Tools.DAY_MILLIS/1000*1));
		...
		request.setAttribute("reccode","8182");
...
<table width="750" border="0">
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012101795957351.gif" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023163944627.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012101710012628.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023164020893.jpg" width="750"/></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012101710023390.jpg" width="750"/></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023164054241.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012101710034353.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012101710039385.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012101710044440.jpg" width="750" /></td>
  </tr>
    <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012102316408145.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023164132525.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023164138536.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023164154591.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012102316422277.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012102316428962.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023164213457.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023164220522.jpg" width="750" /></td>
  </tr>
    <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023184520694.jpg" width="750" /></td>
  </tr>
    <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023184559503.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012102318464108.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012102318469892.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023184615307.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023184621589.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023184630599.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023184639954.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023185522465.jpg" width="750" /></td>
  </tr>
    <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012102318562816.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012102318569460.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023185615772.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023185621803.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023185627301.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023185634928.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023185640396.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023183132278.jpg" width="750" /></td>
  </tr>
    <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023183354321.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012102318357709.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023183533875.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023183541776.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023183550936.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012102318366622.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023183613101.jpg" width="750" /></td>
  </tr>
   <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023184026379.jpg" width="750" /></td>
  </tr>
    <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012102318413266.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012102318418799.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023184114297.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023184119237.jpg" width="750" /></td>
  </tr>
    <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023184132220.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023184124485.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023184138676.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012102319353611.jpg" width="750" /></td>
  </tr>
    <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012102319025317.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012102319031464.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012102319036767.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012102319042324.jpg" width="750" /></td>
  </tr>
    <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012102319048806.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012102319054469.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012102319059832.jpg" width="750" /></td>
  </tr>
   <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023185054528.jpg" width="750" /></td>
  </tr>
    <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023185142723.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023185148981.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023185154279.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012102318520678.jpg" width="750" /></td>
  </tr>
    <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012102318525168.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023185211370.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023185216367.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012101710133118.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012101710142713.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012101710149116.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012101710155533.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/201210171021861.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/201210171029267.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012101710219558.jpg" width="750" /></td>
  </tr>
  <tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/2012101710227576.jpg" width="750" /></td>
  </tr>
    <td><img src="http://images.d1.com.cn/edit/UploadFile/gdsimg/201210/20121023184241249.jpg" width="750" /></td>
  </tr>
</table>
...
function ShowAJaxdh(){
	...
	$.ajax({
		...
		url: 'wydhmincart.jsp',
		cache: false,
		data: {gdsid:skuys,cardno:cardno,skuId:sku2,giftgds:giftgds,zpsku:zpsku},
