...
.spgg1 .skuname ul{width:330px;line-height:25px;_zoom:1;margin-bottom:5px;_margin-bottom:5px;*margin-bottom:5px;}
...
.spgg1 .skuname1{padding-bottom:5px;overflow:hidden;_zoom:1;}
...
<div align="center"><img src="http://images.d1.com.cn/market/1206/wydh/wydh120601.jpg" width="980" height="45"></div>	 
     ...
     String selectgdsid = "";
							 ...
							 <tr><td colspan="3" height="38"><input type="hidden" value="3" id="hzp"/>
							 <table width="338" border="0" cellpadding="0" cellspacing="0">
  <tr id="btn3">
    <td colspan="2" >
    <a href="javascript:void(0)" onclick="getzp()"><img src="http://images.d1.com.cn/images2012/market/wangyi/1211btn.png"/></a>
       </td>
  </tr>
  <tr id="tr3" style="display:none;"> <td colspan="2" id="td3"></td></tr>
   <tr id="btn4" style="display:none;">
    <td colspan="2" style="padding-top:5px;"><a href="javascript:void(0)" onclick="getzp()"><img src="http://images.d1.com.cn/images2012/market/wangyi/1211btn.png"/></a>
       </td>
  </tr>
  <tr id="tr4" style="display:none;"> <td colspan="2" id="td4"></td></tr>
   <tr id="btn5" style="display:none;">
    <td colspan="2" style="padding-top:5px;"><a href="javascript:void(0)" onclick="getzp()"><img src="http://images.d1.com.cn/images2012/market/wangyi/1211btn.png"/></a>
       </td>
  </tr>
  <tr id="tr5" style="display:none;"> <td colspan="2" id="td5"></td></tr>
   <tr id="btn6" style="display:none;">
    <td colspan="2" style="padding-top:5px;"><a href="javascript:void(0)" onclick="getzp()"><img src="http://images.d1.com.cn/images2012/market/wangyi/1211btn.png"/></a>
       </td>
  </tr>
  <tr id="tr6" style="display:none;"> <td colspan="2" id="td6"></td></tr>
   <tr id="btn7" style="display:none;">
    <td colspan="2" style="padding-top:5px;"><a href="javascript:void(0)" onclick="getzp()"><img src="http://images.d1.com.cn/images2012/market/wangyi/1211btn.png"/></a>
       </td>
  </tr>
  <tr id="tr7" style="display:none;"> <td colspan="2" id="td7"></td></tr>
  <tr>
...
function ShowAJaxdh(){
	...
	$.ajax({
		type: "get",
		dataType: "json",
		url: 'wydhmincarttest.jsp',
		cache: false,
		data: {gdsid:skuys,cardno:cardno,skuId:sku2,giftgds:giftgds},
		error: function(XmlHttpRequest){
