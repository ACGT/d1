...
<div align="center"><img src="http://images.d1.com.cn/market/1206/wydh/wydh120601.jpg" width="980" height="45"></div>	 
  ...
  <tr>
    <td colspan="2">
      <input type="button" value="加10元再得一件"/>
       </td>
  </tr>
   <%   
   if(dhgdsmList != null){
   ...
   <div id="skuname<%=j %>" class="skuname1">
									           	<p>选择颜色：<font id="sizecount<%=j %>"></font></p>
									    		<ul><%
									    		String selectSku2 = "";
										    	...
										    	for(DhGdsM dhgds : dhgdsmList){
										    		...
										    		//{
										    		%><li>
										    		<A hideFocus title="<%=dhgds.getDhgdsm_title()%>"  onclick=choosegdsid<%=j %>(this)  href="javascript:void(0);" attr="<%=dhgds.getDhgdsm_gdsid()%>" <%if(i==1){ %> class="current"<%} %>><img  height=80 width=80 src="<%=ProductHelper.getImageTo80(goods) %>" />
										    		</a>
										    		<br/><br/><br/><%=dhgds.getDhgdsm_title()%></li><%
										    		//}
										    		if (i==1){
										    	...
										    	function choosegdsid<%=j %>(obj){
										    	  ...
										    	  if (skuid.length > 0){
										    	  	...
										    	  	$('#sizecount'+<%=j %>).html($(obj).attr("title"));
										    	  }
