...
//获取所有参与兑换的商品
//List<DhGdsM> dhgdsmList2 = getdhgdsmList("mqwyjf1209wdk");
	    ...
	    <div class="goodsshow">
			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<h1>【FEEL MIND】FM男装印第安贴布图案6色时尚卫衣裤
					</h1>
					</div>
					<hr class="newhr"/>
					<!-- 商品展示-->
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/market/1303/weikunan.jpg" width="400" height="400" />
