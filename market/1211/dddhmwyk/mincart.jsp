...
if(!strgdsdh_code.startsWith("mqd130313dhfz")&&!strgdsdh_code.startsWith("mqd130314dhfz")){
	out.print("{\"code\":1,message:\"该兑换码错误，请重新输入！\"}");
	return;
}
...
if (!Tools.isNull(strgdsdh_giftgds) && Tools.isNull(zpsku)){
	out.print("{\"success\":false,message:\"请选择赠品颜色和尺码。\"}");
	return;
}
...
//}else{
	//直接加入购物车。，数量默认1.
	String gdslist="02000775,02000774,02000773,02000772,02000771,02000770,03000151,03000152,03000153,03000154,03000155,03000156";
	...
	*/
	...
	if (!Tools.isNull(strgdsdh_giftgds)){
		...
		cart2.setTitle("【当当兑换赠品】"+ProductHelper.getById(strgdsdh_giftgds).getGdsmst_gdsname());
