	    ...
	    <div class="goodsshow">
			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<h1>【FEEL MIND】纯牛皮印第安头像皮带<br/><font style="color:red;">热卖单品 深棕色卖断货 仅能选择浅咖色 望谅解！
					</font>
					</h1>
					</div>
					<hr class="newhr"/>
					...
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/images2012/market/dd/dddhyd1205.jpg" width="400" height="400" />
				 ...
				 <hr style=" border:5px solid #fff" />
					...
					<span style="display:none">
					 <div class="goods_info">
						...
						<br/><font style="color:red;">热卖单品 深棕色卖断货 仅能选择浅咖色 望谅解！<br/>
					</font>
