...
//}else{
	...
	String cardimg="http://images.d1.com.cn/images2012/market/wangyi/"+product.getId().trim()+"-"+skuId.trim()+".jpg";
	String color="";
	Sku sku=SkuHelper.getById(skuId);
	if(sku!=null){
		color=sku.getSkumst_sku1();
	}
	String pname="【AleeiShe 小栗舍】限量版蝴蝶印刻多彩拉链钱包手拿包（"+color+"）";
