...
<div align="center"><img src="http://images.d1.com.cn/market/1206/wydh/wydh120601.jpg" width="980" height="45"></div>	 
	    ...
	    <div class="goodsshow">
			...
			<div class="gs_right">
			     <!-- 商品展示-->
			    <div class="goods_new">
					<div class="gs_right_title" style="text-align:left;">

					<h1><%=gname %><br/><font style="color:#f00" size="+1">热销爆款预售中！预计18号发出，请耐心等待，带来不便请谅解！
</font></h1>
					...
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/images2012/market/wy1211/dadiku.jpg" width="400" height="400" />
  ...
  <tr>
    ...
    <div style="float:left;padding-left:10px;height:26px;_height:24px;padding-bottom:11px;"> <input type="text" style="width:180px" name="cardno" id="cardno" style="border:none;"/></div>
				...
				<div  class="zh_title"><a href="###" class="newa">网易独享</a></div>
					<div class="clear"></div>
				 <div><%
		request.setAttribute("reccode","8266");
...
function ShowAJaxdh(){
	...
	$.ajax({
		...
		url: 'incart.jsp',
		cache: false,
		data: {gdsid:'02000803',cardno:cardno,skuId:sku2,giftgds:giftgds,zpsku:zpsku},
