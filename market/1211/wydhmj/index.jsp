...
int lcount=CommentHelper.getLevelView(product.getId());
int contentcount=CommentHelper.getCommentLength(product.getId());
 ...
 <div align="center"><img src="http://images.d1.com.cn/market/1206/wydh/wydh120601.jpg" width="980" height="45"></div>	 
			...
			<div class="gs_right">
			    ...
			    <div class="goods_new" style="width:769px;">
					...
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/images2012/market/wangyi/121115mj_2.jpg" width="400" height="400" />
  ...
  <tr>
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="15%"><input type="checkbox" name="giftgds" id="giftgds" value="03200047"  onclick= "cbclick(this); "/></td>
        <td width="16%"><a href="http://www.d1.com.cn/product/03200047" target="_blank"><img src="http://images.d1.com.cn/shopadmin/d1gdsimg/2012/10/03/03200047_s_9.jpg" width="80" height="80" border="0" /></a></td>
        <td width="69%">
        
        <font color="#FF0000" size="+1"><b>+29元</b></font>获得市场价<font color="#FF0000" size="+1"><b>249元</b></font>【FEEL MIND】纯牛皮印第安头像皮带</td>
       </tr>
    </table></td>
  </tr>    
							  ...
							  <div class="frgwc_div" id="frgwc" style="display:none;">
								...
								<li>
									...
									<br/><br/>
									    ...
									    总计金额:￥<font id="countgdsmst3">89</font><br/>
									</div>
...
Tools.setCookie(response,"rcmdusr_rcmid","110",(int)(Tools.DAY_MILLIS/1000*1));
		...
		request.setAttribute("reccode","8244");
		...
		<jsp:include   page= "/html/gdsrecdxwy.jsp"   /></div>	
				 ...
				 <hr style=" border:5px solid #fff" />
					...
					<span style="display:none">
					 <div class="goods_info">
						...
						<%=product.getGdsmst_detailintruduce() %>
					...
					<span>
					    	...
					    	int PAGE_SIZE = 10 ;
					    	PageBean pBean = new PageBean(contentcount,PAGE_SIZE,1);
					    	
					    	List<Comment> commentlist = CommentHelper.getCommentList(product.getId(),pBean.getStart(),PAGE_SIZE);
			 ...
			 <!--购买过本商品的用户还购买过-->
			 <% List<Comment> commentlist2 = CommentHelper.getCommentList(product.getId(),0,15);
...
function ShowAJaxdh(){
	...
	$.ajax({
		...
		url: 'incart.jsp',
		cache: false,
		data: {gdsid:'01719626',skuId:sku2,cardno:cardno,giftgds:giftgds,zpsku:zpsku},
		error: function(XmlHttpRequest){
