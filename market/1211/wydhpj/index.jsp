...
List<DhGdsM> dhgdsmList2 = getdhgdsmList("mqwyjf1210dk");
...
<div align="center"><img src="http://images.d1.com.cn/market/1206/wydh/wydh120601.jpg" width="980" height="45"></div>	 
	    ...
	    <div class="goodsshow">
			...
			<div class="gs_right">
			     <!-- 商品展示-->
			    <div class="goods_new" style="width:769px;">
					...
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/images2012/market/wy1211/pijian.jpg" width="400" height="400" />
   ...
   <tr>
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="15%"><input type="checkbox" name="giftgds" id="giftgds" value="02000791" onclick= "cbclick(this); "/></td>
        <td width="16%"><a href="http://www.d1.com.cn/product/02000791" target="_blank"><img src="http://images.d1.com.cn/shopadmin/d1gdsimg/2012/10/02/02000791_s_1.jpg" width="80" height="80" border="0" /></a></td>
        <td width="69%">

        <font color="#FF0000" size="+1"><b>+19元</b></font>获得市场价<font color="#FF0000" size="+1"><b>58元</b></font>【Sheromo 诗若漫】春秋百搭多色竹炭纤维加绒显瘦连脚打底裤</td>
      </tr>
    </table></td>
  </tr>
...
<td colspan="2">
      ...
      String selectgdsid2 = "";
									   ...
									   // if(!Tools.isNull(skuname1)){
									    	...
									    	//}
									    	//System.out.println(showsku);
										    List<Sku> skuList2 = SkuHelper.getSkuListViaProductIdO(selectgdsid2,showsku2);
  ...
  <tr>
    ...
    <div style="float:left;padding-left:10px;height:26px;_height:24px;padding-bottom:11px;"> <input type="text" style="width:180px" name="cardno" id="cardno" style="border:none;"/></div>
				...
				<div  class="zh_title"><a href="###" class="newa">网易独享</a></div>
					<div class="clear"></div>
				 <div><%
		request.setAttribute("reccode","8270");
