...
if(!strgdsdh_code.startsWith("mqwyjfcj1211st") && !strgdsdh_code.startsWith("mqwyjf1212cjds") && !strgdsdh_code.startsWith("mqwydh1212d")
		&& !strgdsdh_code.startsWith("mqwy1212mgh")&& !strgdsdh_code.startsWith("mqwydh1301pd")&&!strgdsdh_code.startsWith("mqwyjfj1302sp")){
	out.print("{\"code\":1,message:\"兑换码错误！\"}");
	return;
}
...
if(StringUtils.isDigits(num)){
	...
	if(tg!=null){
		...
		if(tuan!=null){
			...
			if (strgdsdh_code.startsWith("mqwyjfj1302sp"))
			{
				String cardno="mqwyjfj1302sp"+lUser.getId()+rndcard.nextInt(1000000);
				 Date enddate=sf.parse("2013-3-31 23:59:59");
				Ticket tktmst=new Ticket();
				 tktmst.setTktmst_value(new Float(15));
		         ...
		         tktmst.setTktmst_gdsvalue(new Float(15));
			 ...
			 Date enddate=sf.parse("2013-2-28 23:59:59");
			...
			if (strgdsdh_code.startsWith("mqwyjfj1302sp"))
			{
			out.print("{\"code\":0,message:\"恭喜您！成功兑换15元全场通用优惠券1张！\"}");
			}else{
