...
List<DhGdsM> dhgdsmList2 = getdhgdsmList("mqwyjf1212mf");
			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/images2012/market/wangyi1212/03000317.jpg" width="400" height="400" />
   ...
   <tr>
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      %>
        ...
        <font color="#FF0000" size="+1"><b>+79元</b></font>获得市场价<font color="#FF0000" size="+1"><b><%=Tools.getFormatMoney(p.getGdsmst_saleprice()) %>元</b></font><%=Tools.clearHTML(p.getGdsmst_gdsname()) %></td>
       </tr>
    </table></td>
  </tr>
							  ...
							  <div class="frgwc_div" id="frgwc" style="display:none;">
								...
								<li>
									...
									<br/><br/>
									    ...
									    总计金额:￥<font id="countgdsmst3">98</font><br/>
									</div>
...
function ShowAJaxdh(){
	...
	$.ajax({
		...
		url: 'wyjfincart.jsp',
		cache: false,
		data: {gdsid:'03000317',cardno:cardno,skuId:sku2,giftgds:giftgds,zpsku:zpsku},
		error: function(XmlHttpRequest){
