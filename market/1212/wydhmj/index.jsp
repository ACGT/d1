			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/images2012/market/wangyi/1212/01719626_400_565.jpg" width="400" height="400" />
  ...
  <tr>
    ...
    <div style="float:left;padding-left:10px;height:26px;_height:24px;padding-bottom:11px;"> <input type="text" style="width:180px" name="cardno" id="cardno" style="border:none;"/></div>
				...
				<div  class="zh_title"><a href="###" class="newa">网易独享</a></div>
					<div class="clear"></div>
				 <div><%
		request.setAttribute("reccode","8311");
...
function ShowAJaxdh(){
	...
	$.ajax({
		...
		url: 'incart.jsp',
		cache: false,
		data: {gdsid:'01719626',cardno:cardno,skuId:sku2,giftgds:giftgds,zpsku:zpsku},
		error: function(XmlHttpRequest){
