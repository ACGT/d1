			...
			<div class="gs_right">
			    ...
			    <div class="goods_new" style="width:769px;">
					...
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/market/1211/wangyi/01720110_400.jpg" width="400" height="400" />
   ...
   <tr>
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      %>
        ...
        <font color="#FF0000" size="+1"><b>+59元</b></font>获得市场价<font color="#FF0000" size="+1"><b><%=Tools.getFormatMoney(p.getGdsmst_saleprice()) %>元</b></font><%=Tools.clearHTML(p.getGdsmst_gdsname()) %></td>
       </tr>
    </table></td>
  </tr>
...
function ShowAJaxdh(){
	...
	$.ajax({
		...
		url: 'incart.jsp',
		cache: false,
		data: {gdsid:'01720110',cardno:cardno,skuId:sku2,giftgds:giftgds,zpsku:zpsku},
		error: function(XmlHttpRequest){
