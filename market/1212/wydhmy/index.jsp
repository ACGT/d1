...
String style = Tools.getFormatMoney(memberprice);
...
//获取所有参与兑换的商品
List<DhGdsM> dhgdsmList2 = getdhgdsmList("mqwyjf1212xjk");
List<DhGdsM> dhgdsmList = getdhgdsmList("mqwyjf1212my");
int lcount=0;
int contentcount=0;
...
<div align="center"><img src="http://images.d1.com.cn/market/1206/wydh/wydh120601.jpg" width="980" height="45"></div>	 
	    ...
	    <div class="goodsshow">
			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<h1>【Sheromo 诗若漫】蝙蝠袖宽松款V领加厚棒针麻花毛衣<font style="color:#f00">
</font></h1>
					...
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/images2012/market/wangyi1212/02001025.jpg" width="400" height="400" />
    ...
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      %>
        ...
        <font color="#FF0000" size="+1"><b>+69元</b></font>获得市场价<font color="#FF0000" size="+1"><b><%=Tools.getFormatMoney(p.getGdsmst_saleprice()) %>元</b></font><%=Tools.clearHTML(p.getGdsmst_gdsname()) %></td>
       </tr>
    </table></td>
  </tr>
