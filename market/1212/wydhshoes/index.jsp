			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/images2012/market/wangyi1212/03100006.jpg" width="400" height="400" />
							  ...
							  <div class="frgwc_div" id="frgwc" style="display:none;">
								...
								<li>
									...
									<br/><br/>
									    ...
									    总计金额:￥<font id="countgdsmst3">169</font><br/>
									</div>
...
function ShowAJaxdh(){
	...
	$.ajax({
		...
		url: 'wyjfincart.jsp',
		cache: false,
		data: {gdsid:'03100006',cardno:cardno,skuId:sku2,giftgds:giftgds,zpsku:zpsku},
		error: function(XmlHttpRequest){
