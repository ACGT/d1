...
<div class="header-links">		
	...
	<div class="navigation">		
		...
		<ul class="navigation-list ch5On"><!-- 哪个频道被激活，则左侧调用 chxOn -->
			...
			<li class="ch4"><a href="http://club.mail.163.com/jifen/lottery/list.do" target="_blank" >抽奖区</a></li>
<li class="ch5"><a href="http://www.d1.com.cn/market/1212/wangyi/index.jsp" target="_blank" >兑换区</a></li>
