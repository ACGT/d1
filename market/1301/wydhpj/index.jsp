...
//获取所有参与兑换的商品
List<DhGdsM> dhgdsmList = getdhgdsmList("mq1301wypj");
int lcount=0;
int contentcount=0;
	    ...
	    <div class="goodsshow">
			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<h1>【FEEL MIND】经典商务休闲真皮钱包+腰带2件套<font style="color:#f00">
</font></h1>
					...
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/images2012/market/wangyi1212/baobao.jpg" width="400" height="400" />
