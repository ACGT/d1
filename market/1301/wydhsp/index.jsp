			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/images2012/market/wangyi1212/shipin.jpg" width="400" height="400" />
...
function ShowAJaxdh(){
	...
	$.ajax({
		...
		cache: false,
		data: {gdsid:'01512568',cardno:cardno},
		error: function(XmlHttpRequest){
