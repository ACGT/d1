...
//获取所有参与兑换的商品
List<DhGdsM> dhgdsmList = getdhgdsmList("mq1301wy");
int lcount=0;
int contentcount=0;
...
<div align="center"><img src="http://images.d1.com.cn/market/1206/wydh/wydh120601.jpg" width="980" height="45"></div>	 
	    ...
	    <div class="goodsshow">
			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<h1>【Sheromo 诗若漫】休闲保暖短款圆摆连帽羽绒棉服外套<font style="color:#f00">
</font></h1>
					...
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/images2012/market/wangyi1212/nvmianfu.jpg" width="400" height="400" />
  ...
  <tr>
  <td colspan="2"><p>&nbsp;</p><span style="color:#FC7C17;">第三步：</span>输入兑换码，放入购物车</td>
  </tr>
  <tr>
