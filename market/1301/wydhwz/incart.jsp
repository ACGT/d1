...
memo="03000117,03000118,03000119,03000120,03000121,03000122,03000123,03000124,03000125,03000088,03000089,03000090,03000091,03000092,03000093,03000094,03000095,03000096,"+memo;
	...
	float ftuanprice=-1;
	if("01517474".equals(gdsid)){
		ftuanprice=49;
	}else if("01517367".equals(gdsid)){
		ftuanprice=29;
	}else if("01720843".equals(gdsid)){
		ftuanprice=29;
	}else if("01721266".equals(gdsid)){
		ftuanprice=25;
	}else if("03000317".equals(gdsid)){
		ftuanprice=98;
	}else if("02001017".equals(gdsid)){
		ftuanprice=98;
	}else if("02001016".equals(gdsid)){
		ftuanprice=98;
	}else if("02001015".equals(gdsid)){
		ftuanprice=98;
	}else if("01512568".equals(gdsid)){
		ftuanprice=98;
	}else if("03300077".equals(gdsid)){
		ftuanprice=99;
	}else if("03300076".equals(gdsid)){
		ftuanprice=99;
	}else if("03000125".equals(gdsid) || "03000124".equals(gdsid) || "03000123".equals(gdsid) || "03000122".equals(gdsid) || "03000121".equals(gdsid) || "03000120".equals(gdsid) || "03000119".equals(gdsid) ||  "03000118".equals(gdsid) || "03000117".equals(gdsid)){
		ftuanprice=69;
	}else if("03000088".equals(gdsid) || "03000089".equals(gdsid) || "03000090".equals(gdsid) || "03000091".equals(gdsid) || "03000092".equals(gdsid) || "03000093".equals(gdsid) || "03000094".equals(gdsid) ||  "03000095".equals(gdsid) || "03000096".equals(gdsid)){
		ftuanprice=69;
	}
	if(ftuanprice<0){
		out.print("{\"code\":1,message:\"此兑换码错误！\"}");
