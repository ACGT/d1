...
<title>【FEEL MIND】FM男装经典款全棉V领长袖T恤（5色，刺绣LOGO款）</title>
<meta name="keywords" content="【FEEL MIND】FM男装经典款全棉V领长袖T恤（5色，刺绣LOGO款）" />
<meta name="description" content="优尚网热卖产品【FEEL MIND】FM男装经典款全棉V领长袖T恤（5色，刺绣LOGO款），在这你可以看到【FEEL MIND】FM男装经典款全棉V领长袖T恤（5色，刺绣LOGO款）怎么样，让您买的放心，用的开心。" />
			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/market/1303/wydh/03200047_400_9.jpg" width="400" height="400" />
					...
					<!-- 商品展示结束-->
				     ...
				     <div class="gs_right_spContent">
                         ...
                         <tr height="40">
							 ...
							 <table width="333" height="50" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="15%"><input type="checkbox" name="giftgds" id="giftgds" value="01719213" onclick= "cbclick(this); "/></td>
        <td width="16%"><a href="http://www.d1.com.cn/product/01719213" target="_blank"><img src="http://images.d1.com.cn/shopadmin/d1gdsimg/2011/10/017002/01719213_s_4.jpg" width="80" height="80" border="0" /></a></td>
        <td width="69%">

        <font color="#FF0000" size="+1"><b>+59元</b></font>获得原价<font color="#FF0000" size="+1"><b>168元</b></font>【骏皇】男士二层皮商务休闲短版横款钱包（咖色）</td>
      </tr>
    </table></td>
  </tr>
  ...
  <tr>
    ...
    <div style="float:left;padding-left:10px;height:26px;_height:24px;padding-bottom:11px;"> <input type="text" style="width:180px" name="cardno" id="cardno" style="border:none;"/></div>
							  ...
							  <div class="frgwc_div" id="frgwc" style="display:none;">
								...
								<li>
									...
									<div style="height:80px;"> <font style="_font-size:12px; "><b>
                                        <div id="spname1" style="font-weight:bold;padding-bottom:10px;"> <%=gdsname %></div></b></font>
									<br/><br/>
				...
				<div  class="zh_title"><a href="###" class="newa">网易独享</a></div>
					<div class="clear"></div>
				 <div><%
		request.setAttribute("reccode","8026");
...
function ShowAJaxdh(){
	...
	$.ajax({
		...
		url: 'incart.jsp',
		cache: false,
		data: {gdsid:'03200047',cardno:cardno,skuId:sku2,giftgds:giftgds,zpsku:zpsku},
		error: function(XmlHttpRequest){
