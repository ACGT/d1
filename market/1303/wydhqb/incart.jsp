...
if(strgdsdh_code!=null&&!strgdsdh_code.startsWith("mqwyjfd1303qb")&&!strgdsdh_code.startsWith("mqwyjfd1304qbpl")
&&!strgdsdh_code.startsWith("mqwyjfd1304spcs")){
...
if(Tools.isNull(memo)){
	...
	if (!Tools.isNull(strgdsdh_giftgds)&&strgdsdh_giftgds.equals("03200053")){
