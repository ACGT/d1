...
if(!Tools.isNull(product.getGdsmst_skuname1())){
    ...
    if(skuList != null && !skuList.isEmpty()){
    	int size = skuList.size();
    		...
    		sb.append("<p><span style=\"color:#FC7C17;\">第二步</span>选择尺寸：<font id=\"sizecount\">未选择</font>");
    		 ...
    		 if(list!=null&&list.size()>0 || (product.getGdsmst_sizeid()!=null && product.getGdsmst_sizeid()>0))
    		   {
    			  ...
    			  sb.append("<font id=\"ccdzb\" style=\" color:#020399;padding-left:15px; cursor:hand;\" onmouseover=\"ccdzb()\" onmouseout=\"ccdzb1()\">(尺寸对照表)</font></p>");
    			  sb.append("<div id=\"ccdzb_img\" style=\"position:absolute;display:none;clear:both; ");
    			  if(!Tools.isNull(sizeinfo)) {
    				  sb.append("  border:1px solid black;background-color:#ffffff" );
    			  }
    			  sb.append(" \"  onmouseover=\"ccdzb()\" onmouseout=\"ccdzb1()\">");
    		     if(!Tools.isNull(sizeinfo)){
    		    	 sb.append(sizeinfo);
			    	  }else{
