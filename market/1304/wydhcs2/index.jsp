...
//获取所有参与兑换的商品
List<DhGdsM> dhgdsmList = getdhgdsmList("mqwyjfc1304cs");
int lcount=0;
int contentcount=0;
...
.spgg1 .skuname1 ul{width:325px;overflow:hidden;_zoom:1;margin-bottom:5px;_margin-bottom:5px;*margin-bottom:5px;}
	    ...
	    <div class="goodsshow">
			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<h1>【FEEL MIND】FM男装格仔夏日迷情系列纯棉短袖衬衫
					</h1>
					</div>
					<hr class="newhr"/>
					<!-- 商品展示-->
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/zt2013/04/400.2.jpg" width="400" height="400" />
     ...
     String selectgdsid = "";
									   ...
									   // if(!Tools.isNull(skuname1)){
										    ...
										    if(skuList != null && !skuList.isEmpty()){
										    	...
										    	<p><span style="color:#FC7C17;">第二步</span>选择尺寸：<font id="sizecount"><%=size==1?skuList.get(0).getSkumst_sku1():"未选择" %></font>
										    		 ...
										    		 if(list!=null&&list.size()>0 || (product.getGdsmst_sizeid()!=null && product.getGdsmst_sizeid()>0))
										    		   {
										    		    ...
										    		    %>
										    			  	<font id="ccdzb" style=" color:#020399; cursor:hand;padding-left:15px;" onmouseover="ccdzb()" onmouseout="ccdzb1()">(尺寸对照表)</font> </p>
					...
					<span style="display:none">
					 <div class="goods_info">
					   <div class="goods_content_list">
							<img src="http://images.d1.com.cn/images2012/market/wangyi/wydhbase.jpg"></img>
						</div>
						...
						<div class="goods_content goods_info_con">
						 ...
						 <!--  <tr><td><b><font style="color:#333">粉色款7月10日第一批补货已全部发出！S/XL全部售空，M和L还有少量库存；<br/>7月18日第二批补货预计到货，喜欢粉色款的用户请尽快预订，货到后我们会根据下单顺序及时发货。
</font></b></td></tr>-->
<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1206/wydh/fm9stx3_01.jpg" width="750" height="138" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1206/wydh/fm9stx3_02.jpg" width="750" height="209" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1206/wydh/fm9stx3_03.jpg" width="750" height="200" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/images2012/market/wangyi/fm9stx3_04[1].jpg" width="750" height="307" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1206/wydh/fm9stx3_05.jpg" width="750" height="242" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1206/wydh/fm9stx3_06.jpg" width="750" height="224" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1206/wydh/fm9stx3_07.jpg" width="750" height="242" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1206/wydh/fm9stx3_08.jpg" width="750" height="322" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1206/wydh/fm9stx3_09.jpg" width="750" height="287" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1206/wydh/fm9stx3_10.jpg" width="750" height="309" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1206/wydh/fm9stx3_11.jpg" width="750" height="244" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1206/wydh/fm9stx3_12.jpg" width="750" height="172" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1206/wydh/fm9stx3_13.jpg" width="750" height="355" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1206/wydh/fm9stx3_14.jpg" width="750" height="364" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1206/wydh/fm9stx3_15.jpg" width="750" height="278" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1206/wydh/fm9stx3_16.jpg" width="750" height="329" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1206/wydh/fm9stx3_17.jpg" width="750" height="235" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1206/wydh/fm9stx3_18.jpg" width="750" height="301" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1206/wydh/fm9stx3_19.jpg" width="750" height="163" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1206/wydh/fm9stx3_20.jpg" width="750" height="254" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1206/wydh/fm9stx3_21.jpg" width="750" height="386" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1206/wydh/fm9stx3_22.jpg" width="750" height="259" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/market/1206/wydh/fm9stx3