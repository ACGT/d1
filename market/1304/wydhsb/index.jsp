			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/market/1304/shoub.jpg" width="400" height="400" />
							  ...
							  <div class="frgwc_div" id="frgwc" style="display:none;">
								...
								<li>
									...
									<br/><br/>
									    ...
									    总计金额:￥<font id="countgdsmst3">159</font><br/>
									</div>
...
function ShowAJaxdh(){
	...
	$.ajax({
		...
		url: 'wydhInCart.jsp',
		cache: false,
		data: {gdsid:'01516150',cardno:cardno,skuId:sku2},
