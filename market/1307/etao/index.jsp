...
//获取所有参与兑换的商品
List<DhGdsM> dhgdsmList = getdhgdsmList("mqyt1307b");
int lcount=0;
int contentcount=0;
...
<meta name="description" content="优尚网热卖产品<%=gname %>，在这你可以看到<%=gname %>的图片、评价、价格以及用户对他的使用感受，告诉你【FEEL MIND】男装夏日必备款V领纯棉短袖T恤怎么样，让您买的放心，用的开心。" />
...
<div id="center">
	    ...
	    <div class="goodsshow">
			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<h1>CASIO 卡西欧EDIFICE系列指针男表EF-316D-1A
					</h1>
					</div>
					<hr class="newhr"/>
					<!-- 商品展示-->
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/market/1307/etao/400X400.jpg" width="400" height="400" />
  ...
  <tr>
    ...
    <div style="float:left;padding-left:10px;height:26px;_height:24px;padding-bottom:11px;"> <input type="text" style="width:210px" name="cardno" id="cardno" style="border:none;"/></div>    </td>
  </tr>
</table></td></tr>
							  ...
							  <div class="frgwc_div" id="frgwc" style="display:none;">
								...
								<li>
									...
									<br/><br/>
									    ...
									    总计金额:￥<font id="countgdsmst3">299</font><br/>
									</div>
