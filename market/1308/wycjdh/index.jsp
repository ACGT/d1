...
//获取所有参与兑换的商品
List<DhGdsM> dhgdsmList = getdhgdsmList("mqwycj1309nt");
int lcount=0;
int contentcount=0;
...
<title>【AleeiShe 小栗舍】精致柔美修身蕾丝领T恤</title>
<meta name="keywords" content="【AleeiShe 小栗舍】精致柔美修身蕾丝领T恤" />
<meta name="description" content="优尚网热卖产品【AleeiShe 小栗舍】精致柔美修身蕾丝领T恤，在这你可以看到【FEEL MIND】FM装翻边款牛仔短裤的图片、评价、价格以及用户对他的使用感受，告诉你【FEEL MIND】男装夏日必备款V领纯棉短袖T恤怎么样，让您买的放心，用的开心。" />
	    ...
	    <div class="goodsshow">
			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<h1>【AleeiShe 小栗舍】精致柔美修身蕾丝领T恤
					</h1>
					</div>
					<hr class="newhr"/>
					<!-- 商品展示-->
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/market/1308/wydh/wycj0829.jpg" width="400" height="400" />
