...
<div id="center">
	    ...
	    <div class="goodsshow">
			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<h1><%=gdsname %>(此商品一个兑换码仅限两个)
					</h1>
					</div>
					<hr class="newhr"/>
					<!-- 商品展示-->
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/market/1311/wydhny/11110.jpg" width="400" height="400" />
      ...
      String selectgdsid = "";
									   ...
									   // if(!Tools.isNull(skuname1)){
										    ...
										    if(skuList != null && !skuList.isEmpty()){
										    	...
										    	<p><span style="color:#FC7C17;">第一步</span>选择尺寸：<font id="sizecount"><%=size==1?skuList.get(0).getSkumst_sku1():"未选择" %></font>
    ...
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="15%"><input type="checkbox" name="giftgds" id="giftgds" value="02002019"  onclick= "cbclick(this); "/></td>
        <td width="16%"><a href="http://www.d1.com.cn/product/02002019" target="_blank"><img src="http://images.d1.com.cn/shopadmin/d1gdsimg/2013/09/02/02002019_s_0.jpg" width="80" height="80" border="0" /></a></td>
        <td width="69%">
        
        <font color="#FF0000" size="+1"><b>+25元</b></font>获得市场价<font color="#FF0000" size="+1"><b>239元</b></font>【D1推荐】再生纤维女士无缝美体保暖内衣套装</td>
       </tr>
    </table></td>
  </tr>
...
<td colspan="2">
      ...
      String selectgdsid2 = "";
									    	...
									    	//}
									    	//System.out.println(showsku);
										    List<Sku> skuList2 = SkuHelper.getSkuListViaProductIdO(id,showsku);
										     
										    if(skuList2 != null && !skuList2.isEmpty() && product!=null){
  ...
  <tr>
    ...
    <div style="float:left;padding-left:10px;height:26px;_height:24px;padding-bottom:11px;"> <input type="text" style="width:180px" name="cardno" id="cardno" style="border:none;"/></div>    </td>
				...
				<div class="clear"></div>
					...
					<div class="clear"></div>
				 <div><%
		request.setAttribute("reccode","9120");
