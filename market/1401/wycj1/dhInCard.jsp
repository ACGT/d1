...
if(strgdsdh_code!=null&&!strgdsdh_code.startsWith("mqwy131227yd")&&!strgdsdh_code.startsWith("mqwy140115zjb")){
...
if(false && t==0){
	...
	float ftuanprice=0;
	String strgdsidOne="";
	if("03300029".equals(strgdsid)){
    	ftuanprice=0;
    }else if("01205356".equals(strgdsid)){
    	ftuanprice=0;
    }
