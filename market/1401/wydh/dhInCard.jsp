...
if(strgdsdh_code!=null&&!strgdsdh_code.startsWith("mqwy131227oyd")){
...
if(twogdsid.indexOf(strgdsid)==-1){
	out.print("{\"code\":1,message:\"商品编码错误！\"}");
	return;
}
...
if(false && t==0){
	...
	if(cartList!=null){
		for(Cart c123:cartList){
			if(c123.getType().longValue()==13&&c123.getTuanCode().startsWith("mqwy131227oyd")){
				hasOne = true ;
				break;
			}
		}
