...
private static String getrec(String code,int len){
	...
	for(int i=0;i<list.size();i++){
		...
		if(!p.getGdsmst_rackcode().startsWith("014")
				||p.getId().equals("01414561")||p.getId().equals("01403841")){
		...
		String gdsimglfag="http://images.d1.com.cn/zt2014/0121qc/temai001.png";
		if(p.getGdsmst_validflag().longValue()!=1){
			gdsimglfag="http://images.d1.com.cn/zt2014/0121qc/sold_end.png";
		}
	...
	if(p.getGdsmst_validflag().longValue()!=1){
		...
		if(!p.getGdsmst_rackcode().startsWith("014")||p.getId().equals("01414561")||p.getId().equals("01403841")){
...
.qcbanner2{
	margin:10px auto;
	background-image: url(http://images.d1.com.cn/zt2014/0121qc/sale2.jpg);
	height:600px;
	background-position: center;
}
.tktcardno{}
...
<div class="qccontent">
<div class="qcgdslist">
<img src="http://images.d1.com.cn/zt2014/0121qc/hbhtg.jpg" />
<ul>
<%=getrec("9175",80) %>
<div class="clear"></div>
</ul>
