         ...
         SimpleDateFormat hourfmt = new SimpleDateFormat("hh时");
      	for(SgGdsDtl sg:sglist1){
            ...
            long gdsnum2=sg.getSggdsdtl_maxnum().longValue()-sg.getSggdsdtl_realbuynum() .longValue();
             ...
             sb.append("<tr><td height=\"310\" colspan=\"5\"><a href=\"http://www.d1.com.cn/product/").append(gdsid).append("\" target=\"_blank\"><img src=\"http://images1.d1.com.cn").append(sg.getSggdsdtl_imgurl()).append("\" height=\"310\" width=\"310\" border=\"0\"></a></td></tr>");
	...
	Collections.sort(list,new GdsMsTimeComparator());
      if(list!=null&&list.size()>0){
          ...
          for (Product product:list){
             ...
             sb.append("<li>");
             sb.append("<table width=\"310\" height=\"450\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">");
             sb.append("<tr><td height=\"310\" colspan=\"5\"><a href=\"http://www.d1.com.cn/product/").append(gdsid).append("\" target=\"_blank\"><img src=\"http://images1.d1.com.cn").append(sg.getSggdsdtl_imgurl()).append("\" border=\"0\" width=\"310\" height=\"310\"></a></td></tr>");
             sb.append("<tr><td colspan=\"5\" bgcolor=\"#e2e2e2\"><table><tr><td height=\"30\">&nbsp;</td>");
             sb.append("<td height=\"30\"><a href=\"http://www.d1.com.cn/product/").append(gdsid).append("\" target=\"_blank\" title=\"").append(sg.getSggdsdtl_gdsname()).append("\" class=\"title\">").append(gdstitle).append("</a></td>");
             sb.append("<td height=\"30\">&nbsp;</td> </tr>");
             sb.append("<tr><td height=\"30\">&nbsp;</td>");
...
<%if(Tools.isNull(request.getParameter("s"))){ %>
<!-- 头部开始 -->
...
<center>
<div><img src="http://images.d1.com.cn/zt2014/miaosha/mk980-366.jpg" width="980" height="366" border="0" usemap="#Mapmiaosha" />
<map name="Mapmiaosha" id="Mapmiaosha">
  <area shape="rect" coords="4,2,521,367" href="http://www.d1.com.cn/product/04000945?tj=mqjs1401" target="_blank" />
  <area shape="rect" coords="528,6,978,362" href="http://www.d1.com.cn/product/04000946?tj=mqjs1401" target="_blank" />
</map></div>
...
<table width="980" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <table width="845" height="310" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="310">
<a href="http://www.d1.com.cn/product/<%=gdsid %>" target="_blank"><img src="http://images1.d1.com.cn<%=sg.getSggdsdtl_imgurl() %>" height="310" width="310" border="0"></a>
</td>
        <td width="10">&nbsp;</td>
...
<%}
  ...
  <div class="msbody  msbody-con" id="msbody2">
