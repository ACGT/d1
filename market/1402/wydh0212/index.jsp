...
<div align="center"><img src="http://images.d1.com.cn/market/1206/wydh/wydh120601.jpg" width="980" height="45"></div>	 
			...
			<div class="gs_right">
			    ...
			    <div class="goods_new" style="width:770px;">
					...
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/market/1402/wydh0212.jpg" width="400" height="400" />
    ...
    <td colspan="2"><table  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="15%"><input type="checkbox" name="giftgds" id="giftgds" value="01205427"  onclick= "cbclick(this); "/></td>
        <td width="16%"><a href="http://www.d1.com.cn/product/01205427" target="_blank"><img src="http://images1.d1.com.cn/shopimg/gdsimg/2014/01/21/01205427_1_80.jpg" width="80" height="80" border="0" /></a></td>
        <td width="69%">
        
        <font color="#FF0000" size="+1"><b>+29元</b></font>获得市场价<font color="#FF0000" size="+1"><b>159元</b></font>【半球】电热水壶 2.0L不锈钢电水壶 正品不锈钢内盖烧水壶</td>
       </tr>
    </table></td>
  </tr>
...
<td colspan="2">
      ...
      String selectgdsid2 = "";
									    	...
									    	//}
									    	//System.out.println(showsku);
										    List<Sku> skuList2 = SkuHelper.getSkuListViaProductIdO("01205427",showsku);
										    Product zpgoods = ProductHelper.getById("01205427");
										    if(skuList2 != null && !skuList2.isEmpty() && product!=null){
										    	...
										    	<p>选择尺寸：<font id="sizecount3"><%=size==1?skuList2.get(0).getSkumst_sku1():"未选择" %></font>
										    	  ...
										    	  <%  ArrayList<GdsAtt> list=GdsAttHelper.getGdsAttByGdsid("01205427");
										    		 if(list!=null&&list.size()>0 || (zpgoods.getGdsmst_sizeid()!=null && zpgoods.getGdsmst_sizeid()>0))
										    		   {
										    			   String sizeinfo="";
											    		   if(zpgoods.getGdsmst_sizeid()!=null && zpgoods.getGdsmst_sizeid()>0){
											    			   sizeinfo= getsizeinfo(zpgoods);
											    		   }
							...
							//if(ifhavegds == 0){
							 ...
							 %><a href="javascript:void(0)" onclick="ShowAJaxdh()"><img src="/res/images/product/frgwc.jpg" /></a>
							  <div class="frgwc_div" id="frgwc" style="display:none;">
								...
								<ul>
								<li>
								    <img src="http://images1.d1.com.cn<%=product.getGdsmst_smallimg() %>" id="cardimg" width="80" height="80" />
					...
					<span style="display:none">
					 <div class="goods_info">
					   ...
					   <%
						...
						<a href="http://www.d1.com.cn/market/1402/miaosha/" target="_blank"><img src="http://images.d1.com.cn/market/1403/750-300.jpg" /></a>
...
function ShowAJaxdh(){
	...
	$.ajax({
		...
		url: 'wydhInCart.jsp',
		cache: false,
		data: {gdsid:'01517877',cardno:cardno,skuId:sku2,giftgds:giftgds,zpsku:zpsku},
