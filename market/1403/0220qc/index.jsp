...
.qcbanner{
	margin:0px auto;
	background-image: url(http://images.d1.com.cn/zt2014/0220qc/cztm_001-2.jpg);
	height:449px;
...
.qcbanner2{
	margin:10px auto;
	background-image: url(http://images.d1.com.cn/zt2014/0220qc/cztm_001_2.jpg);
	height:449px;
	background-position: center;
}

.topbannerdiv{	position:relative; width:980px; height:150px; margin: 0px auto;padding-top:300px;}
.link1{ position:absolute;  width:310px; height:150px; bottom:0; left:370px; }
</style>
<%
