...
private static int Exits(String mbrid,String gdsid)
{
	int result=0;
     ...
     List<SimpleExpression> clist = new ArrayList<SimpleExpression>();
     clist.add(Restrictions.ge("gdsbuyonedtl_mstid",new Long(150)));
     clist.add(Restrictions.le("gdsbuyonedtl_mstid",new Long(152)));
...
long mstid=0;
if(gdsid.equals("04000911")){
 	mstid=150;
 }else if(gdsid.equals("01205480")){
 	mstid=151;
 }else if(gdsid.equals("01205490")){
 	mstid=152;
 }
...
Date now=new Date();
String end="2014-04-16 00:00:00";
...
if (lUser.getMbrmst_finishdate() !=null){
		out.print("{\"code\":1,\"message\":\"只有新客才可以抢购！\"}");
		return;
...
cart.setTitle("【店庆0元抢】"+product.getGdsmst_gdsname());
