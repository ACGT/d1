	   ...
	   if(gList != null && !gList.isEmpty()){
		   for(Product pp:gList){
			   ...
			   sb.append("<li style=\"height:"+hg+"px;\">");
				...
				sb.append("</tr>");
				sb.append("    <tr>");
				sb.append("      <td width=\"3\" bgcolor=\"#6ebd2e\"></td>");
				sb.append("      <td width=\"98\" bgcolor=\"#6ebd2e\"><span  class=\"qcgdst\">").append(memtxt).append("</span><br />");
				sb.append("      <span class=\"qcgdsp2\"><s>").append(memtxt2).append("：").append(oldmemprice).append("</s></span>");
				sb.append("      </td>");
				sb.append("      <td width=\"76\" align=\"center\" bgcolor=\"#6ebd2e\" valign=\"top\"  class=\"qcgdsp\">").append(memprice).append("</td>");
				sb.append("      <td width=\"60\" align=\"center\" bgcolor=\"#6ebd2e\">");
				sb.append("<a href=\"http://www.d1.com.cn/product/").append(gdsid).append("\" title=\"").append(imgalt).append("\" target=\"_blank\">");
				sb.append("<img src=\"http://images.d1.com.cn/zt2014/0220qc/tm002.jpg\" width=\"60\" height=\"60\" /></a></td>");
				sb.append("      <td width=\"3\" bgcolor=\"#6ebd2e\"></td>");
				sb.append("    </tr>");
				sb.append("  </table>");
				sb.append("</li>");
