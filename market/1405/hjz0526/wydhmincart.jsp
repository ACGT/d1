...
if(strgdsdh_code!=null&&!strgdsdh_code.startsWith("mq139yj140523a")&&!strgdsdh_code.startsWith("mq139yjyj1406")){
...
//赠品
if (!Tools.isNull(strgdsdh_giftgds)&&strgdsdh_giftgds.equals("01516824")&& Tools.isNull(zpsku)){
...
//}else{
	...
	if(!"01205397".equals(tuandh.getTuandh_gdsid().trim())){
	...
	*/
	...
	/*加39元包邮可以获得原价59元的 01417359  5合1电动洁面仪深层毛孔清洁/洁面按摩套装

 
加49元包邮可以获得原价199元的 01516824  【YOUSOO】一款三戴爱心の守候水晶项链 
 
加69元包邮可以获得原价99元的 03300070  【FEEL MIND】男士菱形压花纹高级牛皮多卡位钱包皮夹（黑色）
 
加79元包邮可以获得原价129元的 01517687  【YOUSOO】情侣款 陈法拉带锁情侣钥匙 爱心锁手环配项链
	...
	*/
	if (!Tools.isNull(strgdsdh_giftgds)){
		...
		String shopcode="00000000";
         if(strgdsdh_giftgds.equals("01417359")){
        	 ftuanprice2=39f;
        	 gdstitle="5合1电动洁面仪深层毛孔清洁/洁面按摩套装";
         }else  if(strgdsdh_giftgds.equals("01516824")){
        	 ftuanprice2=49f;
        	 gdstitle="【YOUSOO】一款三戴爱心の守候水晶项链";
         }else  if(strgdsdh_giftgds.equals("03300070")){
        	 ftuanprice2=69f;
        	 gdstitle="【FEEL MIND】男士菱形压花纹高级牛皮多卡位钱包皮夹";
         }else  if(strgdsdh_giftgds.equals("01517687")){
        	 ftuanprice2=79f;
        	 gdstitle="【YOUSOO】情侣款 陈法拉带锁情侣钥匙 爱心锁手环配项链";
         }
		...
		String pname="【点指国际】办公室U型护颈枕 脖子记忆棉枕头 可爱太空U形枕午睡枕午休枕颈椎（"+color+"）";
