...
<div id="center">
			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<div class="gs_right_spimg">
							<img src="http://images.d1.com.cn/market/1405/sbd0522.jpg" width="400" height="400" />
										    		...
										    		for(int i=0;i<size;i++){
										    			...
										    			if(product.getGdsmst_stocklinkty()!=null&&(product.getGdsmst_stocklinkty().longValue()==1||product.getGdsmst_stocklinkty().longValue()==2)){
										    				if(CartItemHelper.getProductOccupyStock(product.getId(), sku.getId())<ProductHelper.getVirtualStock(product.getId(), sku.getId())){
											    				%><li<%if(size==1){ %> class="select"<%} %>><a href="javascript:void(0);" title="<%=skuname %>" attr="<%=sku.getId() %>" onclick="chooseskuname1(this)" hidefocus="true"<%if(size==1){ %> class="current"<%} %>><img  height=80 width=65 src="http://images.d1.com.cn/market/1405/<%=id %>_<%=sku.getId().trim()%>.jpg " />
										    		</a>
										    		<br/><br/><br/><%=skuname%></li><%
										    				}
										    				else
										    				{
										    					if(sku.getSkumst_vstock().longValue()==0){ %>
										    						<li><a href="javascript:void(0);" title="售罄"   hidefocus="true"  style="height:21px;line-height:21px;padding:0 9px;border:1px solid #dcdddd;background:#fff;color:#dcdddd;text-decoration:none;"><img  height=80 width=65 src="http://images.d1.com.cn/market/1405/<%=id %>_<%=sku.getId().trim()%>.jpg " />
										    		</a>
										    		<br/><br/><br/><%=skuname%></li>
										    					<%}
										    					else
   ...
   <tr> <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="15%"><input type="radio" name="giftgds" id="giftgds" value="02103359" onclick= "cbclick(this); "/></td>
        <td width="16%"><a href="http://www.d1.com.cn/product/02103359" target="_blank"><img src="http://images.d1.com.cn/shopadmin/d1gdsimg/2014/03/02/02103359_s_7.jpg" width="80" height="80" border="0" /></a></td>
        <td width="69%">

        <font color="#FF0000" size="+1"><b>+29元包邮</b></font>获得原价<font color="#FF0000" size="+1"><b>39元</b></font>【红门鞋业】夏季新款人字拖鞋波西米亚风格</td>
      </tr>
    </table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="15%"><input type="radio" name="giftgds" id="giftgds" value="01517871" onclick= "cbclick(this); "/></td>
        <td width="16%"><a href="http://www.d1.com.cn/product/01517871" target="_blank"><img src="http://images.d1.com.cn/shopadmin/d1gdsimg/2013/11/015/01517871_s_11.jpg" width="80" height="80" border="0" /></a></td>
        <td width="69%">

        <font color="#FF0000" size="+1"><b>+39元包邮</b></font>获得原价<font color="#FF0000" size="+1"><b>59元</b></font>NARY 耐瑞 时尚情侣简约手表</td>
      </tr>
    </table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="15%"><input type="radio" name="giftgds" id="giftgds" value="01519320" onclick= "cbclick(this); "/></td>
        <td width="16%"><a href="http://www.d1.com.cn/product/01519320" target="_blank"><img src="http://images1.d1.com.cn/shopimg/gdsimg/2014/05/07/01519320_1_80.jpg" width="80" height="80" border="0" /></a></td>
        <td width="69%">

        <font color="#FF0000" size="+1"><b>+49元包邮</b></font>获得原价<font color="#FF0000" size="+1"><b>59元</b></font>【香港集福轩】天然西瓜晶/碧玺108颗*6mm佛珠手链 +六字真言</td>
      </tr>
    </table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="15%"><input type="radio" name="giftgds" id="giftgds" value="01519290" onclick= "cbclick(this); "/></td>
        <td width="16%"><a href="http://www.d1.com.cn/product/01519290" target="_blank"><img src="http://images1.d1.com.cn/shopimg/gdsimg/2014/04/29/01519290_1_80.jpg" width="80" height="80" border="0" /></a></td>
        <td width="69%">

        <font color="#FF0000" size="+1"><b>+69元包邮</b></font>获得原价<font color="#FF0000" size="+1"><b>99元</b></font>【YOUSOO】景泰蓝手镯韩版镂空珐琅镀金手镯(彩色)</td>
      </tr>
    </table>
    </td>
  </tr>
...
function ShowAJaxdh(){
	...
	var giftgds= $("input[name='giftgds']:checked").val(); 
	...
	$.ajax({
		...
		url: 'wydhmincart.jsp',
		cache: false,
		data: {gdsid:'01205775',cardno:cardno,skuId:sku2,giftgds:giftgds,zpsku:zpsku},
