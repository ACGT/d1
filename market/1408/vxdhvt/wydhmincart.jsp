...
if(strgdsdh_code!=null&&!strgdsdh_code.startsWith("whb1407")){
...
//}else{
	...
	String gdslist="03000386,03000387,03000388,03000389,03000390";
	...
	if(cartList!=null){
		for(Cart c123:cartList){
			if(c123.getType().longValue()==13&&gdslist.indexOf(c123.getProductId())>=0){
				hasOne = true ;
				break;
			}
		}
