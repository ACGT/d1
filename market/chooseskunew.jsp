...
<style type="text/css">
ul li{float:left;}
.gdsurl a{float:left;width:65px;display:block;color:#1A0096}
</style>
...
if(!Tools.isNull(code))code=code.trim();
String gdsarrstr="";
String selectgdsid = "";
...
<div id="skuname2" class="skuname1" style="margin-bottom:0px;padding-bottom:0px;">
			 	...
			 	<ul><%
										    	...
										    	for(DhGdsM dhgds : dhgdsmList2){
										    		...
										    		<br/><br/><br/><%=dhgds.getDhgdsm_title()%><br>
										    		</li><%
										    		//}
										    		if (i==1){
										    	...
										    	<div class="gdsurl">
										    	<%
										      String[]	strgdsarr=gdsarrstr.split(",");
										    	for(int j=0;j<strgdsarr.length;j++) { %>
										    	<a href="/product/<%=strgdsarr[j] %>" target="_blank" style="">查看详情</a>
										    	<%} %>
										    	</div>
										    	</div>
...
<div id="skuname2" class="skuname1" style="margin-bottom:0px;padding-bottom:0px;">
			 	<p>选择商品：<font id="sizecount2"></font></p>
										    	...
										    	for(int i=0;i<strs.length;i++){
										    		...
										    		<br/><br/><br/><%=gg.getGdsgrpdtl_stdvalue()%><br/>
										    		<a href="/product/<%=gg.getGdsgrpdtl_gdsid().trim() %>" target="_blank" style="">查看详情</a>
										    		</li><%
