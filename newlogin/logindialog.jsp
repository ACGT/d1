...
<div class="dialogdiv">
  ...
  <tr>
  <td colspan="2"><img src="http://images.d1.com.cn/images2012/login/lotop1.jpg" border="0" usemap="#Map"/>
<map name="Map" id="Map"><area shape="rect" coords="76,1,147,23" href="/newlogin/register.jsp" /></map></td>
  </tr>
  <tr>
  <td colspan="2" height="10">
					 ...
					 <tr>
						 <td style=" text-align:right" width="80">用户名：</td><td style="text-align:left;"><input type="text" id="loginName" class="login_input" maxlength="255" tabindex="100" value="<%=username!=null?username:"" %>" /></td>
					 </tr>
					 <tr><td></td><td><span id="errUsername" class="spanmsg" style="display:none;width:160px;" >用户名/Email不能为空！</span></td></tr>
					 <tr><td colspan="2" height="8"></td></tr>
					 <tr>
						 <td style=" text-align:right" width="80">密码：</td><td style="text-align:left;"><input type="password" id="loginPwd" class="login_input" tabindex="101"  maxlength="14" />&nbsp;&nbsp;&nbsp;&nbsp;
					 ...
					 <tr><td></td><td><span id="errPassword" class="spanmsg"  style="display:none;">密码不能为空！</span></td></tr>
					  ...
					  <tr>
						 <td style=" text-align:right" width="80" >验证码：</td><td style="text-align:left;"> <span class="spanmsg2"><input type="text" name="code" class="login_input" id="code"  maxlength="4" style="width:80px;" onkeyup="key_up(this);"/>&nbsp;&nbsp;
					 ...
					 <tr><td  colspan="2" style=" text-align:center; "> <input class="layer_button login_t2 lll" type="button" onclick="javascript:AjaxLogin();" onmousemove="this.className='layer_button_over login_t2 lll'" onmouseout="this.className='layer_button login_t2 lll'" value="登 录" />
