    	...
    	$.ajax({
            ...
            data:{
            	...
            	//alert(strRet);
            	 ...
            	 else if(strRet==1){$.alert('保存成功！'); window.location.href="profile.jsp"}
			    ...
			    <tr>
				 ...
				 <tr>
					...
					%>
				     ...
				     <td  style="text-align:right;"><font color="#c93334">*</font>手机：</td><td><input type="text" id="txtRPhone" maxlength="11" value="<%=Tools.formatString(lUser.getMbrmst_mphone()) %>" onblur="CheckPhone()" onkeyup="this.value=this.value.replace(/[^\d]/g,'')" onafterpaste="this.value=this.value.replace(/[^\d]/g,'') " style="width:120px;" />
				      <%
				     ...
				     <%}else{
				    	 %>  
				    	 <span style="color:red;">&nbsp;&nbsp;如需更换绑定手机，请输入新手机号并验证</span>
				     <%}
				     %>
