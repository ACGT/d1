...
{
	bjprice=(int)(memberprice*0.88);
	vipprice=(int)(memberprice*0.95);
}
else
{
	bjprice=(int)(memberprice*0.95);	
	vipprice=(int)(memberprice*1);
}
	    ...
	    <div class="goodsshow">
			...
			<div class="gs_right">
			    ...
			    <div class="goods_new">
					...
					<%=gdsname %><br/>
					<a href="http://www.d1.com.cn/zhuanti/20130115qcqrj/qrj.jsp" target="_blank" style="color:#c00">全场购物满额赠巧克力、玫瑰花，详情见>></a>
					</h1>
				     ...
				     <div class="gs_right_spContent">
                         ...
                         <%
                              ...
                              else
                              {
                            	 ...
                            	 if(ismiaoshao||isdx||(tuanprice!= 0f&&Tools.floatCompare(tuanprice , oldmemberprice) != 0)||flagbjcp||(lUser!=null&&UserHelper.isPtVip(lUser))||(lUser!=null&&UserHelper.isVip(lUser))){
                            		 if((ismiaoshao&&(lUser==null||(lUser!=null&&!UserHelper.isPtVip(lUser)&&!UserHelper.isVip(lUser))))||(tuanprice!= 0f&&Tools.floatCompare(tuanprice , oldmemberprice) != 0)){
							    	 if(isdx&&!ismiaoshao)
							    	 {%>
							    		 <tr>
								        <td colspan="3" height="30">会员价：￥<%=Tools.getFormatMoney(memberprice) %></span></td>
							    	 ...
							    	 {
							    		 if(tuanprice!= 0f&&Tools.floatCompare(tuanprice , oldmemberprice) != 0&&lUser!=null&&UserHelper.isPtVip(lUser))
							    		 {%>
							    			 <tr>
								        <td colspan="3" height="30">会员价：￥<%=Tools.getFormatMoney(memberprice) %></span></td>
							          </tr>
	                            	 ...
	                            	 if(flagbjcp)
									 {
							    		 ...
							    		 %>
							    			 <tr>
								             <td colspan="3" >促销价：<span style="background-color: whiteSmoke;border: 1px solid #F0EDEC;border-bottom: 1px dotted #999;color: #999;height: 16px;line-height: 16px;margin: 6px 8px 0 0;padding: 0 3px;">活动价</span><span style="color: #C00000;font-size: 22px;font-family:'Arial';">￥<%=memberprice %></span></td>
							                 </tr> 
							    		 <%
							         }
                            	      else if(lUser!=null&&UserHelper.isPtVip(lUser)&&!isdx)
		                           	  {
		                           	  ...
		                           	  {
								        if(ismiaoshao||isdx||flagbjcp||(tuanprice!= 0f&&Tools.floatCompare(tuanprice , oldmemberprice) != 0)||(lUser!=null&&UserHelper.isVip(lUser)))
								        {
								    	//获取活动特价
										 if(isdx){
										 %><tr><td colspan="3"><%
											 ...
											 else
											 {
												 ...
												 else if(tuanprice!= 0f&&Tools.floatCompare(tuanprice , oldmemberprice) != 0)
												 {
											    //获取团购价
								    ...
								    if(!flagbjcp){
							             ...
							             <%if((lUser==null||!UserHelper.isPtVip(lUser))){
							            	 ...
							            	 {} 
			                                   ...
			                                   {%>
			                                	 <tr>
											    <td colspan="3" height="25">白金价：￥<%= bjprice %></td>
											 </tr>  
			                                   <%}
                         ...
                         %>
				             <tr> 
				             <td></td><td width="120"><a id="hyyhsmLink" href="javascript:void(0)">如何成为VIP/白金会员</a>
