...
if("post".equals(request.getMethod().toLowerCase()) && "regist".equals(act)){//注册
	...
	if(user != null && user.getId()!=null){
       ...
       /*  if (!Tools.isNull(strLtinfo)){
		...
		}else if(session.getAttribute("url")!=null&&session.getAttribute("url").toString().indexOf("zhuanti/201303/szn0307/")>0){
...
<table cellpadding="0" cellspacing="0" border="0">
     ...
     <div class="reg">
       ...
       <div class="reg1">
		   <div class="reg_main">
		   <form name="form_Regist" id="form_Regist" action="register.jsp?act=regist" method="post" onsubmit="return false;">
		   <table width="740">
