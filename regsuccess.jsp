...
<%//}} %>
   <div class="reg_suc">
   	   <div class="regsuc_top">
			  <span>恭喜您成为D1优尚注册会员！
			   <%if (session.getAttribute("url")!=null&&session.getAttribute("url").toString().indexOf("/html/zt2013/etkt0708")>0){ %>
			  <script type="text/javascript">
alert('优惠券已发到您的帐户中有效期1个月，购物结算时可直接使用！');
</script>
			  <br>30元服装券已经充到您的帐号，<a href="/user/ticket.jsp" target="_blank">查看我的优惠券</a>
			  <%} %>
			  </span>
		...
		<div style="clear:both;"></div>
		 ...
		 <table cellpadding="0" cellspacing="0" border="0" width="550px">
			...
			<tr><td align="center">
				<table cellpadding="0" cellspacing="0" border="0" >
				<tr><td valign="top"><span style="font-size:14px;" >手机号码：</span></td>
				...
				<div class="yztxt"><input name="yzcode" id="yzcode" placeholder="请输入右侧图片数字"  class="yzcode mgt10"  type="text" >
				...
				<td>&nbsp;&nbsp;<input type="button" value="获取短信验证码" style="border:1px #727272 solid;height:24px;" onclick="checktime(this)"/></td>
				</tr>
				<tr><td></td>
	...
	<li><a href="/user/profile.jsp" target="_blank"><img src="http://images.d1.com.cn/images2012/login/zc_25.jpg" border="0"/></a><br/>
...
_adwq.push(['_setAction', 
    '7dbuym',
    '<%=lUser.getId()%>',       // 扩展参数, 可填 用户名 或 用户ID(可选)
    '' // 事件价值 (可选)
   ]);
</script>
<!--亿玛DSP部署  -->
