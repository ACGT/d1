...
(function($) {
	...
	$.inCart.defaults = {
		...
		onComplete : function(obj,o,json){$.inCart.success(obj,o,json);} //when sucess then complete
	};
	$.inCart.doShopcatAction = function(o,obj,id,type,arrays){
		var options = {"id":id,"type":type,"count":o.gdscount};
	...
	$.inCart.shopcarAddItemCallBack = function(obj,o,json,skuId){
		switch(json.code){
			case 0://success
				if(o.showSuccWindow) $.inCart.success(obj,o,json);
				o.onComplete(obj,o,json);
				break;
			case 1://informat
				$.inCart.tips(obj,o,json);
				break;
			case 2://again
				$.inCart.again(obj,o,json,skuId);
				break;
			case 3://sku
				$.inCart.sku(obj,o,json);
				break;
			case 4://other sku
				$.inCart.moreSku(obj,o,json);
				break;
			default:
				$.inCart.tips(obj,o,{'message':'你要进行什么操作？'});
		}
	};
	$.inCart.moreSku = function(obj,o,json){
		try{
			...
			$('#bindBuy').click(function(){
				...
				//submit
				$.inCart.doShopcatAction(o,obj,$(obj).attr("attr"),1,{"skuId":skuId,"code":$(obj).attr('code')});
			});
			$.inCart.show(o,obj);
		}catch(e){
			if (typeof e === 'object'){
		...
		try{
			...
			<div class="cart_property_wrapper">\
				...
				<div class="block_options"'+(o.goodsType==1?' style="display:none;"':'')+'>\
					...
					<div class="option_list"><input tag="buyNum" value="'+o.gdscount+'" name="" type="text"> 件</div>\
				</div>\
	...
	$.inCart.success = function(obj,o,json){
	...
	$.inCart.again = function(obj,o,json,skuId){
		var template = '<div class="box_hint_normal">\
			<span class="icon msg2-icon-right"></span>\
			<div class="hint_content">\
		...
		$('#shopcar_b_cover').click(function(){
			$.inCart.doShopcatAction(o,obj,$(obj).attr("attr"),1,{"skuId":skuId});
		});
	...
	$.inCart.tips = function(obj,o,json){
		var template = '<div class="box_hint_normal">\
			<span class="icon msg2-icon-right"></span>\
			<div class="hint_content">\
