...
function ShowTuan() {
    $.ajax({
        type: "get",
        dataType: "html",
        url: "/ajax/html/getIndexTuan.jsp",
        cache: false,
        data: {},
        success: function(strHtml) {
            if (typeof strHtml != 'undefined') {
                $('#tuan').empty();
                $(strHtml).appendTo($('#tuan'));
            }
        },beforeSend: function() {},
        complete: function() {xsms2011('tuan');ShowXSTM();}
    });
};
// end function
...
function ShowXSTM() {
    $.ajax({
        type: "get",
        dataType: "html",
        url: "/ajax/html/getIndexXSTM.jsp",
        cache: false,
        data: {},
        success: function(strHtml) {
            if (typeof strHtml != 'undefined') {
                $('#xstm_2011919').empty();
                $(strHtml).appendTo($('#xstm_2011919'));
            }
        },beforeSend: function() {},
        complete: function() {xsms2011('xstm_2011919');}
    });
};
// end function