...
if(request.getAttribute("code")!=null && request.getAttribute("num")!=null){
	...
	int i=0;
			...
			%>
			 <table width="881" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor=white>
					  <tr><td height=3>
					  </td></tr>
		<tr>
		<%	for(PromotionProduct pProduct:list){
			...
			if(product!=null){
				directory=DirectoryHelper.getById(product.getGdsmst_rackcode());
			}
				if(directory!=null){
		...
		<font style="font-size:10pt"><%=Tools.substring(pProduct.getSpgdsrcm_gdsname(),100)%></font><br><br>
