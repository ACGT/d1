...
@Entity
@Table(name="gdsmst_result")
public class ProductResult extends BaseEntity implements java.io.Serializable {
	/**
	 * version id
	 */
	private static final long serialVersionUID = 1L;
	@Id
	@Column(name="gdsmst_result_id")
	private String id;
	...
	public void setGdsmst_weight(Float gdsmst_weight) {
		this.gdsmst_weight = gdsmst_weight;
	}
