...
public class UploadFileServlet extends HttpServlet {
	...
	private static String baseFileDir = File.separator + "shopimg/gdsimg" + File.separator;//上传文件存储目录
	//private static String baseFileDir = "/opt/shopimg/gdsimg/" + File.separator;//上传文件存储目录
	
	private static String baseURLDir = "/shopimg/gdsimg/";//上传文件目录URL
