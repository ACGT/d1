<%@ page contentType="text/html; charset=UTF-8" import="java.math.*"%>
  ...
  <%= si!=null&&!Tools.isNull(si.getShopinfo_floatcontent())?si.getShopinfo_floatcontent():"" %>
	...
	<div style="clear: both;"></div>
	  <div class="widauto" id="widauto">
		<div class="imgabs" id="imgabs">
	     <%= si.getShopinfo_bgimg() %>
		</div>
		<%
                        	    	        			...
                        	    	        			">
                        	    	        			 ...
                        	    	        			 >
                        	    	        			  ...
                        	    	        			  <tr>
                        	    	        			    ...
                        	    	        			    <a href="http://www.d1.com.cn/Product/<%= p.getId() %>" target="_blank" title="<%= p.getGdsmst_gdsname()%>">
                        	    	        			    <span style=" font-family: '微软雅黑'; font-size: 14px; line-height: 21px; padding-left: 36px;">
                        	    	        	...
                        	    	        	<%}else{%>
	                        	    	        	...
	                        	    	        	<%}
	                        	    	        		...
	                        	    	        		if(gdsidarr[m].indexOf("all")>0){//all代表读取所有的商品
	                        	    	        			pro_list=getProductList(gdsidarr[m].substring(0, 8),200);
	                        	    	        			...
	                        	    	        			list = PromotionProductHelper.getPProductByCode(gdsidarr[m],200);//取出推荐位表中的值
		                        	    	        			 ...
		                        	    	        			 <%}else{%>height="270"<%}%>>
																  <tr valign="middle">
		 												           ...
		 												           long endt=0;
		 												            ...
		 												            %>
																	<img src="http://images.d1.com.cn/zt2014/0110/clock.gif" style="vertical-align: middle;" width="21" height="21"/>&nbsp;<span style="vertical-align: middle;font-size: 11pt;font-family: '微软雅黑'; color: #606060;">剩余时间：<span id="pmstime<%=id%>" /></span></span>
																	 <script type="text/javascript">
		                        	    	        			...
		                        	    	        			">
		                        	    	        			 ...
		                        	    	        			 >
		                        	    	        			  ...
		                        	    	        			  <%if(sm.getShopmodel_size()==16){%>
		                        	    	        			   ...
		                        	    	        			   <td height="60" style="background: url('http://images.d1.com.cn/zt2014/0304/pricebg.gif') no-repeat;" >
		                        	    	        			   <%}%>
		                        	    	        			   <span style="color: #FFFFFF;font-size: 20px; padding-left: 6px;">￥<span style="font-size: 42px;"><%=booldx?dxprice:memprice%></span></span>
