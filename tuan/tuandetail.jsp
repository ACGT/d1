   ...
   <div id="wrapper">
    ...
    <%
     ...
     <%if (product.getTgrpmst_endtime().before(new Date()) || product.getTgrpmst_state().intValue()!=1){%>
		     <a href="tuandetail.jsp?ID=<%= product.getId() %>" target="_blank"><img src="http://images.d1.com.cn/Index/over.gif" /><span style=" font-size:30px; color:#fff; font-family:'微软雅黑'; position:absolute; margin-left:-230px; margin-top:10px;">￥<%=sprice %></span></a>
			 
			  <%}
		    else if (lastcount.intValue()<=10){
		    	%>
		    	 <a href="tuandetail.jsp?ID=<%= product.getId() %>" target="_blank"><img src="http://images.d1.com.cn/Index/end.gif" /><span style=" font-size:30px; color:#fff; font-family:'微软雅黑'; position:absolute; margin-left:-230px; margin-top:10px;">￥<%=sprice %></span></a>
		    ...
		    %>
		    	 <a href="###" attr="<%=product.getId() %>" onclick="addCart(this);"><img src="http://images.d1.com.cn/Index/buy.gif" /><span style=" font-size:30px; color:#fff; font-family:'微软雅黑'; position:absolute; margin-left:-230px; margin-top:10px;"><font style=" font-family:'微软雅黑';">￥</font><%=sprice %></span></a>
		   ...
		   <div class="left_content3">
		       <table>
			     <tr><td width="10"></td><td height="20" ></td></tr>
                 <tr><td></td>
				    <td style=" font-size:15px;">已经有<font color="#b51014" style="font-size:25px; padding-left:2px; padding-right:2px;"><%
				    if(product.getTgrpmst_gdsid().equals("01205254"))
				    {
							product.setTgrpmst_hotmodulus(product.getTgrpmst_hotmodulus().longValue()+10);
							Tools.getManager(ProductGroup.class).update(product, false);
						
				    }
				    out.print(product.getTgrpmst_hotmodulus());
				    %> </font>人购买</td>
				</tr>
				<tr><td></td><td height="2" ></td></tr>
                 <tr><td></td>
		...
		<%Product gdsmst=ProductHelper.getById(product.getTgrpmst_gdsid()) ;
		if (gdsmst.getGdsmst_rackcode()!=null&&gdsmst.getGdsmst_rackcode().length()>=3&&gdsmst.getGdsmst_rackcode().startsWith("014")){
		%>
		<div  style=" border:solid 1px #c2c2c2; margin-top:10px;">
		<table id="__01" width="650"  border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td>
			<img src="http://images.d1.com.cn/images2012/tuan/zpbz/tgzpbz_01.jpg" width="650" height="126" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/images2012/tuan/zpbz/tgzpbz_02.jpg" width="650" height="252" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/images2012/tuan/zpbz/tgzpbz_03.jpg" width="650" height="242" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/images2012/tuan/zpbz/tgzpbz_04.jpg" width="650" height="227" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/images2012/tuan/zpbz/tgzpbz_05.jpg" width="650" height="178" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/images2012/tuan/zpbz/tgzpbz_06.jpg" width="650" height="210" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/images2012/tuan/zpbz/tgzpbz_07.jpg" width="650" height="214" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="http://images.d1.com.cn/images2012/tuan/zpbz/tgzpbz_08.jpg" width="650" height="173" alt=""></td>
	</tr>
</table>
		</div>
		<%} %>
