    ...
    <%
      ...
      if(tgrpmst_id.trim().length()!=0){
    	...
    	// {
    		 ...
    		 ProductGroup product=(ProductGroup)Tools.getManager(ProductGroup.class).get(tgrpmst_id);
    		 if(product!=null)
    		 {
    	 ...
    	 <div class="left_sub1">
			...
			<div class="left_content">
		     ...
		     <a href="javascript:void(0)" target="_blank"><img src="http://images.d1.com.cn/Index/over.gif" /><span style=" font-size:30px; color:#fff; font-family:'微软雅黑'; position:absolute; margin-left:-230px; margin-top:10px;">￥<%=sprice %></span></a>
