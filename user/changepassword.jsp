	        ...
	        <table border="0" cellspacing="0" cellpadding="0" class="t_update">
			    ...
			    <tr>
				 ...
				 <tr>
				    ...
				    <td width="150" style="text-align:right;">我的旧密码：</td>
				    <td><input type="password" id="oldpassword" /></td><td>&nbsp;
				    &nbsp;<span id="oldpassword_notice" style="display:none;">原密码输入错误，请重新输入</span></td>
				 ...
				 <tr>
				    ...
				    <td style="text-align:right;">请再次输入新密码：</td><td><input type="password" name="password2" id="password2" onfocus="pass2_focus();" onblur="issame();" maxlength="14"/></td>
