...
<%!	/**
	 * 获取有效地积分换购信息
	 */
	public static ArrayList<Award> getAwardList(long s,long e,String shopcode){
		...
		clist.add(Restrictions.eq("award_shopcode", shopcode));
...
List<Award> awardlist=getAwardList(s,e,shopcode);
