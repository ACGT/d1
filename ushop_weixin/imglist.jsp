...
<body style="padding-left: 5px;">
	...
	<table>
		<tr>
			<td style="background: #f00; color: #fff;">&nbsp;<a
				href="/wap/goods.jsp?productid=<%= id %>" style="color: #fff;"><b>简介</b></a>&nbsp;|&nbsp;<a
		...
		<tr>
			<td>&nbsp;商品品牌：<%= p.getGdsmst_brandname() %></td>
		</tr>
		<% if(ismiaosha)
    	 {
		...
		<%
									    ...
									    if(!Tools.isNull(p.getGdsmst_skuname1())){
										    ...
										    if(skuList != null && !skuList.isEmpty()){
										    	...
										    	%><tr>
			<td><br />&nbsp;我要购买(<%=p.getGdsmst_skuname1() %>)：<%
	...
	<div style="background: #FFDEAD; padding: 3px; width: 100%;">
		<a href="/wap/user/index.jsp">我的优尚</a>&nbsp;&nbsp; <a href="">购物车</a>&nbsp;&nbsp;<a
