<%@ page contentType="text/html; charset=UTF-8"
	import="com.d1.util.*,java.util.Map,java.util.HashMap,com.d1.bean.*,com.d1.helper.*"%>
<%@ include file="/hm.jsp"%>
<%
...
<div class="top" id="top"
	style="background: #FFDEAD; padding-top: 2px; padding-bottom: 2px;">
	<% 
    String info="";
...
<a href="/mindex.jsp"><img
	src="http://images.d1.com.cn/wap/newlogo.jpg" /></a>
