...
<body>
	<div>
		...
		<form id="login" method="post" action="login.jsp?rec=login">
			...
			<br />
			<input type="submit"
				style="backgroud-color: #6495ED; color: #333; padding: 3px; width: 75px; margin-top: 5px; font-size: 13px;"
				value="登&nbsp;录" />
			<br />
		</form>
		<a href="regist.jsp">免费注册</a>&nbsp;&nbsp;&nbsp;&nbsp;<a
			href="/wap/forgetpwd.jsp">忘记密码</a> <br /> <br />
		1、如果您已经在电脑上注册D1优尚网，请直接登录。<br /> 2、如果你还未注册，可以在手机上<a href="regist.jsp">免费注册</a>。
		<br /> <br /> <a href="/mindex.jsp">首页</a>&nbsp;&nbsp;<a
			href="/wap/flow.jsp">购物车</a><br /> <a href="login.jsp">登录</a>&nbsp;&nbsp;<a
			href="regist.jsp">注册</a>&nbsp;&nbsp;<a href="/wap/html/help.jsp">帮助</a>
