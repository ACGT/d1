...
String REDIRECT_URI="http://www.d1.com.cn/interface/login/weixinlogin.jsp";
...
//String loginurl="https://open.weixin.qq.com/connect/oauth2/authorize?appid="+APPID+"&redirect_uri="+REDIRECT_URI2+"&response_type=code&scope=snsapi_userinfo&state="+getRandomString(16)+"#wechat_redirect";
String loginurl="https://open.weixin.qq.com/connect/qrconnect?appid="+APPID+"&redirect_uri="+REDIRECT_URI2+"&response_type=code&scope=snsapi_login&state="+getRandomString(16)+"#wechat_redirect";
