<%@ page contentType="text/html; charset=UTF-8"
	import="net.sf.json.JSONArray,net.sf.json.JSONObject,com.d1.comp.*,java.util.*,com.d1.manager.*,org.hibernate.*"%><%@include
...
JSONArray jsonarr=new JSONArray();
    ...
    int count=0;
	 ...
	 jsonlitem.put("pcontent", sm.getShopmodel_content()!=null?sm.getShopmodel_content().replace("http://m.d1.cn/wap/", "")  :"");
