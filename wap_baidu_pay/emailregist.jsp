...
<body>
	<div>
		...
		<a href="mindex.jsp"><img
			...
			color="red">，无需再次注册.</font> <br /> 邮箱注册&nbsp;&nbsp;|&nbsp;&nbsp;<a
			href="/wap/regist.jsp">手机注册</a><br /> <span id="erroinfo"
			style="color: red; font-weight: bold;"><%= info %></span>
		<form name="form_Regist" id="form_Regist"
			action="/wap/emailregist.jsp?act_wap=regist" method="post">
			邮箱地址：
			<br />
