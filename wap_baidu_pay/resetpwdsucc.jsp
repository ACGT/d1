...
<body>
	<div style="padding-left: 4px; font-size: 14px;">
		...
		<br /> <a href="/mindex.jsp"><img
			src="http://images.d1.com.cn/wap/newlogo.jpg" /></a> <br /> 恭喜，您的密码设置成功！<br />
		请牢记您的密码！<br /> 你可以<a href="/wap/login.jsp">马上登录</a>或者<a
			href="/mindex.jsp">返回首页</a> <br /> <br /> <a href="/mindex.jsp">返回首页</a>&nbsp;&nbsp;<a
