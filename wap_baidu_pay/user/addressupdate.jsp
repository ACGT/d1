	...
	<div style="margin-bottom: 15px;">
     ...
     %>
		...
		<form action="addressupdate.jsp" method="post">
			<input id="hidefrom" name="hidefrom" type="hidden"
				value="<%=provid %>" />
			...
			<div id="third" style="margin-top: 2px; line-height: 18px;">
				<span style="color: red;"><%=msg %></span><br /> 第3步/共3步<br />
				<table>
					<tr>
						...
						<td><input type="text" id="txtName" name="txtName"
							value="<%=name%>" /> <br />
						<span id="spanName" style="color: #e53333; display: none"></span>
						</td>
					</tr>
					<tr>
						<td>&nbsp;<font color='red'>*</font>&nbsp;详细地址：
						</td>
						<td><input type="text" id="txtRAddress" name="txtRAddress"
							value="<%=addr%>" /> <br /></td>
					</tr>
					<tr>
						...
						<td><input type="text" id="txtRZipcode" maxlength="6"
							name="txtRZipcode" value="<%=code%>" /> <br />
					...
					<tr>
						...
						<td><input type="text" id="txtRPhone" name="txtRPhone"
							value="<%=phone%>" /> <br />
					...
					<tr>
						...
						<td><input type="text" id="txtREmail" maxlength="40"
							name="txtREmail" value="<%=email%>" /> <br />
						<span id="spanREmail" style="color: #e53333; display: none"></span>
						</td>
					</tr>
					<tr>
						<td>&nbsp;固定电话：</td>
						<td><input type="text" id="txtTelePhone" name="txtTelePhone"
							value="<%=tel%>" /> <br /> <span id="spanTelePhone"
							style="display: none"></span></td>
					</tr>

				</table>
				<span id="erroinfo"></span> <input type="submit"
					value="<%=btntext %>" id="btnSaveMbrcst"
					style="width: 65px; padding: 4px;" />&nbsp;&nbsp;<a
					href="addresscity.jsp?hideProvId=<%=provid %>&hideAddressId=<%=addressid %><%=url %>"
