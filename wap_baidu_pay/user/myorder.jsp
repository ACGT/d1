...
<body>
	...
	<div style="margin-bottom: 15px;">
		<div style="background: #FFDEAD; padding: 3px; width: 100%;">
			<a href="/mindex.jsp">首页</a>><a href="index.jsp">我的优尚</a>>我的四个月订单 <br />
		</div>
		<% 
    String msg="";
...
//翻页
  int totalLength1 =(result != null ?result.size() : 0);
    ...
    else
    {
		...
		<tr>
			<td colspan="2" align="left" style="border-bottom: solid 1px #00f;">
    		   ...
    		   %> <%
    			...
    			else
    			{
    				if(ob.getOdrmst_payid().longValue()==20){//支付宝手机支付
    					%> <a
				href="/interface/pay/wapalipay/Trade.jsp?OdrID=<%= ob.getId() %>">去支付>></a><br />
				<%	}
      ...
      %>
	   ...
	   //分页
		...
		<form action="myorder.jsp">
			...
			<input type="text" style="width: 20px;" id="page" name="pageno1"
				value="<%=pageno1%>" />/<%=pBean1.getTotalPages() %>页
