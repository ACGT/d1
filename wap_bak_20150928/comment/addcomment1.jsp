...
<form id="form1" name="form1" action="operation.jsp?orderid=<%=request.getParameter("orderid") %>" method="post"  >
      ...
      if(!Tools.isNull(request.getParameter("orderid"))){
        ...
        <td>
		     ...
		     <div id="mark" style="padding-left:4px; margin-left:0px; float:left">
					
		    <input type="radio" value="5" name="rlevel<%=i%>" checked="checked" >5星</input>
		     <input type="radio" value="4" name="rlevel<%=i%>" >4星</input>
		      <input type="radio" value="3" name="rlevel<%=i%>" >3星</input>
		       <input type="radio" value="2" name="rlevel<%=i%>" >2星</input>
		        <input type="radio" value="1" name="rlevel<%=i%>" >1星</input>
...
<tr><td align="center"><input type="submit" value="提交"></input></td></tr>
            </table>
