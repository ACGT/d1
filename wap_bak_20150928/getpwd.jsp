...
System.out.println(msg+"【D1优尚】"+"返回结果---> " + ret2);  
} catch (Exception e) {
	e.printStackTrace();
}
if (ret2.indexOf("-")>=0){
...
<div style="padding-left:4px;">
    ...
    <a href="/mindex.jsp">首页</a>>取回密码
    <br/>
    </div>
    <a href="mindex.jsp"><img src="http://images.d1.com.cn/wap/newlogo.jpg" /></a>
    <br/>
    第2步/共3步<br/>
    <span id="erroinfo" name="erroinfo" style=" color:red; font-weight:bold;"><%= info %></span>
     
    <br/>
   
   验证信息稍侯将以免费短信的形式发送给您，您有两种方式修改密码，任选其中一种即可：<br/>
   1.点击短信中的链接，修改密码<br/>
   2.输入短信中的验证码，修改密码<br/>
   您的手机号:<%= tele %><br/>
     <form name="form_Regist" id="form_Regist" action="getpwd.jsp" method="post" >        
     <input type="hidden" id="tele" name="tele" value="<%= tele%>"/>
             请输入短信验证码：
      <input type="text" id="code" name="code" maxlength="6" style="width:50px;"></input>
      </br>
   <input type="submit" value="修改密码" style="width:80px;" />
        ...
        <form action="getpwd.jsp?sign=vcode" method="post">
          ...
          <input type="submit" value=" 请重新发送激活短信"/><br/>
       ...
       或核实您输入的手机号是否正确
         ...
         <br/>
         <a href="/mindex.jsp">返回首页</a>&nbsp;&nbsp;<a href="/wap/login.jsp">登录</a>&nbsp;&nbsp;<a href="/wap/html/help.jsp">帮助</a>
        <br/>
