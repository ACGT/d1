...
<div style=" margin-bottom:15px;">
   ...
   <table>
     ...
     <tr><td style=" border-bottom:solid 1px #333;"><%
						...
						<%} %></td></tr>
	 <tr><td>&nbsp;<b>商品详情：</b></td></tr>
	 <tr><td>&nbsp;<%= product.getGdsmst_briefintrduce() %></td></tr>
	<%
                                        ///sku
	...
	%>
	  ...
	  <tr><td> &nbsp;<a href="/wap/consult/consultlist.jsp?productid=<%= id%>">商品咨询</a>&nbsp;&nbsp;<a href="/wap/consult/addconsult.jsp?productid=<%= id%>">我要咨询</a><br/>
  <% if(product.getGdsmst_ifhavegds().longValue() == 0){
		if(product.getGdsmst_validflag().longValue() == 1){
			if(ProductStockHelper.canBuy(product)){
	...
	%> 
	&nbsp;&nbsp;<a href="goods.jsp?productid=<%= id %>">返回该商品首页</a></td></tr>
