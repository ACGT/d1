...
<div style=" margin-bottom:15px;">
   <div style=" background:#FFDEAD; padding:3px; width:100%;">
    <a href="/mindex.jsp">首页</a>><a href="/user/index.jsp">我的优尚</a>><a href="/user/ticket.jsp">我的优惠券</a> >激活优惠券
    <br/>
    </div>
    ...
    %>
   <br/> <span style="color:red;font-size:16px;"><%=msg %></span><br/><br/>
    <%if (msg.equals("激活成功")){  %>
    <a href="/wap/user/ticket.jsp">查看优惠券</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/mindex.jsp">现在去购物</a>
    <%} %>
 ...
 <br/>
     <a href="/user/ticket.jsp">查看我的优惠券>></a>
      <br/>
    返回 <a href="/user/index.jsp">我的优尚</a>
</div>
