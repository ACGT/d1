...
<style type="text/css">
  body{ line-height:25px; padding-left:5px;}
  img{border:none;}
...
欢迎来到D1优尚网<br/>
<b>请牢记以下信息：</b><br/>
邮箱账号：<%= lUser.getMbrmst_uid() %><br/>
您可以在电脑上完成对邮箱的验证，便于您找回密码。
<br/>
<a href="/wap/user">马上进入我的优尚</a><br/>
<a href="/mindex.jsp">返回首页</a>&nbsp;&nbsp;<a href="/wap/html/help.jsp">帮助</a>
        <br/>
