...
<div style=" margin-bottom:15px; width:100%">
   <div style=" background:#FFDEAD; padding:3px; width:100%;">
    <a href="/mindex.jsp">首页</a>><a href="myorder.jsp">我的订单</a>><a href="inorder.jsp">查看物流</a>><%= orderid %>
    <br/>
    </div>
    <% 
    ...
    {%>
    	基本信息：<br/>
    	订单号：<%= orderid %><br/>
    	订购时间：<%= new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(ob.getOdrmst_orderdate()) %><br/>
    	发货时间：<%= new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(ob.getOdrmst_realshipdate()) %><br/>
    	配送公司：<%= ob.getOdrmst_d1shipmethod() %><br/>
    	配送公司电话：<% if(getPsPhone((int)Tools.longValue(ob.getOdrmst_d1shipid()))!=null) out.print(getPsPhone((int)Tools.longValue(ob.getOdrmst_d1shipid()))); %><br/>
