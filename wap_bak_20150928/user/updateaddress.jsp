   ...
   <div style=" background:#FFDEAD; padding:3px; width:100%;">
    ...
    <input type="hidden" id="hdnMbrcstID" value="0" />
	  ...
	  <select id="ddlProvince"  onchange="ChangeProv(this)">
        ...
        <input type="button" value="修&nbsp;改" onclick="AddMbrcst_wap('new_save');" id="btnSaveMbrcst"  style="width:65px; padding:4px;">&nbsp;&nbsp;<a href="javascript:void(0)" onclick="operation('2')" style=" text-decoration:underline">返回上一步</a>
