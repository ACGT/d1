...
<div style=" margin-bottom:15px;">
   <div style=" background:#FFDEAD; padding:3px; width:100%;">
    <a href="/mindex.jsp">首页</a>><a href="index.jsp">我的优尚</a>>修改密码
    <br/>
    </div>
    <span style="color:#f00"><%= infos  %></span>
    <form name="form_update" id="form_update" action="/wap/user/updatepassword.jsp?act=update" method="post">
		  
	        <table border="0" cellspacing="0" cellpadding="0" class="t_update">
				 <tr><td>&nbsp;输入原密码：</td></tr>
				 <tr><td>&nbsp;<input type="password" id="oldpassword" name="oldpassword"/></td></tr>
			
				 <tr><td>&nbsp;请输入新密码(6-14位)：</td></tr>
				 <tr><td>&nbsp;<input type="password" name="password" id="password"  maxlength="14" />
				 
				 </td></tr>
				 
				 <tr><td>&nbsp;请再次输入新密码：</td></tr>
				 <tr><td>&nbsp;<input type="password" name="password2" id="password2" maxlength="14"/></td></tr>
				  <tr height="10"><td><font color="#c2c2c2">密码长度6-14位，请正确填写</font></td></tr>


				<tr height="10"><td>
				&nbsp;<input type="submit" value="提&nbsp;交" style="padding:3px;"/></td></tr>
