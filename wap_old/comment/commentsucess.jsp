...
<%@ include file="../inc/head.jsp" %>
  ...
  <div style=" margin-bottom:15px;">
   <div style=" background:#FFDEAD; padding:3px; ">
    <a href="/mindex.jsp">首页</a>><a href="index.jsp">我的优尚</a>>评价预览
    <br/>
    </div>
  ...
  %>
    	  <table border="0"  >
			...
			<tr> <td  class="peisong_body" align="center" valign="middle"  height="40px" >
			<%
			if(!Tools.isNull(Tools.getCookie(request,"PINGAN"))){
				%>	
				<span style="font-size:14px; font-weight:bold">评价已成功</span>
			<%}else{
			%>
          <span style="font-size:14px; font-weight:bold">评价已成功，您获得了<%=score %>个积分</span> 
        <%} %>
         </td>
			</tr>
			 <tr>
         <td  class="peisong_body" align="center" valign="middle" height="30px" style="background-color:#FEEEF1;">
          <b style="font-size:16px; ">我的评价</b>
    		 ...
    		 <table border="0" >
    		 <tr ><td style=" color:#a25663; width:80px;" >订单号</td>
						 <td  ><a href="/wap/orderdetail.jsp?orderid=<%=request.getParameter("orderid") %>" ><%=request.getParameter("orderid") %></a></td>
						 </tr>	
    		 <% 
 ...
 <td><span class="sptitle" style=" display:block; "><a href="<%=linkurl %>" target="_blank"><%=comment.getGdscom_gdsname() %></a></span></td>
 </tr>
