...
<script type="text/javascript" src="<%=com.d1.helper.ResourceHelper.getResourceVersion("/res/js/flow/flowCheck_wap.js")%>"></script>
<style>
...
<!-- Start:收货人信息头 -->
			...
			%>
    		<!-- Start:新增收货表单 -->
    		<form id="formAddr" method="post" action="/wap/flowCheck.jsp" onsubmit="return false;">
    		<input type="hidden" id="hdnMbrcstID" value="0" />
    		<input type="hidden" id="MbrcstAction" value="new_save_consignee" />
            <table style="border:0px;" cellpadding="3" cellspacing="0" class="t00" id="tblAddEditMbrct">
        		<tr>
   			    ...
   			    <tr>
        		    ...
        		    <td valign="middle" class="t01" style="white-space:nowrap;">
          			...
          			<td colspan="3" valign="middle">
						<input type="text" id="txtRAddress" maxlength="200" class="b13" onblur="CheckRAddress()" />
        		...
        		<tr>
          			...
          			<td colspan="4" align="left" valign="middle">
						<table border="0" cellspacing="0" cellpadding="0">
            				<tr>
              					<td align="left">
									<input type="button" class="SaveMbrcst" onclick="AddMbrcst('new_save')" id="btnSaveMbrcst" value="保存"/>
								</td>
              					<td align="left">
		...
		<form name="frm_sendpay" method="post" action="ReceiverList1.aspx" id="frm_sendpay">
    		...
    		<table  border="0" cellpadding="0" cellspacing="0" class="tb43" id="tblMbrcstList">
      			<tr>
    		...
    		<!--End:收货人列表--> 
		    <!-- Start：添加、修改收货人信息 -->
    		<table  border="0" cellpadding="0" cellspacing="0" id="btnAddEditMbrcst">
				<tr><td height="5"></td></tr>
        		<tr>
          			<td valign="top">&nbsp;
						<input type="button" class="AddMbrcst" style="cursor:pointer;" onclick="ToggleAddEditMbrcst()" value="添加收货人" />
		    ...
		    <input type="hidden" id="hdnMbrcstID" value="0" />
    		<input type="hidden" id="MbrcstAction" value="new_save_consignee" />
            <table style="display:none;border:0px;margin-top:10px;"  cellpadding="3" cellspacing="0" class="t00" id="tblAddEditMbrct">
        		<tr>
					<td valign="middle" style="width:10px"><span class="t14">*</span></td>
					<td valign="middle" class="t01" style="white-space:nowrap;">
						<strong style="white-space:nowrap">姓<span style="visibility:hidden">一二</span>名：</strong>
        		...
        		<tr>
          			...
          			<td colspan="4" align="left" valign="middle">
						<table  border="0" cellspacing="0" cellpadding="0">
            				<tr>
              					<td align="left">
									<input type="button" class="SaveMbrcst" onclick="AddMbrcst()" id="btnSaveMbrcst" value="保存"/>
								</td>
              					<td align="left">
								&nbsp;	<a href="javascript:void(0)" onclick="ReSetMbrcst()">清除重写</a>
								</td>
			...
			<a name="pay_top"></a>
      		<table  border="0"  cellpadding="0" cellspacing="0" id="tblPayHead" width="100%">
        		...
        		<tr>
          			<td  class="d2"><span class="t23">&nbsp;支付方式 </span>
          			</td>
        		...
        		<tr>
          			<td><input type="radio" name="req_payid" value="0" checked="checked">货到付款</input></td>
        		</tr>
      		</table>
			<!-- End:支付方式 -->
		    ...
		    <!-- Start:送货时间头 -->
        		...
        		<tr>
          			<td >&nbsp;</td>
          			<td class="t00">（写字楼/商用地址客户请选择此项）<br/>所有商品将通过快递方式发出。</td>
        		</tr>
    		</table>
    		<!-- End:送货时间头 -->
		    <!--Start:商品清单头-->
            ...
            <tr>
            <td>已使用<span id="tvalue"></span>元优惠券</td>
            </tr>
             <tr>
		    ...
		    <!--Start:订单留言-->
      		...
      		<table border="0"  cellpadding="10" cellspacing="0" id="tblGest">
        		...
        		<tr id="tr1" style="display:none;">
          			<td width="98%">
          				&nbsp;<textarea name="txtCustomerMemo" id="txtCustomerMemo"  rows="5" style="width:95%;"></textarea>
					</td>
        		</tr>
        		<tr id="tr2" style="display:none;">
          			<td>&nbsp;&nbsp;<a href="javascript:clearmoemo();">清空</a>&nbsp;&nbsp;<a href="javascript:canclememo();">取消</a></td>
        		</tr>
    		</table>
      		<!--End:订单留言-->
		    <!--Start:提交订单-->
        		...
        		<tr>
          			<td  align="center">							    
						<div id="divBtnOrder" style="display:block;text-align:center;">
							&nbsp;<input type="button" id="Submit33" name="Submit33" class="SubmitOrder" onclick="javascript:sendupdate()" value="提交订单"/>
						</div>
