...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/res/wap/css/base.css" charset="utf-8"/>
		<link rel="stylesheet" type="text/css" href="/res/wap/css/result.css?1.31" charset="utf-8"/>
        ...
        <script type="text/javascript" src="/res/wap/js/com.js"></script>
        	<style>
.chooses{height:.40rem;font-size:.14rem;width:100%;margin-top:.10rem;}
		.choose_con{font-size:.14rem;width:95%;margin-top:.08rem;margin:0 auto;}
		.chooses .ch_row{border-bottom:1px solid #dedede;height:40px;}
		.choose_con .chc_row{border-bottom:1px solid #dedede;overflow-y: scroll;
overflow-x: hidden;max-height:160px;border-left:1px solid #dedede;display:none;}
		.chooses ul li,.choose_con ul li{float: left;
...
.chooses ul li:first-child,.choose_con ul li:first-child{border-left:none}
.chooses ul li.on,.choose_con ul li.on{color:red;background:#dedede;}
.clear{clear:both;}
		</style>
	</head>
		  <body>
		        ...
		        <a name="top"></a>
		             <div class="h_txt">
					     <div class="pageback"><a href="javascript:window.history.back(-1);" >返回</a></div>
					    <div class="search">
						<input type="submit" class="sbut" text="搜索" name="sbut" id="sbut" />
						<input name="keyword" id="keyword" autocomplete="off" role="combobox" aria-haspopup="true" type="text" class="keys" />
						</div>
						<div class="home"><a href="/wap/index.html"></a></div>
			            <div class="myuser"><a href="/wap/user/index.html"></a></div>
						<div class="carth"><a href="/wap/flow.html"></a></div>
			          </div>
			    </header>
				<div class="main">
					<div class="chooses">
				    ...
				    <div class="m_plist">
				       <div class="mp_sort">
					       <div class="mps_con">
						     <div class="mpsc_txt">
						       <a href="javascript:void(0)"  attr="0"   class="cur">综合</a>
						       <a href="javascript:void(0)"  attr="3" >销量</a>
							   <a href="javascript:void(0)"  attr="2"  >价格</a>
							   <a href="javascript:void(0)"  attr="4" >上架时间</a>
							 </div>
						   </div>
				       </div>
					   <div class="mp_list">
						   ...
						   <div class="m_page">
						    <div class="mp_cell s" >首页</div>
							   ...
							   <div class="mp_cell m">
							       <span class="vselect">10/15&nbsp;<i></i></span>
					...
					<div class="rrs_content">
						...
						<div class="rrsc_box rrsc_min" id="rrsc_rck">
							...
							<div class="rck_choose ok_c" attr="">
							</div>
							</div>
