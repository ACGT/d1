...
<style type="text/css" >
body{ line-height:18px;background:#fff; padding-left:4px; font-size:16px; color:#333 }
...
<% if(request.getParameter("flag")!=null&&request.getParameter("flag").length()>0)
	{ %>
 删除成功！<br/>您可以返回<a href="/wap/user/address.jsp">我的地址簿</a>或<a href="/mindex.jsp">返回首页</a>
   <%}
else
{%>
 删除失败！<br/>您可以返回<a href="/wap/user/address.jsp">我的地址簿</a>或<a href="/mindex.jsp">返回首页</a>
	<%}%>
