...
<div style=" margin-bottom:15px;">
   <div style=" background:#FFDEAD; padding:3px; width:100%;">
    <a href="/mindex.jsp">首页</a>><a href="index.jsp">我的优尚</a>>我的四个月前订单
    <br/>
    </div>
    <% 
    String msg="";
  ...
  int totalLength1 =(result != null ?result.size() : 0);
    ...
    else
    {
    	...
    	%>
    		...
    		<tr  style="border-bottom:solid 1px #00f;"><td colspan="2" align="left">
    ...
    <% 
	   //分页
	    if(pBean1.getTotalPages()>1){%>
			...
			<input type="text" style=" width:50px;" id="page" name="pageno1" value="<%=pageno1%>"></input>/<%=pBean1.getTotalPages() %>页<input type="submit" value="跳&nbsp;转"  style=" width:80px; height:20px;"></input>
