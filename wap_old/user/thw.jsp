...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/res/wap/css/uindex.css" charset="utf-8"/>
...
.main-wrap {
		  ...
		  <body>
		        <header class="p_header">
					  ...
					  <div class="pageback"><a href="javascript:window.history.back(-1);" >返回</a></div>
					    <div class="h_h2"><h2><i></i>退换货申请</h2></div>
  ...
  <tr style="display:none">
    ...
    <td >    <input type="radio" id="req_thtype" <%if(thtype.equals("1")){out.print("checked='checked'");} %> onclick="getpaytype();" name="req_thtype" value="1" />
退货&nbsp;&nbsp;
  ...
  <tr id="paytype" style="display:<%if(thtype.equals("2")) {out.print("none");} else {out.print("''");}%>">
    ...
    <td ><input type="radio" id="req_paytype1"  name="req_paytype" value="1" />
退到预存款 &nbsp;&nbsp;
...
%> 
  ...
  <tr>
    ...
    <td><textarea name="req_memo" id="req_memo" style="width:100%" cols="60" rows="4"></textarea></td>
  </tr>
  <tr>
    <td height="30">&nbsp;</td>
