...
<div style=" margin-bottom:15px;">
   <div style=" background:#FFDEAD; padding:3px; width:100%;">
    <a href="/mindex.jsp">首页</a>><a href="index.jsp">我的优尚</a>>我的优惠券
    <br/>
    </div>
    <%
...
%>
    ...
    <form action="ticket.jsp" method="post">
     <input type="hidden" name="ticket" value="ticket"></input>
    	<table>
           ...
           %>
           <tr><td> <% if(islist!=null&&islist.size()>0)
					       {%>
					    	    <% if(pBean1.hasPreviousPage()){ %>&nbsp;<a href="<%=pageURL1%>pageno1=<%=pBean1.getPreviousPage()%>">上页</a><%} %>
					    	    <% if(pBean1.hasNextPage()){ %>&nbsp;&nbsp;<a href="<%=pageURL1%>pageno1=<%=pBean1.getNextPage()%>">下页</a><%} %>
					    	    &nbsp;&nbsp;<input type="text" name="pageno1" style="width:50px;" id="page" value="<%=currentPage1%>"/>/<%=pBean1.getTotalPages() %>
 ...
 <br/>
     <a href="activeticket.jsp">激活新优惠券>></a>
      <br/>
