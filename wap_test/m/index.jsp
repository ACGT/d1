<%@ page contentType="text/html; charset=UTF-8"
	import="com.d1.comp.*,com.d1.manager.*,com.d1.bean.id.SequenceIdGenerator,java.util.Hashtable,com.todaynic.client.mobile.*"%><%@include
	file="/inc/header.jsp"%>
...
.center {
	...
	background: #fff;
	width: 980px;
	background: url('http://images.d1.com.cn/wap/wapbj2013-2.jpg');
	width: 980px;
	height: 1120px;
}
</style>
...
<body style="background: #fff;">
	...
	<div class="center">
		<table>
			<tr>
				<td height="98"
					style="width: 10px; width: 9px\0; _width: 8px; + width: 10px;"></td>
				<img src="http://images.d1.com.cn/images2012/bgbgbg.gif"
					usemap="#maptele"
					style="position: absolute; width: 980px; height: 98px;" />
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td height="660">
					<table>
						<tr>
							<td>
								<div
									style="background: url('http://images.d1.com.cn/images2012/telephones.gif'); width: 303px; height: 593px; text-align: center; z-index: 9999;">
									<iframe src="/mindex.jsp" scrolling="yes" frameborder="0"
										width="246" height="374" style=" margin-top:113px; ">
					...
					<table style="width: 100%">
						...
						<tr>
							<td height="120" colspan="2" valign="top"
								style="font-size: 80px; line-heihgt: 120px; text-align: center; font-family: '微软雅黑'; color: #fff;"><table
									width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td width="62%"><font style="color:#333333">m.d1</font><font
											style="color:#f00">.cn</font></td>
										<td width="38%" valign="top"><img
											src="http://images.d1.com.cn/wap/wapurl.png" alt=""
						...
						<tr>
							<td height="180" width="315"></td>
							<td width="326" align="center" valign="top"><table
									width="96%" height="159" border="0" cellpadding="0"
									cellspacing="0">
									<tr>
										<td height="44">&nbsp;</td>
									</tr>
									<tr>
										<td height="115" align="center" bgcolor="#F2F2F2"><img
											src="http://images.d1.com.cn/wap/wapurl.png" alt=""
